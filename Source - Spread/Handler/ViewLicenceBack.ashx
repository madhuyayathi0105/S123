<%@ WebHandler Language="C#" Class="ViewLicenceBack" %>
...
public class ViewLicenceBack : IHttpHandler 
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        cmd.CommandText = "select File_Name from Temp_Table where Staff_Code ='" + staffcod + "' and type='Back'";
