<%@ Page Title="" Language="C#" MasterPageFile="~/smsmod/SMSSubSiteMaster.master" AutoEventWireup="true"
        ...
        <div style="width: 700px;">
            <table>
                <tr>
                    ...
                    <td>
                        <center>
                            <asp:Label ID="Label1" CssClass="lbl" runat="server" Text="SMS"></asp:Label>
                        </center>
                    </td>
                    <td>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:GridView ID="gridMenu" BackColor="WhiteSmoke" runat="server" AutoGenerateColumns="False"
                            GridLines="Both" OnRowDataBound="gridMenu_OnRowDataBound" CssClass="grid-view"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Help" Visible="false">
                                    <ItemTemplate>
                                        <center>
                                            <%--<asp:LinkButton ID="lbHelplink" runat="server" CssClass="grid_view_lnk_button" Text="Help" Font-Underline="false" PostBackUrl='<%#Eval("HelpURL") %>'></asp:LinkButton>--%>
