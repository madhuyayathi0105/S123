                        ...
                        <table cellpadding="2px" cellspacing="4px" style="height: 100%; margin-left: 0px;
                            ...
                            <tr>
                                <td colspan="4">
                                    ...
                                    <asp:Button ID="btnGo" runat="server" Text="Go" Style="height: 26px; top: 214px;
              ...
              Font-Underline="False">
                                                ...
                                                <td class="style7" align="center">
                                                    ...
                                                    <asp:Panel ID="Panel_sp2" runat="server" BorderColor="ActiveCaptionText" BorderStyle="Ridge"
                                                        ...
                                                        <FarPoint:FpSpread ID="sml_spread" runat="server" Height="170px" Width="300px" ActiveSheetViewIndex="0"
