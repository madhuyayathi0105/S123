<%@ Page Title="" Language="C#" MasterPageFile="~/ScheduleMOD/ScheduleSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="Alternatesched.aspx.cs" Inherits="Alternatesched" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <asp:Label ID="lblhead" runat="server" Text="Alternate Schedule Change" class="fontstyleheader"
            Style="color: #008000; font-size: x-large"></asp:Label>
    </center>
    <div>
        <center>
            <table cellpadding="0px" cellspacing="0px" style="width: 900px; height: 70px; background-color: #0CA6CA;"
                class="table">
                <tr>
                    <td>
                ...
                <tr>
                    <td class="style15">
                        <asp:Label ID="lblFromdate" runat="server" Text="From Date" Font-Bold="True" Font-Names="Book Antiqua"
                            Font-Size="Medium" Width="79px"></asp:Label>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <asp:CalendarExtender ID="caltodate" TargetControlID="txtToDate" Format="dd/MM/yyyy"
                            runat="server">
                        </asp:CalendarExtender>
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="txtnoofalter" CssClass="txt" runat="server" Height="25px" Width="45px"
            ...
            <center>
                <div>
                    ...
                    <asp:Label ID="tofromlbl" runat="server" Text="From date should not be greater than To date"
                        ForeColor="Red" Font-Bold="True" Font-Names="Book Antiqua" Style="position: absolute;
                        top: 286px; left: 21px;"></asp:Label>
                </div>
            </center>
                ...
                <ContentTemplate>
                    ...
                    <table>
                        ...
                        <asp:Panel ID="Panel3" runat="server">
                            ...
                            <tr>
                                <td class="style1">
                                    <asp:Button ID="Button4" runat="server" Text="Free Staff List" Style="border-bottom-style: none;"
                        ...
                        <tr>
                            <td>
                                ...
                                <%--PostBackUrl="~/ScheduleMOD/Batchallocation.aspx"--%>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <table>
                            <tr>
                                ...
                                <td class="style12" align="right">
                                    ...
                                    <asp:Panel ID="panelModified" Visible="false" runat="server">
                                        <asp:Button ID="btnFreeStaff" runat="server" Text="Choose Free Staff" OnClick="btnFreeStaff_click"
                                            Visible="true" />
                                        <asp:DropDownList ID="ddlAlternamteStaff" Width="160px" runat="server" AutoPostBack="true">
                                        </asp:DropDownList>
                                    </asp:Panel>
                                    ...
                                    <asp:Button ID="btnmulstaff" runat="server" Text="Ok" OnClick="btnmulstaff_Click"
                                        Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Medium" />
                                    <asp:CheckBox ID="chkSelectAlterStaff" runat="server" OnCheckedChanged="chkSelectAlterStaff_CheckedChanged"
                                        Visible="false" AutoPostBack="true" Text="Select Alter Staff" />
                            ...
                            <tr>
                                ...
                                <td class="style12" align="center">
                                    ...
                                    <asp:Button ID="btnAddRow" runat="server" Text="Add Row" Font-Bold="True" Font-Names="Book Antiqua"
                                        Font-Size="Medium" Height="25px" Width="85px" BackColor="ControlLight" OnClick="btnAddRow_Click" />
                                </td>
                            </tr>
                            <%--<tr><td></td><td class="style12">  <asp:CheckBox ID="chk_multisubj" runat="server" OnCheckedChanged="chk_multisubj_CheckedChanged" Text="Multiple Staffs" Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Medium" ForeColor="blue" AutoPostBack="true"/>


               <asp:TextBox ID="txtmultisubj" runat="server" Height="21px" 
                   Width="99px" Font-Bold="True" 
         Font-Names="Book Antiqua" Font-Size="Medium" ></asp:TextBox>
              </td></tr>
              <tr><td></td><td class="style12">  


                   <asp:Panel ID="pnlmultisubj" runat="server" Direction="LeftToRight" 
                       ScrollBars="Auto" BorderColor="Black" BorderStyle="Inset"  Height="19px" 
                       Width="175px" style="top: 1250px; left: 470px; position: absolute"  >           
                      
                           
                      
                       <asp:CheckBoxList ID="chklistmultisubj" runat="server" CssClass="font"                       
                         Font-Bold="True" 
         Font-Names="Book Antiqua" Font-Size="Medium" >
                       </asp:CheckBoxList>
                   </asp:Panel>
                   ...
                   <asp:DropDownExtender ID="ddextmultisubj" runat="server" TargetControlID="txtmultisubj" DropDownControlID="pnlmultisubj"  DynamicServicePath="" Enabled="true">
                   </asp:DropDownExtender>
