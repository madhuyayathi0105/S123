...
public partial class Usercontrols_PrintMaster : System.Web.UI.UserControl
{
   ...
   bool truevar = false;
    ...
    public void loadspreaddetails(FpSpread FpSpread1, string pagename, string degreedetails, byte print = 0, string userCode = null)
    {
        try
        {
            //Hashtable hatHeader = new Hashtable();
            //Hashtable hatSubheader = new Hashtable();
            //Hashtable hatChild = new Hashtable();
            //Hashtable hatsubChild = new Hashtable();
            DataTable dtgvdetail = new DataTable();
            dtgvdetail.Columns.Add("Colname");
            dtgvdetail.Columns.Add("size");
            dtgvdetail.Columns.Add("order");
            dtgvdetail.Columns.Add("ischecked");
            dtgvdetail.Columns.Add("HeaderId");
            dtgvdetail.Columns.Add("SubHeaderId");
            dtgvdetail.Columns.Add("ChildHeader");
            dtgvdetail.Columns.Add("SubChildHeader");
            setstyle();
            ...
            for (srtcnt = 0; srtcnt < total_clmn_count; srtcnt++)
            {
                if (fpspreadsample.Sheets[0].Columns[srtcnt].Visible == true)
                {
                    if (fpspreadsample.Sheets[0].ColumnHeader.Cells[0, srtcnt].Text != "")
                    {
                        ...
                        //if (!hatHeader.ContainsKey(Columnname))
                        //{
                            dr2 = dtgvdetail.NewRow();
                            dr2["Colname"] = Columnname;
                            dr2["size"] = "";
                            dr2["order"] = "";
                            dr2["ischecked"] = 0;
                            dr2["HeaderId"] = srtcnt;
                            dr2["SubHeaderId"] = 0;
                            dr2["ChildHeader"] = 0;
                            dr2["SubChildHeader"] = 0;
                            dtgvdetail.Rows.Add(dr2);
                            //hatHeader.Add(Columnname, srtcnt);
                        //}
                        //
                        //dtgvdetail.Columns.Add("HeaderId");
                        ...
                        //
                        //txtbx = new TextBox();
                        //txtbx.ID = "mytxt" + srtcnt;
                        //txtbx.Height = 20;
                        //txtbx.Width = 50;
                        //txtbx.Text = "mytxt" + srtcnt; 
                        int shead = 0;
                                    ...
                                    for (int row = 1; row < headrow; row++)
                                    {
                                        if (fpspreadsample.Sheets[0].Columns[spancol].Visible == true)
                                        {
                                            if (fpspreadsample.Sheets[0].ColumnHeader.Cells[row, spancol].Text != "")
                                            {
                                                ...
                                                //if (!hatSubheader.ContainsKey(rowColumnname))
                                                //{
                                                    dr2 = dtgvdetail.NewRow();
                                                    dr2["Colname"] = rowColumnname;
                                                    dr2["size"] = "";
                                                    dr2["order"] = "";
                                                    dr2["ischecked"] = 0;
                                                    dr2["SubHeaderId"] = shead;
                                                    dr2["HeaderId"] = srtcnt;
                                                    dr2["ChildHeader"] = 0;
                                                    dr2["SubChildHeader"] = 0;
                                                    dtgvdetail.Rows.Add(dr2);
                                                   // hatSubheader.Add(rowColumnname, shead);
                                                //}
                                                //dtgvdetail.Columns.Add("SubHeaderId");
                                                        ...
                                                        for (int subrow = row + 1; subrow < headrow; subrow++)
                                                        {
                                                            if (fpspreadsample.Sheets[0].Columns[subcol].Visible == true)
                                                            {
                                                                if (fpspreadsample.Sheets[0].ColumnHeader.Cells[subrow, subcol].Text != "")
                                                                {
                                                                    ...
                                                                    ch = ch + 1;
                                                                    //if (!hatChild.ContainsKey(subrowColumnname))
                                                                    //{
                                                                        dr2 = dtgvdetail.NewRow();
                                                                        dr2["Colname"] = subrowColumnname;
                                                                        dr2["size"] = "";
                                                                        dr2["order"] = "";
                                                                        dr2["ischecked"] = 0;
                                                                        dr2["ChildHeader"] = ch;
                                                                        ...
                                                                        dr2["SubChildHeader"] = 0;
                                                                        dtgvdetail.Rows.Add(dr2);
                                                                        //hatsubChild.Add(subrowColumnname,ch);
                                                                    //}
                                                                    //dtgvdetail.Columns.Add("SubChildHeader");
                                                                            ...
                                                                            for (int subchirow = subrow + 1; subchirow < headrow; subchirow++)
                                                                            {
                                                                                if (fpspreadsample.Sheets[0].Columns[subspancol].Visible == true)
                                                                                {
                                                                                    if (fpspreadsample.Sheets[0].ColumnHeader.Cells[subchirow, subspancol].Text != "")
                                                                                    {
                                                                                        ...
                                                                                        dr2["order"] = "";
                                                                                        dr2["ischecked"] = 0;
                                                                                        dr2["SubChildHeader"] = subspancol;
                                                                                        dr2["ChildHeader"] = subcol;
                                                                                        dr2["SubHeaderId"] = row;
                                                                                        dr2["HeaderId"] = srtcnt;
                                                                                        dtgvdetail.Rows.Add(dr2);
                                                                                    }
            ...
            string selectedSize = da.GetFunction("select SizeOrder from tbl_print_master_settings where page_Name='" + pagename + "' and usercode='" + Convert.ToString(Session["user_code"]) + "'");
            string[] splitselectedPrintFields = selectedPrintFields.Split('#');
            Chk_sel.Checked = false;
            string[] splitsizeorder = selectedSize.Split('$');

            if (splitselectedPrintFields.Length > 0)
            {
                int seleCount = 0;
                int selTotCount = 0;
                for (int parenT = 0; parenT < dtgvdetail.Rows.Count; parenT++)
                {
                    selTotCount++;
                    //int childRowCount = 0;
                    //int newChildRowCount = 0;
                    //int a = 0;
                      for (int col = 0; col < splitsizeorder.Length; col++)
                      {
                      string strsizecol = Convert.ToString(splitsizeorder[col]);
                      string[] orderSize = strsizecol.Split(';');
                      if (Convert.ToString(orderSize[0]).Contains("^"))
                      {
                          string[] ordersize1 = Convert.ToString(orderSize[0]).Split('^');

                          if (Convert.ToString(ordersize1[1]).Trim() == Convert.ToString(dtgvdetail.Rows[parenT]["Colname"]).Trim())
                          //if (strsizecol.Contains(Convert.ToString(dtgvdetail.Rows[parenT]["Colname"])))
                          {
                              dtgvdetail.Rows[parenT]["size"] = Convert.ToString(orderSize[1]);
                              dtgvdetail.Rows[parenT]["order"] = Convert.ToString(orderSize[2]);
                          }
                      }
                      else
                      {
                          if (Convert.ToString(orderSize[0]).Trim() == Convert.ToString(dtgvdetail.Rows[parenT]["Colname"]).Trim())
                          //if (strsizecol.Contains(Convert.ToString(dtgvdetail.Rows[parenT]["Colname"])))
                          {
                              dtgvdetail.Rows[parenT]["size"] = Convert.ToString(orderSize[1]);
                              dtgvdetail.Rows[parenT]["order"] = Convert.ToString(orderSize[2]);
                    ...
                    for (int val = 0; val < splitselectedPrintFields.Length; val++)
                    {
                        ...
                        if (printField == Convert.ToString(dtgvdetail.Rows[parenT]["Colname"]))
                        {
                            dtgvdetail.Rows[parenT]["ischecked"] = 1;
                            seleCount++;
                        }
                        else if (printField.Contains("^"))
                        {
                            if (printField.Split('^')[1] ==Convert.ToString(dtgvdetail.Rows[parenT]["Colname"]))
                            {
                                if (printField.Contains("@"))
                                {
                                    string strChild = printField.Split('@')[0];
                                    if (strChild.Split('^')[1] == Convert.ToString(dtgvdetail.Rows[parenT]["Colname"]))
                                    {
                            ...
                            if (printField.Split('^')[0] == Convert.ToString(dtgvdetail.Rows[parenT]["Colname"]))
                            {
                                if (printField.Contains("@"))
                                {
                                    string strChild = printField.Split('@')[0];
            ...
            //dtgvdetail.DefaultView.RowFilter="Subheader=0";
    ...
    protected void btnprint_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SortedDictionary<int, string> hat = new SortedDictionary<int, string>();
           string HeaderID = string.Empty;
           string colname = string.Empty;
           string PrintSizeOrder = string.Empty;
            for (int remv = 0; remv < GridView1.Rows.Count; remv++)
            {
                bool enter = false;
                TextBox box1 = new TextBox();
                TextBox box2 = new TextBox();
                GridViewRow row2 = GridView1.Rows[remv];
                int colval = remv;
                int rowval = remv;
                bool ischecked = (row2.FindControl("chkRow") as CheckBox).Checked;
                if (ischecked == true)
                {
                    //new code===========================================================
                    box1 = (TextBox)GridView1.Rows[remv].Cells[3].FindControl("txtorder");
                    box2 = (TextBox)GridView1.Rows[remv].Cells[2].FindControl("txtSize");
                    string He = GridView1.Rows[remv].Cells[1].Text;
                    string rowCountVal= GridView1.Rows[remv].Cells[4].Text;
                    int rowC = 0;
                    int getVal = 0;
                   
                    for (int remval = 0; remval < GridView1.Rows.Count; remval++)
                    {
                        
                        //if (Convert.ToInt32(rowCountVal) == remval)
                        //{
                            if (rowCountVal == GridView1.Rows[remval].Cells[4].Text)
                            {
                                rowC++;
                                if (rowC > 1)
                                {
                                    colval = Convert.ToInt32(GridView1.Rows[remval].Cells[4].Text) + getVal;
                                    //colval = remval - 1;
                                    string ColumnName = string.Empty;
                                    if (!string.IsNullOrEmpty(He))
                                    {
                                        colname = He + "^" + GridView1.Rows[remval].Cells[1].Text;
                                    }
                                    else
                                    {
                                        colname = GridView1.Rows[remval].Cells[1].Text;
                                    }

                                    box1 = (TextBox)GridView1.Rows[remval].Cells[3].FindControl("txtorder");
                                    box2 = (TextBox)GridView1.Rows[remval].Cells[2].FindControl("txtSize");
                                    string val = colname + "%" + colval.ToString();
                                    if (!string.IsNullOrEmpty(box1.Text))
                                    {
                                        if (!hat.ContainsKey(Convert.ToInt32(box1.Text)))
                                        {
                                            secondrowselect = true;
                                            hat.Add(Convert.ToInt32(box1.Text), val);
                                            if (string.IsNullOrEmpty(PrintSizeOrder))
                                            {
                                                PrintSizeOrder = colname + ";" + box2.Text + ";" + box1.Text;
                                            }
                                            else
                                            {
                                                PrintSizeOrder = PrintSizeOrder + "$" + colname + ";" + box2.Text + ";" + box1.Text;
                                            }
                                            getVal++;
                                            enter = true;
                                    ...
                                    //string size = GridView1.Rows[remval].Cells[1].Text;
                                }
                                //else
                                //{

                                //    colname = GridView1.Rows[remv].Cells[1].Text;
                                //    string val = colname + "%" + colval.ToString();
                                //    box1 = (TextBox)GridView1.Rows[remval].Cells[3].FindControl("txtorder");
                                //    box2 = (TextBox)GridView1.Rows[remval].Cells[2].FindControl("txtSize");
                                //    if (!string.IsNullOrEmpty(box1.Text))
                    ...
                    if (rowC < 2 &&  enter==false)
                    {
                       
                        colname = GridView1.Rows[remv].Cells[1].Text;
                        box1 = (TextBox)GridView1.Rows[remv].Cells[3].FindControl("txtorder");
                        box2 = (TextBox)GridView1.Rows[remv].Cells[2].FindControl("txtSize");
                        string val = colname + "%" + Convert.ToInt32(GridView1.Rows[remv].Cells[4].Text);
                        if (!string.IsNullOrEmpty(box1.Text))
                        {
                            if (!hat.ContainsKey(Convert.ToInt32(box1.Text)))
                            {
            ...
            foreach(KeyValuePair<int, string> entry in hat)
            {
                        string columnvalue = "";
                        string[] sizeCol = entry.Value.ToString().Split('%');
                  
                        Columname = Convert.ToString(sizeCol[0]);
                        printField = Convert.ToString(sizeCol[0]);
                            //box1 = remv.ToString();
                        columnvalue = Convert.ToString(sizeCol[1]);
                        if (Headername == "")
                        {
                            columncount++;
            ...
            if (!string.IsNullOrEmpty(PrintSizeOrder))
            {
                string SelectQ = "if exists(select * from tbl_print_master_settings  where page_Name='" + Session["Pagename"].ToString() + "' and usercode='" + Convert.ToString(Session["user_code"]) + "' ) update tbl_print_master_settings SET SizeOrder='" + PrintSizeOrder + "' where page_Name='" + Session["Pagename"].ToString() + "' else insert into tbl_print_master_settings(page_Name,usercode,sizeorder) values ('" + Session["Pagename"].ToString() + "','" + Convert.ToString(Session["user_code"]) + "','" + PrintSizeOrder + "')";
                int count = da.update_method_wo_parameter(SelectQ,"text");
            }
                    ...
                    for (int row = 0; row < nopages; row++)
                    {
                        ...
                        if (value < fpspreadsample.Sheets[0].RowCount)
                        {
                            ...
                            for (int head = 0; head <= spilthead.GetUpperBound(0); head++)
                            {
                                ...
                                bool SetWidh = false;
                                string strSizeOrderCol = da.GetFunction("select SizeOrder from tbl_print_master_settings where page_Name='" + Session["Pagename"].ToString() + "' and usercode='" + Convert.ToString(Session["user_code"]) + "'");
                                if (!string.IsNullOrEmpty(strSizeOrderCol))
                                {
                                    string[] splitsizeorder = strSizeOrderCol.Split('$');
                                    for (int col = 0; col < splitsizeorder.Length; col++)
                                    {
                                        string strsizecol = Convert.ToString(splitsizeorder[col]);
                                        if (strsizecol.Contains(headvalue))
                                        {
                                            string[] orderSize = strsizecol.Split(';');
                                            if (!string.IsNullOrEmpty(Convert.ToString(orderSize[1])))
                                            {
                                                int strWidth = Convert.ToInt32(orderSize[1]);
                                                table.Columns[tablecolumn].SetWidth(strWidth);
                                                width = width + (strWidth);
                                                SetWidh = true;
                                            }
                                            else
                                            {
                                        ...
                                        //else if (!strSizeOrderCol.Contains(headvalue))
                                        //{
                                        //    table.Columns[tablecolumn].SetWidth(leng * fontsize);
                                        //    width = width + (leng * fontsize);
                                        //}
                            ...
                            if (tablegflag == true)
                            {
                                if (headflag == true)
                                {
                                    ...
                                    {
                                        if (width > 825 || chkfitpaper.Checked == true)//Rajkumar Chage X Pos
                                        {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        if (pagesizeflag == false)
                                        {
                                            ...
                                            {
                                                Double leftarrange = Math.Round(Convert.ToDouble((790 - width) / 2), 0);
    ...
    protected void chkview_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                dttempNew = (DataTable)ViewState["CurrentTable"];
            }
            if (Session["truvar"] == null)
            {
                dttempNew = new DataTable();
                //drrowNew = new DataRow();
                dttempNew.Columns.Add("Colname");
                dttempNew.Columns.Add("size");
                dttempNew.Columns.Add("order");
                dttempNew.Columns.Add("ischecked");

                dttempNew.Columns.Add("HeaderId");
                dttempNew.Columns.Add("SubHeaderId");
                dttempNew.Columns.Add("ChildHeader");
                dttempNew.Columns.Add("SubChildHeader");
                truevar = true;
                Session["truvar"] = "abcd";
            }
            ...
            int row1 = Convert.ToInt32(gr.RowIndex);
            int rowcount = 0;
            GridViewRow row2 = GridView1.Rows[row1];
            bool ischecked = (row2.FindControl("chkRow") as CheckBox).Checked;
            //string sel=GridView1.DataKeys[gr.RowIndex].Value.ToString();



            foreach (GridViewRow row in this.GridView1.Rows)
            {
                CheckBox chkId = (row.FindControl("chkRow") as CheckBox);
                if (chkId.Checked)
                {
                    rowcount++;
                    //GridView1.Rows[row1].Cells[3].Text = rowcount.ToString();
                }

                if (ViewState["CurrentTable"] == null)
                {
                    drrowNew = dttempNew.NewRow();
                    drrowNew["Colname"] = row.Cells[1].Text;
                    drrowNew["size"] = (row.FindControl("txtSize") as TextBox).Text;
                    drrowNew["order"] = (row.FindControl("txtorder") as TextBox).Text;
                    drrowNew["ischecked"] = Convert.ToBoolean((row.FindControl("chkRow") as CheckBox).Checked) ? 1 : 0;
                    drrowNew["HeaderId"] = row.Cells[4].Text;
                    drrowNew["SubHeaderId"] = row.Cells[5].Text;
                    drrowNew["ChildHeader"] = row.Cells[6].Text;
                    drrowNew["SubChildHeader"] = row.Cells[7].Text;
                    dttempNew.Rows.Add(drrowNew);
                    //ViewState["CurrentTable"] = dttempNew;
                }
            ...
            if (ischecked)
            {
                if (string.IsNullOrEmpty(Convert.ToString(dttempNew.Rows[row1][2])))
                {
                    dttempNew.Rows[row1]["ischecked"] = 1;
                    string chksubhead = Convert.ToString(dttempNew.Rows[row1]["HeaderId"]);
                    for (int j = 0; j < dttempNew.Rows.Count; j++)
                    {
                        if (Convert.ToString(dttempNew.Rows[row1]["HeaderId"]) == chksubhead)
                        {
                            Session["HeaderId"] = Convert.ToString(dttempNew.Rows[row1]["HeaderId"]);
                        }
                    }
                    dttempNew.Rows[row1]["order"] = rowcount.ToString();
                }
            }
            else
            {
                dttempNew.Rows[row1]["ischecked"] = 0;
                int min = Convert.ToInt32(dttempNew.Rows[row1]["order"]);
                dttempNew.Rows[row1]["order"] = null;
                for (int i = 0; i < dttempNew.Rows.Count; i++)
                {
                    if (Convert.ToString(dttempNew.Rows[i]["ischecked"]) == "1")
                    {
                        if (Convert.ToInt32(dttempNew.Rows[i]["order"]) > min)
                        {
                            int num = Convert.ToInt32(dttempNew.Rows[i]["order"]);
                            dttempNew.Rows[i]["order"] = (num - 1).ToString();
                        }
                    }
                }
            }
            ...
            {
                GridView1.DataSource = dttempNew;
                GridView1.DataBind();
            }
        }
        catch
    ...
    protected void GridView1_DataBound(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string vr;
                string HeaderID = Convert.ToString(Session["HeaderId"]);
                vr = GridView1.Rows[i].Cells[5].Text;
                if (vr != "0")
                {
                    
                    //GridView1.Rows[i].CssClass = "hidden";
                }
                if (GridView1.Rows[i].Cells[4].Text == HeaderID)
                {
