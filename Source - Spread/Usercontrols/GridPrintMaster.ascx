<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GridPrintMaster.ascx.cs" Inherits="Usercontrols_PrintMaster" %>
...
function errorCheckChanged(chkBox){  
    ...
    for(var i = 0; i < Elements.length; i++){
        ...
        var txtbx = Elements.getElementById('txtorder').value;
        txtbx=numChecked;
           } 
    }end for
}
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlforlistbox" runat="server" Style="top: 300px; left: 151px; position: absolute;"
            ...
            <asp:Panel ID="first_tree_panel" runat="server" BorderStyle="Solid" Direction="LeftToRight"
                ...
                left: 2px; position: absolute;" BorderWidth="1">
              ...
              <asp:GridView ID="GridView1" runat="server" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White"
                AutoGenerateColumns="false" Width="200px" AllowSorting="true" OnDataBound="GridView1_DataBound">
                <Columns>
                 <asp:TemplateField>
                 <ItemTemplate>
                <asp:CheckBox ID="chkRow" onclick="errorCheckChanged(this)" runat="server" Checked='<%# Eval("ischecked").ToString().Equals("1") %>' />  <%--Checked='<%# Eval("ischecked") %>' --%>  <%--OnCheckedChanged="chkview_CheckedChanged"--%>
                 </ItemTemplate>
                </asp:TemplateField>
                 <asp:BoundField DataField="Colname" HeaderText="Name"  ItemStyle-Width="450"/>
                    <asp:TemplateField HeaderText="Size" ItemStyle-Width="100">
                    <ItemTemplate>
                     <asp:TextBox ID="txtSize" runat="server" Text='<%# Eval("size") %>' ReadOnly="false" Width="50px"></asp:TextBox>
                     </ItemTemplate>
                      <ItemStyle Width="100px" />
                     </asp:TemplateField>
                     <asp:TemplateField HeaderText="order" ItemStyle-Width="100">
                    <ItemTemplate>
                     <asp:TextBox ID="txtorder" runat="server" Text='<%# Eval("order") %>' ReadOnly="false" Width="50px"></asp:TextBox>
                     </ItemTemplate>
                      <ItemStyle Width="100px" />
                     </asp:TemplateField> 
                      <asp:BoundField DataField="HeaderId" HeaderText="Headerid"><HeaderStyle CssClass="hidden" /> <ItemStyle CssClass="hidden"/></asp:BoundField>
                       <asp:BoundField DataField="SubHeaderId" HeaderText="SubHeaderId"><HeaderStyle CssClass="hidden" /><ItemStyle CssClass="hidden"/></asp:BoundField>
                        <asp:BoundField DataField="ChildHeader" HeaderText="ChildHeader"><HeaderStyle CssClass="hidden" /><ItemStyle CssClass="hidden" /></asp:BoundField>
                         <asp:BoundField DataField="SubChildHeader" HeaderText="SubChildHeader"><HeaderStyle CssClass="hidden" /><ItemStyle CssClass="hidden" /></asp:BoundField>
                    </Columns>
                </asp:GridView>
                <br />
            </asp:Panel>
