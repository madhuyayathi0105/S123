<%@ Page Title="" Language="C#" MasterPageFile="~/Financemod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="Finance_MIS_Budget_Report.aspx.cs" Inherits="Finance_MIS_Budget_Report" %>
        ...
        <div>
            ...
            <center>
                <div>
                    <center>
                        <div>
                            <span class="fontstyleheader" style="color: #008000">Finance MIS Budget Report</span></div>
                    </center>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlacctype" runat="server" CssClass="textbox1 ddlheight2" OnSelectedIndexChanged="ddlacctype_change"
                                                        AutoPostBack="true" Style="width: 102px;">
                                                ...
                                                <td>
                                                    <asp:Label runat="server" ID="Label1" Text="Account Header"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                        <ContentTemplate>
                                                            ...
                                                            <asp:Panel ID="paccheader" runat="server" Height="250px" Width="369px" CssClass="multxtpanel">
                                                ...
                                                <td id="tdSeat" runat="server" visible="false">
                                                    <asp:Label ID="lbl_seat" runat="server" Text="Seat Type"></asp:Label>
                                                </td>
                                                <td id="tdSeatsnd" runat="server" visible="false">                                                    
                                                    <asp:DropDownList ID="ddlseattype" runat="server" CssClass="textbox1 ddlheight2"
                                                        Style="width: 150px; height: 28px; font-family: Book Antiqua;">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td colspan="10">
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:CheckBox ID="chk_datewise" runat="server" Text="DateWise" OnCheckedChanged="chk_datewise_OnCheckedChanged"
                                                        AutoPostBack="true" />
                                                </td>
                                                <td colspan="2">
                                                    <div id="divdatewise" runat="server">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txt_fromdate" runat="server" onchange="return checkDate()" Style="height: 20px;
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lbl_todate" runat="server" Text="To" Style=""></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txt_todate" runat="server" onchange="return checkDate()" Style="height: 20px;
                                                                        width: 75px;"></asp:TextBox>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnGo" runat="server" OnClientClick="return checkDate()" OnClick="btnGo_Click"
                                                        Text="Go" CssClass="textbox textbox1 btn1" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
