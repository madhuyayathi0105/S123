<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceMod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="StudTransReport.aspx.cs" Inherits="StudTransReport" %>
                    ...
                    <div id="divreport" runat="server">
                        <table class="maintablestyle">
                            <tr>
                                ...
                                <%--<td>
                                    <asp:DropDownList ID="ddlcollege" Width="300px" runat="server" CssClass="textbox  ddlheight"
                                        AutoPostBack="true" OnSelectedIndexChanged="ddlcollege_Selected">
                                    </asp:DropDownList>
                                </td>--%>
                                <td colspan="2">
                                    <table>
                                ...
                                <td>
                                    <asp:RadioButtonList ID="rblType" runat="server" RepeatDirection="Horizontal" >
                                        <asp:ListItem Text="Before Admission" Selected="True"></asp:ListItem>
                                        <asp:ListItem Text="After Admission"></asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                                <td>
                                ...
                                <Sheets>
                                    <FarPoint:SheetView SheetName="Sheet1" AllowPage="false" GridLineColor="Black">
                                            ...
                                            overflow: auto; border-radius: 10px;">--%>
                                                <asp:GridView ID="gridReport" runat="server" AutoGenerateColumns="true" GridLines="Both"
                                                    CssClass="grid-view" BackColor="WhiteSmoke" OnRowDataBound="gridReport_OnRowDataBound">
                                                </asp:GridView>
                                                <%--</div>--%>
                                            </td>
                                        </tr>
