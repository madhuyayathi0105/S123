<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceMod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="FinanceUniversalReportMultiple.aspx.cs" Inherits="FinanceUniversalReportMultiple" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <body>
        ...
        <script type="text/javascript">
            //college
            function CheckBoxListSelectCollege(cbControl) {
                var chkBoxList = document.getElementById('<%=cbl_college.ClientID %>');
            ...
            <center>
                <div>
                    <span id="sphd" runat="server" class="fontstyleheader" style="color: Green;">Finance
                        Universal Multiple Reports</span>
                </div>
            </center>
        </div>
        <center>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <fieldset style="height: 100px; width: 270px;">
                                            <asp:Panel ID="Panel24" runat="server" ScrollBars="Auto" Style="height: 109px;">
                                                <asp:CheckBox ID="cb_college" runat="server" Text="All" onclick="CheckBoxListSelectCollege(this);" />
                                                <asp:CheckBoxList ID="cbl_college" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cbl_college_OnSelectedIndexChanged">
                                                </asp:CheckBoxList>
                                            </asp:Panel>
                                        </fieldset>
                                    </td>
                    ...
                    <td colspan="6">
                        <table>
                            <tr>
                                ...
                                <td><%--added by abarna 18.07.2018--%>
                                    <fieldset id="yearsemfield" runat="server" visible ="false" style="height: 15px; width: 300x; ">
                                        <asp:RadioButtonList ID="rbldetailedsemandyear" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rbldetailedsemandyear_Selected"
                                            RepeatDirection="Horizontal" Visible ="false">
                                            <asp:ListItem Text="Yearwise Detailed" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="SemWise Detailed" Value="1"></asp:ListItem>
                                        </asp:RadioButtonList>
                                    </fieldset>
                                </td>
                                <td>
                        ...
                        <fieldset id="fldstud" runat="server" style="display: none;">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lbl_seat" runat="server" Text="Quota"></asp:Label>
                                        <fieldset style="height: 109px; width: 155px;">
                                            <asp:Panel ID="Panel10" runat="server" ScrollBars="Auto" Style="height: 109px;">
                                                ...
                                                <asp:CheckBoxList ID="cbl_seat" runat="server">
                                                </asp:CheckBoxList>
                                    ...
                                    <td>
                                        ...
                                        <fieldset style="height: 109px; width: 125px;">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <fieldset style="height: 109px; width: 110px;">
                                    ...
                                    <%-- -----------------------------------------------------------%>
                                    <%--Added by Saranya on 02/01/2018 for Concession Reason--%>
                                    <td>
                                        <asp:Label ID="LblConcession" Text="ConcessionReason" runat="server"></asp:Label>
                                        <fieldset style="height: 109px; width: 170px;">
                                            <asp:Panel ID="PnlConcession" runat="server" ScrollBars="Auto" Style="height: 109px;">
                                                <asp:CheckBox ID="ChkbxConcession" runat="server" Width="200px" Text="All" AutoPostBack="true"
                                                    OnCheckedChanged="ChkbxConcession_OnCheckedChanged" />
                                                <asp:CheckBoxList ID="ChKl_Concession" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ChKl_Concession_OnSelectedIndexChanged">
                                                </asp:CheckBoxList>
                                            </asp:Panel>
                                        </fieldset>
                                    </td>
            ...
            <center>
                <div id="print" runat="server" visible="true">
                    ...
                    <asp:Button ID="btnprintmasterhed" runat="server" Visible="false" Font-Names="Book Antiqua"
                        ...
                        CssClass="textbox textbox1" Width="100px" />
