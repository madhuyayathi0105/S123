<%@ Page Title="" Language="C#" MasterPageFile="~/ScheduleMOD/ScheduleSubSiteMaster.master" AutoEventWireup="true"
    CodeFile="Batchallocation.aspx.cs" Inherits="Batchallocation" %>
                        ...
                        <table cellpadding="2px" cellspacing="4px" style="height: 100%; margin-left: 0px;
                            ...
                            <tr>
                                <td colspan="4">
                                    ...
                                    <asp:Button ID="btnGo" runat="server" Text="Go" Style="height: 26px; top: 177px;
                                        left: 442px; position: absolute; font-weight: 700" Font-Bold="True" Font-Names="Book Antiqua"
      ...
      <TitleInfo BackColor="#E7EFF7" Font-Size="X-Large" ForeColor="" 
              ...
              Font-Underline="False">
                                                        ...
                                                        <asp:Button ID="delbtn" runat="server" Text="Delete" Font-Bold="True" Font-Names="Book Antiqua"
                                                            Font-Size="Medium" Height="28px" Width="55px" OnClick="delbtn_Click" />
                                                    </asp:Panel>
                                                </td>
                                                <%-- ------------------------lab----------------------%>
