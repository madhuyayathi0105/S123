<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceMod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="actualfinyearsetting.aspx.cs" Inherits="actualfinyearsetting" %>
                    ...
                    <td>
                        <asp:GridView ID="gdReport" runat="server" Visible="false" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Finance Year" HeaderStyle-BackColor="#0CA6CA" HeaderStyle-HorizontalAlign="center"
                                    HeaderStyle-Width="">
                                    <ItemTemplate>
                                        <center>
            ...
            <center>
                <div id="divEdit" runat="server" visible="false" class="popupstyle popupheight1 "
                    ...
                    <div style="background-color: White; height: auto; width: 650px; border: 5px solid #0CA6CA;
                        ...
                        <br />
                        <span style="color: Green; font-size: large; font-weight: bold;">FinanceYear Settings</span>
                        <table>
                            <tr>
                                <td>
