<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceMod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="DailyFeesCollectionReport.aspx.cs" Inherits="DailyFeesCollectionReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <body>
        ...
        <div>
            <center>
                <div>
                    <span class="fontstyleheader" style="color: Green;">Daily Fees Collection Report</span></div>
            </center>
        </div>
        <div>
            <center>
                <div id="maindiv" runat="server" class="maindivstyle" style="width: 1000px; height: auto">
                    <table class="maintablestyle">
                        <tr>
                            ...
                            <td colspan="2" id="tdmemtype" runat="server" visible="true">
                       ...
                       <%--     added by abarna on 19.02.2018--%>
                            ...
                            <td id="td1" runat="server">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:PopupControlExtender ID="PopupControlExtender3" runat="server" TargetControlID="txtuser"
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:CheckBox ID="cbbeforAdm" runat="server" Text="Before Admission" Checked="true"
                                    Visible="true" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="8">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:CheckBox ID="cbfine" runat="server" Text="Include Fine" Checked="true" />
                                        </td>
                                        <td>
