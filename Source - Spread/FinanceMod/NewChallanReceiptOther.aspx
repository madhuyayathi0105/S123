<%@ Page Title="" Language="C#" MasterPageFile="~/Financemod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="NewChallanReceiptOther.aspx.cs" Inherits="NewChallanReceiptOther"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function checkfeeamount() {
            ...
            var fnlBalAmt = 0;
            var txttotaltobepaid = document.getElementById("<%=Txt_amt.ClientID %>");
            var txtmaintotalamount = document.getElementById("<%=txt_totamt.ClientID %>");
            var txtmainpaidamount = document.getElementById("<%=txt_paidamt.ClientID %>");
            var txtmainbalanceamount = document.getElementById("<%=txt_balamt.ClientID %>");
            var tbl = document.getElementById("<%=grid_Details.ClientID %>");
            var gridViewControls = tbl.getElementsByTagName("input");
            for (var i = 0; i < (gridViewControls.length) - 1; i++) {
                ...
                var txtfee = document.getElementById('MainContent_grid_Details_txt_fee_amt_' + i.toString());
                var txtdeduct = document.getElementById('MainContent_grid_Details_txt_deduct_amt_' + i.toString());
                var txttotal = document.getElementById('MainContent_grid_Details_txt_tot_amt_' + i.toString());
                var txtpaid = document.getElementById('MainContent_grid_Details_txt_paid_amt_' + i.toString());
                var txtbal = document.getElementById('MainContent_grid_Details_txt_bal_amt_' + i.toString());
                var txttobe = document.getElementById('MainContent_grid_Details_txt_tobepaid_amt_' + i.toString());

                var hffee = document.getElementById('MainContent_grid_Details_hf_fee_amt_' + i.toString());
                var hfdeduct = document.getElementById('MainContent_grid_Details_hf_deduct_amt_' + i.toString());

                var cbsel = document.getElementById('MainContent_grid_Details_cb_selectLedger_' + i.toString());

                if (txtfee != null && txtfee.value.trim() != "")
                    feeAmt = parseFloat(txtfee.value);
                if (txtdeduct != null && txtdeduct.value.trim() != "")
                    deductAmt = parseFloat(txtdeduct.value);
                if (txttotal != null && txttotal.value.trim() != "")
                    totalAmt = parseFloat(txttotal.value);
                if (txtpaid != null && txtpaid.value.trim() != "")
                    paidAmt = parseFloat(txtpaid.value);
                if (txtbal != null && txtbal.value.trim() != "")
                    balAmt = parseFloat(txtbal.value);
                if (txttobe != null && txttobe.value.trim() != "")
                    tobepaidAmt = parseFloat(txttobe.value);
                if (hffee != null && hffee.value.trim() != "")
                    hffeeAmt = parseFloat(hffee.value);
                if (hfdeduct != null && hfdeduct.value.trim() != "")
                    hfdeductAmt = parseFloat(hfdeduct.value);
                var boolcheck = false;
                if (feeAmt < deductAmt) {
                    txtfee.value = hffeeAmt.toString();
                    txtdeduct.value = hfdeductAmt.toString();
                    boolcheck = true;
                }
                if ((feeAmt - deductAmt) < paidAmt) {
                    txtfee.value = hffeeAmt.toString();
                    txtdeduct.value = hfdeductAmt.toString();
                    boolcheck = true;
                }

                if (feeAmt != hffeeAmt || deductAmt != hfdeductAmt) {
                    if (!boolcheck) {
                        //feeamount add
                        var temptotAmt = feeAmt - deductAmt;
                        txttotal.value = temptotAmt.toString(); //total amount
                        var tempbalAmt = parseFloat(txttotal.value) - paidAmt;
                        txtbal.value = tempbalAmt.toString();
                        txttobe.value = parseFloat(txtbal.value);
                        curToPayAmtVal += parseFloat(txttobe.value);
                        txtbal.value = "0.00";
                        cbsel.checked = true;

                    }
                }
                fnlTotAmt += txttotal != null && txttotal.value.trim() != "" ? parseFloat(txttotal.value) : parseFloat("0");
                fnlPaidAmt += txtpaid != null && txtpaid.value.trim() != "" ? parseFloat(txtpaid.value) : parseFloat("0");
                fnlBalAmt += txtbal != null && txtbal.value.trim() != "" ? parseFloat(txtbal.value) : parseFloat("0");
            }
            curToPayAmt.innerHTML = "Total Amount To Be Paid : Rs." + curToPayAmtVal.toString() + " /-";
            txtmaintotalamount.value = fnlTotAmt.toString();
            txtmainpaidamount.value = fnlPaidAmt.toString();
            txtmainbalanceamount.value = fnlBalAmt.toString();
            txttotaltobepaid.value = curToPayAmtVal.toString();
        }
    ...
    <center>
        <div>
            <span class="fontstyleheader" style="color: Green;">Miscellaneous Receipt Entry</span>
        </div>
    </center>
                        ...
                        <table class="maintablestyle" style="height: 25px; float: left; margin-left: 20px;">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:CheckBox ID="cbAdvance" runat="server" Text="Advance" />
                                ...
                                <td colspan="4">
                                    <div id="div_rcpt" runat="server" visible="true">
                                        ...
                                        <asp:CheckBox ID="chl_MulRcpt" runat="server" Text="Multiple Receipt" Checked="false"
                                            AutoPostBack="true" Visible="false" OnCheckedChanged="chl_MulRcpt_OnCheckedChanged" />
                                    </div>
                                </td>
                            </tr>
                        </table>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:TextBox ID="txt_dept" runat="server" placeholder="Department" CssClass="textbox txtheight2"
                                                                                ReadOnly="true" onfocus="myFunction(this)"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                            ...
                                            <td colspan="2">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:LinkButton ID="btnAddFee" runat="server" Visible="false" OnClientClick="return addFeesDiv();"
                                                    ...
                                                    <tr>
                                                        <td id="checCashDD" runat="server" visible="false">
                                                            ...
                                                            <asp:RadioButton ID="rb_NEFT" runat="server" RepeatDirection="Horizontal" GroupName="same3"
                                                                Text="NEFT" onchange="rb_ccdc_Onchange('card')"></asp:RadioButton>
                                                        ...
                                                        <td>
                                                            <asp:Label runat="server" ID="lblfyear" Visible="false" Text="FinanceYear" Width="85px"></asp:Label>
                                                        </td>
                                                        <td id="tdfyear" runat="server" visible="false">
                ...
                <div id="divgrid" runat="server" visible="false" style="width: 980px; height: 350px;
                    ...
                    <div id="div_grid" runat="server" style="width: 980px; height: 310px; overflow: auto;
                        ...
                        <asp:GridView ID="grid_Details" runat="server" AutoGenerateColumns="false" GridLines="Both"
                            OnRowDataBound="grid_Details_OnRowDataBound">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Term" HeaderStyle-BackColor="#0CA6CA" HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <center>
                                            <asp:Label ID="lbl_textCode" runat="server" Text='<%#Eval("TextCode") %>' Visible="false"></asp:Label>
                                            <asp:Label ID="lbl_textval" runat="server" Text='<%#Eval("Textval") %>' Width="55px"></asp:Label></center>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Fee Amt" HeaderStyle-BackColor="#0CA6CA" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <center>
                                            <asp:HiddenField ID="hf_fee_amt" runat="server" Value='<%#Eval("Fee_Amount") %>' />
                                            <asp:TextBox ID="txt_fee_amt" runat="server" CssClass="  textbox txtheight" Width="70px"
                                                Text='<%#Eval("Fee_Amount") %>' onchange="return checkfeeamount();" Height="15px"
                                                ReadOnly="false" Style="text-align: right;"></asp:TextBox></center>
                                ...
                                <asp:TemplateField HeaderText="Deduction" HeaderStyle-BackColor="#0CA6CA" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <center>
                                            <asp:HiddenField ID="hf_deduct_amt" runat="server" Value='<%#Eval("Deduct") %>' />
                                            <asp:TextBox ID="txt_deduct_amt" runat="server" CssClass="  textbox txtheight" Text='<%#Eval("Deduct") %>'
                                                Height="15px" Width="60px" onchange="return checkfeeamount();" ReadOnly="false"
                                ...
                                <asp:TemplateField HeaderText="Financial Year" Visible="true" HeaderStyle-BackColor="#0CA6CA"
                                    ...
                                    <ItemTemplate>
                                        <center>
                                            ...
                                            <asp:Label ID="lblfinyear" runat="server" Text='<%#Eval("finyear") %>' Width="80px"></asp:Label>
                                        </center>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
            ...
            <div style="background-color: White; height: 500px; width: 950px; border: 5px solid #0CA6CA;
                ...
                <asp:Panel ID="pnlCommonLedger" runat="server">
                    ...
                    <center>
                        ...
                        <div style="padding-top: 5px; text-align: center;">
                            <asp:Button ID="btn_ledgersave" runat="server" Visible="false" OnClick="btnpopLedgersave_Click"
                                Font-Names="Book Antiqua" Font-Size="Medium" Text="Save" CssClass="textbox btn2 textbox1" />
                            <asp:Button ID="btn_ledgerExit" runat="server" Visible="false" OnClientClick="return hideFeeDiv();"
    ...
    <center>
        <div id="divSchemeSettings" runat="server" class="popupstyle popupheight1 " style="width: 100%;
            ...
            <div>
                <center>
                    <div id="maindiv" runat="server" class="maindivstyle" style="width: 950px; height: 480px;">
                        <center>
                            <div>
                        ...
                        <fieldset id="fldRad" style="width: 450px; border: 1px solid #999999; background-color: #F0F0F0;
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox ID="cbduepaid" runat="server" Checked="true" Enabled="false" Text="Include Due and Paid" />
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
