<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceMod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="DeptWiseStudPaidCountReport.aspx.cs" Inherits="DeptWiseStudPaidCountReport" %>
                ...
                <div id="maindiv" runat="server" class="maindivstyle" style="width: 1000px; height: auto">
                    <table class="maintablestyle">
                        <tr>
                            ...
                            <td id="tdmem" runat="server" visible="false">
                        ...
                        <tr>
                            <td colspan="2" id="tdcon" runat="server" visible="false">
                                <asp:CheckBox ID="cbconcession" runat="server" Text="Include Concession" />
                            </td>
                            <td>
