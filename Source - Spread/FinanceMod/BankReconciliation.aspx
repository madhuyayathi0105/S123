<%@ Page Title="" Language="C#" MasterPageFile="~/Financemod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="BankReconciliation.aspx.cs" Inherits="BankReconciliation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <body>
        ...
        <div>
            <center>
                <div>
                    <span class="fontstyleheader" style="color: Green;">Bank Reconciliation</span></div>
            </center>
        </div>
        <center>
                ...
                <center>
                    <div>
                        <table class="maintablestyle">
                            ...
                            <td colspan="5" align="left">
                                ...
                                <td colspan="5">
                                    <fieldset style="height: 15px; width: 353px;">
                                        <asp:RadioButton ID="rbtodeposit" runat="server" Checked="true" Text="ToBe Deposited"
                    ...
                    <div>
                        <table>
                            <tr>
                                <td>
                                    <fieldset id="fldtot" runat="server" visible="false" style="height: 20px; width: 250px;">
                                        <table align="left">
                                            <tr>
                    ...
                    <center>
                        ...
                        <FarPoint:FpSpread ID="FpSpread1" runat="server" Visible="false" BorderStyle="NotSet"
                            BorderWidth="0px" ActiveSheetViewIndex="0" OnButtonCommand="FpSpread1_OnButtonCommand"
                    ...
                    <div id="Div6" runat="server" class="table" style="background-color: White; height: 150px;
                        ...
                        <center>
                            <table style="height: 100px; width: 100%">
                                ...
                                <tr>
                                    <td align="center">
                                        <asp:RadioButton ID="rbcancel" runat="server" Text="Do You Want Cancel The Receipt"
                                            GroupName="can" />
                                    </td>
                                </tr>
                                <tr>
