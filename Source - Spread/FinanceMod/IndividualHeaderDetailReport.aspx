<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceMod/FinanceSubSiteMaster.master" AutoEventWireup="true" CodeFile="IndividualHeaderDetailReport.aspx.cs" Inherits="FinanceMod_IndividualHeaderDetailReport" %>
 ...
 <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <body>
        ...
        <div>
            <center>
                <div>
                    <span class="fontstyleheader" style="color: Green;">Individual Header Detailed Report</span></div>
            </center>
        </div>
        <div>
            <center>
                           ...
                           <%-- <td>
                            ...
                            <td>
                                ...
                                <asp:Panel ID="Pconcession" runat="server" CssClass="multxtpanel">
                                    <asp:CheckBox ID="chkconcession" runat="server" Width="122px" Text="Select All" OnCheckedChanged="chkconcession_changed"
                                        AutoPostBack="True" />
