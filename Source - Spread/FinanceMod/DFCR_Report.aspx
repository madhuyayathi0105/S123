<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceMod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="DFCR_Report.aspx.cs" Inherits="DFCR_Report" %>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $('#<%=cbbfadm.ClientID %>').change(function () {
                    if ($(this).is(':checked')) {
                        $('#<%=cbWithoutAdm.ClientID %>').removeAttr('disabled');
                    }
                    else {
                        $('#<%=cbWithoutAdm.ClientID %>').attr('disabled', 'disabled');
                    }
                });
            });
        </script>
                ...
                <div id="maindiv" runat="server" class="maindivstyle" style="width: 1000px; height: auto">
                    <table class="maintablestyle">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddltype" runat="server" Style="height: 24px; width: 144px;"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:UpdatePanel ID="upd_paid" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txt_paid" runat="server" Style="height: 20px; width: 110px;" ReadOnly="true">--Select--</asp:TextBox>
                        ...
                        <tr>
                            <td colspan="8">
                                <table>
                                    <tr>
                                        <td colspan="2">
                                            <asp:CheckBox ID="checkdicon" runat="server" Text="Include Category" AutoPostBack="true"
                                                OnCheckedChanged="checkdicon_Changed" Font-Names="Book Antiqua" Style="width: 200px;" />
                                        </td>
                                        <td colspan="2">
                                            <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="txtinclude" Font-Names="Book Antiqua" Style="height: 20px; width: 164px;"
                                                        CssClass="Dropdown_Txt_Box" runat="server" ReadOnly="true" Width="145px">--Select--</asp:TextBox><%--Enabled="false"--%>
                                        ...
                                        <td colspan="2">
                                            <asp:CheckBox ID="chkfeeroll" runat="server" Text="Fee off the Role" Font-Names="Book Antiqua"
                                                Style="width: 200px;" />
                                            <asp:CheckBox ID="cbbfadm" runat="server" Text="Before Admission" Font-Names="Book Antiqua" />
                                            <asp:CheckBox ID="cbWithoutAdm" runat="server" Text="Without Admit" Enabled="false" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            ...
                                            <asp:CheckBox ID="cbabstract" runat="server" Text="Abstract" />
                                            <asp:CheckBox ID="cbdegwisetotal" runat="server" Text="Datewise Total" />
                                            <asp:CheckBox ID="cbdgreename" runat="server" Text="Without Date Total" />
                                            <asp:CheckBox ID="cbdeptName" runat="server" Text="Degree Name" />
                                            <asp:CheckBox ID="cbledgacr" runat="server" Text="Ledger Acr" Enabled="false" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                           <asp:CheckBox ID="Reason" runat="server" Text="Deduct Reason" />
                                        </td>
                                         <td>
                                           <asp:CheckBox ID="arrear" runat="server" Text="Arrear" />
                                        </td>
                                        <td>
                                        <asp:CheckBox ID="deptwiseTotal" runat="server" Text="Deptwise Total" />
                                        </td>
                                         <td>
                                         <%--  <asp:CheckBox ID="Payment" runat="server" Text="Payment" />--%>
                                           <asp:RadioButtonList ID="rbtype" runat="server" AutoPostBack="true" 
                                                RepeatDirection="Horizontal">
                                                <asp:ListItem Text="Receipt" Value="0" Selected="True"></asp:ListItem>
                    ...
                    <div id="divlabl" runat="server" visible="false">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lblneft" runat="server" Text="Neft" Font-Bold="True" Font-Names="Book Antiqua"
                                        Font-Size="Medium" BackColor="Aqua"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <center>
                        <div id="print" runat="server" visible="false">
                            ...
                            <asp:Button ID="btnprintmasterhed" runat="server" Font-Names="Book Antiqua" Font-Size="Medium"
                                Text="Print Setting" OnClick="btnprintmaster_Click" Height="32px" CssClass="textbox textbox1"
                                Width="100px" />
                            <asp:Button ID="btn_print" runat="server" Font-Names="Book Antiqua" Font-Size="Medium"
                                Text="Print" OnClick="btn_print_Click" Height="32px" CssClass="textbox textbox1"
                                Width="60px" />
