                ...
                if (!cbdate.Checked)
                {
                    ...
                    else if (ddlacctype.SelectedItem.Text.Trim() == "Header" || ddlacctype.SelectedItem.Text.Trim() == "Ledger")
                    {
                        ...
                        else if (ddlfeetype.SelectedItem.Text == "Yet To Be Paid")
                        {
                            ...
                            Query += " select  f.App_No,sum (TotalAmount),SUM( PaidAmount),sum(BalAmount)as Balance,FeeCategory" + hdStr + " from FT_FeeAllot f,Registration r ,Degree d,Department dt,Course c where f.App_No =r.App_No and r.degree_code =d.Degree_Code and d.Dept_Code =dt.Dept_Code and d.Course_Id =c.Course_Id  and ISNULL (BalAmount ,TotalAmount)<>0  and d.college_code ='" + collegecode + "'";
                            if (delflg != "")
                                Query += delflg;
                            if (batch.Trim() != "")
                                Query += " and r.batch_year  in ('" + batch + "')";
                ...
                else
                {
                    ...
                    else if (ddlacctype.SelectedItem.Text == "Header" || ddlacctype.SelectedItem.Text == "Ledger")
                    {
                        ...
                        else if (ddlfeetype.SelectedItem.Text == "Yet To Be Paid")
                        {
                            #region query
                            //demand amount
                            Query = " select SUM(TotalAmount) as Demand, f.App_No,r.degree_code,r.Batch_Year  from FT_FeeAllot f,Registration r where f.App_No =r.App_No ";
                            if (delflg != "")
                                Query += delflg;
                            if (batch.Trim() != "")
                                Query += " and r.batch_year  in ('" + batch + "')";
                            ...
                            //header and ledger
                            Query += " select SUM(TotalAmount) as Demand, f.App_No,f.FeeCategory,r.degree_code,r.Batch_Year" + hdStr + "  from FT_FeeAllot f,Registration r where f.App_No =r.App_No ";
                            if (delflg != "")
                                Query += delflg;
                            if (batch.Trim() != "")
                                Query += " and r.batch_year  in ('" + batch + "')";
                            ...
                            if (fnlYear.Trim() != "")
                                Query += " and f.FinYearFK   in ('" + fnlYear + "')";
                            Query += "  group by f.App_No,f.FeeCategory,r.degree_code,r.Batch_Year" + hdStr + "";
                            ...
                            Query += " group by f.App_No,f.FeeCategory,r.degree_code,r.Batch_Year,r.Stud_Name,r.Roll_No,r.roll_admit,r.Reg_No" + hdStr + "";
    ...
    public void btnprintmaster_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (PaidOrYettobePaid == "Yet To Be Paid")
                PaidOrYettobePaid = "Demand Report";
            ...
            if (cbdate.Checked == true && ddltype.Items.Count > 0)
            {
                ...
                {
                    degreedetails = "Daily Fees Collection Report" + '\n' + PaidOrYettobePaid + '@' + " Date   : " + txt_fromdate.Text + " To " + txt_todate.Text + "" + '@' + "Stream : " + ddltype.SelectedItem.Text + "" + '@' + "Header Name: " + getCblSelectedTextVal(cblheader) + '@' + "Pay Mode: " + getCblSelectedTextVal(chkl_paid);
                }
                else
                {
                    degreedetails = "Daily Fees Collection Report" + '\n' + PaidOrYettobePaid + '@' + " Date   : " + txt_fromdate.Text + " To " + txt_todate.Text + "" + '@' + "Stream : Day & Evening " + '@' + "Header Name: " + getCblSelectedTextVal(cblheader) + '@' + "Pay Mode: " + getCblSelectedTextVal(chkl_paid);
                }
            }
            ...
            else if (ddltype.Items.Count > 0)
            {
                if (ddltype.SelectedItem.Value != "Both")
                {
                    degreedetails = "Daily Fees Collection Report " + '\n' + PaidOrYettobePaid + '@' + "Stream : " + ddltype.SelectedItem.Text + "" + '@' + "Header Name: " + getCblSelectedTextVal(cblheader) + '@' + "Pay Mode: " + getCblSelectedTextVal(chkl_paid);
                }
                else
                {
