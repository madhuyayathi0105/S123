<%@ Page Title="" Language="C#" MasterPageFile="~/Financemod/FinanceSubSiteMaster.master" AutoEventWireup="true"
    CodeFile="SmsSendtoStudent.aspx.cs" Inherits="SmsSendtoStudent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <body>
        ...
        <div>
            <center>
                <div>
                    <span class="fontstyleheader" style="color: Green;">Send Sms To Students</span></div>
            </center>
        </div>
        <div>
            <center>
                <div id="maindiv" runat="server" class="maindivstyle" style="width: 1000px; height: auto">
                    <center>
                        <table>
                            ...
                            <tr>
                                <td id="templateforSpread2" align="left" runat="server">
