<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceMod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="FinanceDailyCollectionStatementReport.aspx.cs"
    Inherits="FinanceDailyCollectionStatementReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <body>
        ...
        <div>
            <center>
                <div>
                    <span class="fontstyleheader" style="color: Green;">Finance Daily Collection Statement
                        Report</span></div>
            </center>
        </div>
        <div>
