<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceMod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="FeeConcessionByManagement.aspx.cs" Inherits="FinanceMod_FeeConcessionByManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <body>
        ...
        <div>
            <center>
                <div>
                    <span class="fontstyleheader" style="color: Green;">Student Wise Fee Concession Report </span></div>
            </center>
        </div>
        <div>
            <center>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlstream" runat="server" Enabled="false" OnSelectedIndexChanged="ddlstream_OnSelectedIndexChanged"
                                    AutoPostBack="true" CssClass="textbox  ddlheight" Style="width: 134px;">
                                </asp:DropDownList>
                            </td>
                            <td>
                                <span>Batch</span>
