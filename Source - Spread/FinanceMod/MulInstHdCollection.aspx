<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceMod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="MulInstHdCollection.aspx.cs" Inherits="MulInstHdCollection" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div>
        <center>
            <div>
                <span id="sphd" runat="server" class="fontstyleheader" style="color: Green;">Headerwise
                    Collection</span>
            </div>
        </center>
    </div>
                ...
                <ContentTemplate>
                    <div id="maindiv" runat="server" class="maindivstyle" style="width: 1000px; height: auto">
                        <table class="maintablestyle">
                                ...
                                <td>
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:Panel ID="Panel1" runat="server" CssClass="multxtpanel multxtpanleheight" Style="width: 250px;
                                                height: auto;">
                                            ...
                                            <asp:PopupControlExtender ID="PopupControlExtender2" runat="server" TargetControlID="txtbank"
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label1" runat="server" Text="Other Bank"></asp:Label>
                                </td>
                                <td>
                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtobank" runat="server" Style="height: 20px; width: 100px;" ReadOnly="true">--Select--</asp:TextBox>
                                            <asp:Panel ID="Panel2" runat="server" CssClass="multxtpanel multxtpanleheight" Style="width: 250px;
                                                height: auto;">
                                                <asp:CheckBox ID="cbobank" runat="server" Width="100px" Text="Select All" AutoPostBack="True"
                                                    OnCheckedChanged="cbobank_OnCheckedChanged" />
                                                <asp:CheckBoxList ID="cblobank" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cblobank_OnSelectedIndexChanged">
                                                </asp:CheckBoxList>
                                            </asp:Panel>
                                            <asp:PopupControlExtender ID="PopupControlExtender4" runat="server" TargetControlID="txtobank"
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtinclude" Enabled="true" Font-Size="Medium" Font-Names="Book Antiqua"
                                                Style="height: 20px; width: 80px;" CssClass="Dropdown_Txt_Box" runat="server"
                                ...
                                <td id="tdfnl" runat="server" visible="false" colspan="2">
                                ...
                                <td colspan="10">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:CheckBox ID="cbDate" runat="server" Text="DateWise" />
                                            </td>
                                            <td id="tdJournal" runat="server" visible="false">
                                                <asp:CheckBox ID="cbJournal" runat="server" Text="Journal" />
                                            </td>
                                            <td id="tdOthers" runat="server" visible="false">
                                                <asp:CheckBox ID="cbIncOthers" runat="server" Text="Include Other" Checked="true" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="cbMonth" runat="server" Text="MonthWise" OnCheckedChanged="cbMonth_OnCheckedChanged"
                                                    AutoPostBack="true" />
                                            </td>
                                            <td>
                        ...
                        <br />
                        <asp:GridView ID="grdHeaderWiseCollection" Width="700px" runat="server" ShowFooter="false"
                            AutoGenerateColumns="true" ShowHeader="false" Font-Names="Book Antiqua" toGenerateColumns="false"
                            OnRowDataBound="grdHeaderWiseCollection_RowDataBound">
                            <HeaderStyle BackColor="#0CA6CA" ForeColor="Black" />
                        </asp:GridView>
                        <asp:GridView ID="GrdMonthwise" Width="700px" runat="server" ShowFooter="false" AutoGenerateColumns="true"
                            ShowHeader="false" Font-Names="Book Antiqua" toGenerateColumns="false" OnRowDataBound="GrdMonthwise_RowDataBound">
                            <%----%>
                            <HeaderStyle BackColor="#0CA6CA" ForeColor="Black" />
                        </asp:GridView>
                    </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                <ContentTemplate>
                    <div id="div_staffLook" runat="server" visible="false" class="popupstyle popupheight1 ">
                        ...
                        <br />
                        <br />
                        <div style="background-color: White; height: 560px; width: 650px; border: 5px solid #0CA6CA;
