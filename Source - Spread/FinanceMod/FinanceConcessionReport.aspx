<%@ Page Title="" Language="C#" MasterPageFile="~/Financemod/FinanceSubSiteMaster.master" AutoEventWireup="true"
    CodeFile="FinanceConcessionReport.aspx.cs" Inherits="FinanceConcessionReport"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="head">
        <asp:Label ID="lbl_head" runat="server" Font-Bold="true" Style="left: 340px; top: 0px;
            ...
            Text="Finance Year Concession Report"></asp:Label>
    </div>
    <body>
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <div class="mainbatch">
                    ...
                    <asp:Panel ID="pdegree" runat="server" CssClass="multxtpanel" Width="128px"
                    ...
                    <asp:Label runat="server" ID="lblfyear" Text="Finance Year" Font-Bold="True" Font-Names="Book Antiqua"
                        Font-Size="Medium" ForeColor="White" Style="position: absolute; top: 49px; left: 11px;
                        width: 100px"></asp:Label>
                    <asp:TextBox ID="txtfyear" CssClass="Dropdown_Txt_Box" Font-Bold="true" Font-Names="Book Antiqua"
                        Style="position: absolute; left: 126px; top: 49px;" runat="server" ReadOnly="true"
                        Width="145px">--Select--</asp:TextBox>
                    ...
                    <asp:Label ID="lblheader" runat="server" Font-Names="Book Antiqua" Font-Bold="true"
                        ForeColor="white" Font-Size="Medium" Style="position: absolute; left: 285px;
                        top: 49px;" Text="Header"></asp:Label>
                    <asp:TextBox ID="txtHeader" CssClass="Dropdown_Txt_Box" Font-Bold="true" Font-Names="Book Antiqua"
                        Style="position: absolute; left: 340px; top: 48px;" runat="server" ReadOnly="true"
                        Width="100px">--Select--</asp:TextBox>
                    ...
                    <asp:Label ID="lblledger" runat="server" Font-Names="Book Antiqua" Font-Bold="true"
                        ForeColor="white" Font-Size="Medium" Style="position: absolute; left: 445px;
                        top: 49px;" Text="Ledger"></asp:Label>
                    <asp:TextBox ID="txtledger" CssClass="Dropdown_Txt_Box" Font-Bold="true" Font-Names="Book Antiqua"
                        Style="position: absolute; left: 500px; top: 48px;" runat="server" ReadOnly="true"
                        Width="100px">--Select--</asp:TextBox>
                    ...
                    <asp:Label runat="server" ID="lblconscession" Text="Concession" Font-Bold="True"
                        ...
                        top: 49px; left: 606px; width: 90px"></asp:Label>
                    <asp:TextBox ID="txtcons" CssClass="Dropdown_Txt_Box" Font-Bold="true" Font-Names="Book Antiqua"
                        Style="position: absolute; left: 691px; top: 48px;" runat="server" ReadOnly="true"
                        Width="100px">--Select--</asp:TextBox>
                    ...
                    <asp:PopupControlExtender ID="PopupControlExtender6" runat="server" TargetControlID="txtcons"
                    ...
                    <asp:Label runat="server" ID="lblcategory" Text="Category" Font-Bold="True" Font-Names="Book Antiqua"
                        Font-Size="Medium" ForeColor="White" Style="position: absolute; top: 49px; left: 800px;
                        width: 105px"></asp:Label>
                    <asp:TextBox ID="txtcetgory" CssClass="Dropdown_Txt_Box" Font-Bold="true" Font-Names="Book Antiqua"
                        Style="position: absolute; left: 865px; top: 48px;" runat="server" ReadOnly="true"
                    ...
                    <asp:Button ID="btngo" runat="server" Font-Names="Book Antiqua" Text="Go" OnClick="btngo_Click"
                        Font-Size="Medium" Font-Bold="true" Style="top: 47px; left: 974px; position: absolute;" />
                </div>
                <br />
                <br />
                <br />
