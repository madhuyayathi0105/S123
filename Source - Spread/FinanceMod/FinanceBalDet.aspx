<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceMod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="FinanceBalDet.aspx.cs" Inherits="FinanceBalDet" %>
        ...
        <center>
            <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                    ...
                    <div id="maindiv" runat="server" class="maindivstyle" style="width: 1000px; height: auto">
                        <table class="maintablestyle">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:CheckBox ID="cbloadMaster" runat="server" Visible="false" Text="Load Master"
                                        AutoPostBack="true" OnCheckedChanged="cbloadMaster_Changed" />
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <%--   <td>
                            <asp:DropDownList ID="ddlfinyear" AutoPostBack ="true"  runat="server" CssClass="textbox ddlstyle ddlheight3">
                            </asp:DropDownList>
                        </td>--%>
                                <td id="tdfnl" runat="server">
                                ...
                                <td>
                                    <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txt_type" runat="server" Height="15px" Width="83px" CssClass="textbox  txtheight2"
                                                ReadOnly="true">--Select--</asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="cbCurSem" runat="server" Text="Current Year" Visible="false" />
                                </td>
                                <%--//added by abarna 26.01.2018--%>
                                <td colspan="3">
                                    <asp:RadioButtonList ID="rblhostelmode" runat="server" RepeatDirection="Horizontal"
                                        AutoPostBack="true" OnSelectedIndexChanged="rblhostelmode_Selected" Visible="false">
                                        <asp:ListItem Text="Cumulative" Selected="True"></asp:ListItem>
                                        <asp:ListItem Text="HostelWise"></asp:ListItem>
                                        <asp:ListItem Text="CollegeWise"></asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                                <%--  ------------------------------------%>
                                <%-- </td>
                                ...
                                <td>
                                    <asp:UpdatePanel ID="UpdatePanel19" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:PopupControlExtender ID="PopupControlExtender7" runat="server" TargetControlID="txtQuota"
                        ...
                        <asp:GridView ID="grdInstWiseBalReport" Width="900px" runat="server" ShowFooter="false"
                            AutoGenerateColumns="true" Font-Names="Book Antiqua" ShowHeader="false" toGenerateColumns="false"
                            OnRowDataBound="grdInstWiseBalReport_RowDataBound" OnRowCreated="grdInstWiseBalReport_OnRowCreated"
                            OnSelectedIndexChanged="grdInstWiseBalReport_SelectedIndexChanged">
                ...
                <Triggers>
                    ...
                    <asp:PostBackTrigger ControlID="grdInstWiseBalReport" />
                </Triggers>
            </asp:UpdatePanel>
        </center>
        <center>
