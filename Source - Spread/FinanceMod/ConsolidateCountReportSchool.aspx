<%@ Page Title="" Language="C#" MasterPageFile="~/Financemod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="ConsolidateCountReportSchool.aspx.cs" Inherits="ConsolidateCountReportSchool" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <body>
        ...
        <div>
            <center>
                <div>
                    <span class="fontstyleheader" style="color: Green;">Consolidate Count Report</span></div>
            </center>
        </div>
        <div>
            <center>
                <div id="maindiv" runat="server" class="maindivstyle" style="width: 1000px; height: auto">
                    <table class="maintablestyle">
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:CheckBox ID="cbbefore" runat="server" Text="Include Before Admission" />
                            </td>
                            <td>
                                Scheme
                            </td>
                            <td>
                                <asp:UpdatePanel ID="updScheme" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtScheme" Font-Size="Medium" Font-Names="Book Antiqua" Style="height: 20px;
                                            width: 120px;" CssClass="Dropdown_Txt_Box" runat="server" ReadOnly="true">--Select--</asp:TextBox>
                                        <asp:Panel ID="pnlScheme" runat="server" CssClass="multxtpanel multxtpanleheight"
                                            Width="172px">
                                            <asp:CheckBox ID="cbScheme" runat="server" Text="Select All" Font-Size="Medium" Font-Names="Book Antiqua"
                                                OnCheckedChanged="cbScheme_OnCheckedChanged" AutoPostBack="True" />
                                            <asp:CheckBoxList ID="chklScheme" runat="server" Font-Size="Medium" Font-Names="Book Antiqua"
                                                OnSelectedIndexChanged="chklScheme_OnSelectedIndexChanged" AutoPostBack="True">
                                            </asp:CheckBoxList>
                                        </asp:Panel>
                                        <asp:PopupControlExtender ID="pceScheme" runat="server" TargetControlID="txtScheme"
                                            PopupControlID="pnlScheme" Position="Bottom">
                                        </asp:PopupControlExtender>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
