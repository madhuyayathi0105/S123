<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceMod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="DailyCollectionDetailedStatementReport.aspx.cs"
    Inherits="DailyCollectionDetailedStatementReport" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="Server">
    <body>
        ...
        <div>
            <center>
                <div>
                    <span class="fontstyleheader" style="color: Green;">Finance Daily Collection Detailed
                        Statement Report</span></div>
            </center>
        </div>
        <div>
            <center>
                <div id="maindiv" runat="server" class="maindivstyle" style="width: 1000px; height: auto">
                    <table class="maintablestyle">
                        <tr>
                            <td>
                                <asp:Label ID="Label1" Text="Others" runat="server"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtfyear" Style="height: 20px;" CssClass="Dropdown_Txt_Box" runat="server"
                                            ReadOnly="true" Width="118px">--Select--</asp:TextBox>
                        ...
                        <tr>
                            <td colspan="10">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:CheckBox ID="cbtermwise" runat="server" Text="Term/Sem/Year Paid" Checked="false"
                                                AutoPostBack="true" OnCheckedChanged="cbtermwise_Changed" />
                                        </td>
                                        <td colspan="2">
                                            <asp:RadioButtonList ID="rblpaidtype" Visible="false" runat="server" RepeatDirection="Horizontal">
                                                <asp:ListItem Text="Full" Value="0" Selected="True"></asp:ListItem>
                                                <asp:ListItem Text="Partial" Value="1"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                        <td>
                                            <asp:CheckBox ID="cbincludedate" Visible="false" runat="server" Text="Date" Checked="true" />
                                        </td>
                                        <td>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="txt_type" runat="server" Height="15px" CssClass="textbox  txtheight2"
                                                        ReadOnly="true" Width="59px">--Select--</asp:TextBox>
                                        ...
                                        <td id="td1" runat="server">
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="txtuser" Style="height: 20px;" CssClass="Dropdown_Txt_Box" runat="server"
                                                        ReadOnly="true" Width="82px">--Select--</asp:TextBox>
                                                    ...
                                                    <asp:PopupControlExtender ID="PopupControlExtender4" runat="server" TargetControlID="txtuser"
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="txtinclude" Enabled="true" Font-Size="Medium" Font-Names="Book Antiqua"
                                                        Style="height: 20px;" CssClass="Dropdown_Txt_Box" runat="server" ReadOnly="true"
                                                        Width="132px">--Select--</asp:TextBox>
                                        ...
                                        <td>
                                            <asp:CheckBox ID="cbBillwise" runat="server" Text="Bill No Wise" />
                                        </td>
                                        <td>
                ...
                <center>
                    <div id="print" runat="server" visible="false">
                        ...
                        <asp:Button ID="btnprintmasterhed" runat="server" Font-Names="Book Antiqua" Font-Size="Medium"
                            Visible="false" Text="Print" OnClick="btnprintmaster_Click" Height="32px" Style="margin-top: 10px;"
