<%@ Page Title="" Language="C#" MasterPageFile="~/Financemod/FinanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="DailyPayment_Report.aspx.cs" Inherits="DailyPayment_Report" %>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            function accType() {
                ...
                date = parseInt(fromDate.substring(0, 2));
                month = parseInt(fromDate.substring(3, 5));
                year = parseInt(fromDate.substring(6, 10));

                date1 = parseInt(toDate.substring(0, 2));
                month1 = parseInt(toDate.substring(3, 5));
                year1 = parseInt(toDate.substring(6, 10));
                var today = new Date();
        ...
        <div>
            <center>
                <div>
                    <span class="fontstyleheader" style="color: Green;">Daily Payment Report</span></div>
            </center>
        </div>
        <div>
            <center>
                                        ...
                                        <div>
                                            <table id="maintable" runat="server" class="maintablestyle">
                                                <tr>
                                                    <td colspan="2">
                                                        <fieldset>
                                                            <asp:CheckBox ID="cbReceipt" runat="server" Text="Receipt" Checked="true"  AutoPostBack="false" OnCheckedChanged="cbReceipt_Changed" />
                                                            <asp:CheckBox ID="cbPayment" runat="server" Text="Payment"  Checked="true"  AutoPostBack="false" OnCheckedChanged="cbPayment_Changed" />
                                                        </fieldset>
                                                    </td>
                                                    <td colspan="4">
                                                        <fieldset>
                                                            ...
                                                            <asp:CheckBox ID="chkcumul" runat="server" Visible="false" Text="Cumulative" AutoPostBack="true"
                                                                OnCheckedChanged="chkcumul_OnCheckedChanged" />
                                                            <asp:RadioButton ID="cbAll" runat="server" Text="All" GroupName="s1" AutoPostBack="true"
                                                                OnCheckedChanged="cbAll_OnCheckedChanged" />
                                                        </fieldset>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="4" id="tddivsearch" runat="server" visible="false">
                            ...
                            <tr>
                                <td>
                                    <center>
                                        ...
                                        <FarPoint:FpSpread ID="FpSpread1" runat="server" Visible="false" BorderStyle="Solid" BorderWidth="0px"
