...
public partial class SubjectWiseAttendanceReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                grouporusercode1 = " group_code=" + Convert.ToString(group_user).Trim() + "";
            }
            else
            {
    ...
    protected void btnExcel1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Convert.ToString(reportname).Trim() != "")
            {
                ...
                {
                    da.printexcelreport(FpAttendanceReport, reportname);
                }
                lbl_norec1.Visible = false;
            }
            else
    ...
    public void Init_Spread()
    {
        try
        {
            ...
            FpAttendanceReport.Sheets[0].RowCount = 0;
            FpAttendanceReport.Sheets[0].ColumnCount = 6;
            ...
            FpAttendanceReport.Sheets[0].Columns[0].Width = 40;
            FpAttendanceReport.Sheets[0].Columns[1].Width = 60;
            ...
            FpAttendanceReport.Sheets[0].ColumnHeader.Cells[0, 1].Text = "Admission No";
            FpAttendanceReport.Sheets[0].ColumnHeader.Cells[0, 2].Text = "Roll No";
            FpAttendanceReport.Sheets[0].ColumnHeader.Cells[0, 3].Text = "Reg No";
            FpAttendanceReport.Sheets[0].ColumnHeader.Cells[0, 4].Text = "Student Type";
            FpAttendanceReport.Sheets[0].ColumnHeader.Cells[0, 5].Text = "Student Name";
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!string.IsNullOrEmpty(collegeCode) && !string.IsNullOrEmpty(newBatchYear) && !string.IsNullOrEmpty(newBranchCode) && !string.IsNullOrEmpty(newsemester) && !string.IsNullOrEmpty(subjectNo))
            {
                ...
                string qryStudentStaffSelector = string.Empty;
                bool staffSelector = false;
                string minimumabsentsms = dirAcc.selectScalarString("select LinkValue from New_InsSettings where LinkName='Studnet Staff Selector' and college_code='" + collegeCode + "'");
                ...
                if (dsStudentsList.Tables.Count > 0 && dsStudentsList.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (noOfHours > 0)
                    {
                        foreach (DataRow drStudent in dsStudentsList.Tables[0].Rows)
                        {
                            ...
                            FpAttendanceReport.Sheets[0].RowCount++;
                            rowCount = FpAttendanceReport.Sheets[0].RowCount - 1;
                            if (!hatsplhrattendance.Contains(rollNo.Trim().ToLower()))
                            {
                                hatsplhrattendance.Add(rollNo.Trim().ToLower(), rowCount);
                            }
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 0].Text = Convert.ToString(sno).Trim();
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 0].Locked = true;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 0].Font.Name = "Book Antiqua";
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 0].HorizontalAlign = HorizontalAlign.Center;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 0].VerticalAlign = VerticalAlign.Middle;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 1].Text = Convert.ToString(admissionNo).Trim();
                            ...
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 1].Note = Convert.ToString(dtAdmissionDate.ToString("yyyy/MM/dd")).Trim();
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 1].Locked = true;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 1].Font.Name = "Book Antiqua";
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 1].HorizontalAlign = HorizontalAlign.Left;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 1].VerticalAlign = VerticalAlign.Middle;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 2].Text = Convert.ToString(rollNo).Trim();
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 2].Locked = true;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 2].Font.Name = "Book Antiqua";
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 2].HorizontalAlign = HorizontalAlign.Left;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 2].VerticalAlign = VerticalAlign.Middle;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 3].Text = Convert.ToString(regNo).Trim();
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 3].Locked = true;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 3].Font.Name = "Book Antiqua";
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 3].HorizontalAlign = HorizontalAlign.Left;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 3].VerticalAlign = VerticalAlign.Middle;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 4].Text = Convert.ToString(studentType).Trim();
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 4].Locked = true;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 4].Font.Name = "Book Antiqua";
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 4].HorizontalAlign = HorizontalAlign.Left;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 4].VerticalAlign = VerticalAlign.Middle;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 5].Text = Convert.ToString(studentName).Trim();
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 5].Locked = true;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 5].Font.Name = "Book Antiqua";
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 5].HorizontalAlign = HorizontalAlign.Left;
                            FpAttendanceReport.Sheets[0].Cells[FpAttendanceReport.Sheets[0].RowCount - 1, 5].VerticalAlign = VerticalAlign.Middle;
                            sno++;
                        }
                        htSplHr.Clear();
                        ...
                        if (subjectNoSelected.Length > 0)
                        {
                            ...
                            DataTable dtSchedule = new DataTable(); DataTable dtAlterSchedule = new DataTable();
                            ...
                            //bb
                            SemesterandAlternateSchedule(collegecode, newBatchYear, newBranchCode.Replace("'", ""), newsemester, sectionName, dtFromDate.ToString("MM/dd/yyyy"), dtToDate.ToString("MM/dd/yyyy"), noOfHours, ref  dtSchedule, ref  dtAlterSchedule);

                            dsAlterSchedule1.Tables.Add(dtAlterSchedule);
                            dsSemesterSchedule1.Tables.Add(dtSchedule);
                            foreach (string subjects in subjectNoSelected)
                            {
                                ...
                                attnd_hr = 0;
                                tot_hr = 0;
                                FpAttendanceReport.Sheets[0].ColumnCount = FpAttendanceReport.Sheets[0].ColumnCount + 6;
                                FpAttendanceReport.Sheets[0].ColumnHeader.Cells[0, FpAttendanceReport.Sheets[0].ColumnCount - 6].Text = subjectAcronymn;
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 6].Width = 100;
                                FpAttendanceReport.Sheets[0].ColumnHeaderSpanModel.Add(0, FpAttendanceReport.Sheets[0].ColumnCount - 6, 1, 6);
                                FpAttendanceReport.Sheets[0].ColumnHeader.Cells[1, (FpAttendanceReport.Sheets[0].ColumnCount - 6)].Text = "Con. Hrs";
                                FpAttendanceReport.Sheets[0].ColumnHeader.Cells[1, (FpAttendanceReport.Sheets[0].ColumnCount - 5)].Text = "Present";
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 5].Width = 100;
                                FpAttendanceReport.Sheets[0].ColumnHeader.Cells[1, (FpAttendanceReport.Sheets[0].ColumnCount - 4)].Text = "OD";
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 4].Width = 100;
                                FpAttendanceReport.Sheets[0].ColumnHeader.Cells[1, (FpAttendanceReport.Sheets[0].ColumnCount - 3)].Text = "Tot.Hrs";
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 3].Width = 100;
                                FpAttendanceReport.Sheets[0].ColumnHeader.Cells[1, (FpAttendanceReport.Sheets[0].ColumnCount - 2)].Text = "Absent";
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 2].Width = 100;
                                FpAttendanceReport.Sheets[0].ColumnHeader.Cells[1, (FpAttendanceReport.Sheets[0].ColumnCount - 1)].Text = "  \t\t%\t\t  ";
                                FpAttendanceReport.Sheets[0].ColumnHeader.Cells[1, (FpAttendanceReport.Sheets[0].ColumnCount - 1)].Font.Bold = true;
                                FpAttendanceReport.Sheets[0].ColumnHeader.Cells[0, (FpAttendanceReport.Sheets[0].ColumnCount - 1)].Note = "0";
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 1].Width = 100;
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 6].Resizable = false;
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 6].Locked = true;
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 5].Resizable = false;
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 5].Locked = true;
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 4].Resizable = false;
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 4].Locked = true;
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 3].Resizable = false;
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 3].Locked = true;
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 2].Resizable = false;
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 2].Locked = true;
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 1].Resizable = false;
                                FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 1].Locked = true;
                                sno = 0;
                                int countInvisible = 0;
                                for (int row_cnt = 0; row_cnt < FpAttendanceReport.Sheets[0].RowCount; row_cnt++)
                                {
                                    bool check_flag = false;
                                    attnd_hr = 0;
                                    roll_no = Convert.ToString(FpAttendanceReport.Sheets[0].Cells[row_cnt, 2].Text).Trim();
                                    if (has_load_rollno.Contains(roll_no.Trim().ToLower()))
                                    {
                                        ...
                                        if (FpAttendanceReport.Sheets[0].Rows[row_cnt].Visible == true)
                                        {
                                            sno++;
                                            FpAttendanceReport.Sheets[0].Cells[row_cnt, 0].Text = sno.ToString();
                                            FpAttendanceReport.Sheets[0].Cells[row_cnt, 0].Locked = true;
                                            FpAttendanceReport.Sheets[0].Cells[row_cnt, 0].Font.Name = "Book Antiqua";
                                            FpAttendanceReport.Sheets[0].Cells[row_cnt, 0].HorizontalAlign = HorizontalAlign.Center;
                                            FpAttendanceReport.Sheets[0].Cells[row_cnt, 0].VerticalAlign = VerticalAlign.Middle;
                                        }
                                        double hrs = 0;
                                        ...
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, (FpAttendanceReport.Sheets[0].ColumnCount - 5)].Text = attnd_hr.ToString();
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 5].Locked = true;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 5].Font.Name = "Book Antiqua";
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 5].HorizontalAlign = HorizontalAlign.Center;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 5].VerticalAlign = VerticalAlign.Middle;
                                    }
                                    tot_hr = 0;
                                    ...
                                    if (has_od.Contains(roll_no.Trim().ToLower()))
                                    {
                                        ...
                                        check_flag = true;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, (FpAttendanceReport.Sheets[0].ColumnCount - 4)].Text = od_count.ToString();
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 4].Locked = true;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 4].Font.Name = "Book Antiqua";
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 4].HorizontalAlign = HorizontalAlign.Center;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 4].VerticalAlign = VerticalAlign.Middle;
                                    }
                                    if (check_flag == false)
                                    {
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 4].Text = "0";
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 4].Locked = true;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 4].Font.Name = "Book Antiqua";
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 4].HorizontalAlign = HorizontalAlign.Center;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 4].VerticalAlign = VerticalAlign.Middle;
                                    ...
                                    {
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 3].Text = "-";
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 3].Locked = true;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 3].Font.Name = "Book Antiqua";
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 3].HorizontalAlign = HorizontalAlign.Center;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 3].VerticalAlign = VerticalAlign.Middle;
                                    }
                                    else
                                    {
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 3].Text = (attnd_hr + od_count).ToString();
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 3].Locked = true;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 3].Font.Name = "Book Antiqua";
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 3].HorizontalAlign = HorizontalAlign.Center;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 3].VerticalAlign = VerticalAlign.Middle;
                                    ...
                                    {
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 2].Text = "-";
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 2].Locked = true;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 2].Font.Name = "Book Antiqua";
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 2].HorizontalAlign = HorizontalAlign.Center;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 2].VerticalAlign = VerticalAlign.Middle;
                                    }
                                    else
                                    {
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 2].Text = (tot_hr - (attnd_hr + od_count)).ToString();  //(tot_hr - attnd_hr).ToString();
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 2].Locked = true;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 2].Font.Name = "Book Antiqua";
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 2].HorizontalAlign = HorizontalAlign.Center;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 2].VerticalAlign = VerticalAlign.Middle;
                                    }
                                    FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 6].Text = tot_hr.ToString();
                                    double hrsCon = 0;
                                    ...
                                    FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 6].Locked = true;
                                    FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 6].Font.Name = "Book Antiqua";
                                    FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 6].HorizontalAlign = HorizontalAlign.Center;
                                    FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 6].VerticalAlign = VerticalAlign.Middle;
                                    if (FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 3].Text == "0" && tot_hr == 0)
                                    {
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 1].Text = "-";
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 1].Locked = true;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 1].Font.Name = "Book Antiqua";
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 1].HorizontalAlign = HorizontalAlign.Center;
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 1].VerticalAlign = VerticalAlign.Middle;
                                    }
                                    else
                                    {
                                        ...
                                        FpAttendanceReport.Sheets[0].Cells[row_cnt, FpAttendanceReport.Sheets[0].ColumnCount - 1].Text = attnd_perc.ToString();
                                        double hrsPer = 0;
                                ...
                                int rowValue = 0;
                                for (int row_visible = 0; row_visible < FpAttendanceReport.Sheets[0].RowCount; row_visible++)
                                {
                                    if (FpAttendanceReport.Sheets[0].Rows[row_visible].Visible == true)
                                    {
                                        rowValue++;
                                        check_row_visible = true;
                                        FpAttendanceReport.Sheets[0].Cells[row_visible, 0].Text = rowValue.ToString();
                                    }
                                }
                                if (!check_row_visible || countInvisible == FpAttendanceReport.Sheets[0].RowCount)
                                {
                                    lblErrmsg.Text = string.Empty;
                                    lblErrmsg.Visible = false;
                                    rptprint1.Visible = false;
                            ...
                            for (int roll = 0; roll < FpAttendanceReport.Sheets[0].RowCount; roll++)
                            {
                                if (roll == 0)
                                {
                                    FpAttendanceReport.Sheets[0].ColumnCount = FpAttendanceReport.Sheets[0].ColumnCount + 4;
                                    FpAttendanceReport.Sheets[0].ColumnHeader.Cells[0, FpAttendanceReport.Sheets[0].ColumnCount - 4].Text = "Tot Con";
                                    FpAttendanceReport.Sheets[0].ColumnHeaderSpanModel.Add(0, FpAttendanceReport.Sheets[0].ColumnCount - 4, 2, 1);
                                    FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 4].Resizable = false;
                                    FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 4].Locked = true;
                                    FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 4].Width = 100;

                                    FpAttendanceReport.Sheets[0].ColumnHeader.Cells[0, FpAttendanceReport.Sheets[0].ColumnCount - 3].Text = "Tot. Present";
                                    FpAttendanceReport.Sheets[0].ColumnHeaderSpanModel.Add(0, FpAttendanceReport.Sheets[0].ColumnCount - 3, 2, 1);
                                    FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 3].Resizable = false;
                                    FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 3].Locked = true;
                                    FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 3].Width = 100;

                                    FpAttendanceReport.Sheets[0].ColumnHeader.Cells[0, FpAttendanceReport.Sheets[0].ColumnCount - 2].Text = "  \t\t%\t\t  ";
                                    FpAttendanceReport.Sheets[0].ColumnHeader.Cells[0, FpAttendanceReport.Sheets[0].ColumnCount - 2].Font.Bold = true;
                                    FpAttendanceReport.Sheets[0].ColumnHeaderSpanModel.Add(0, FpAttendanceReport.Sheets[0].ColumnCount - 2, 2, 1);
                                    FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 2].Resizable = false;
                                    FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 2].Locked = true;
                                    FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 2].Width = 100;

                                    FpAttendanceReport.Sheets[0].ColumnHeader.Cells[0, FpAttendanceReport.Sheets[0].ColumnCount - 1].Text = "Remarks";
                                    FpAttendanceReport.Sheets[0].ColumnHeaderSpanModel.Add(0, FpAttendanceReport.Sheets[0].ColumnCount - 1, 2, 1);
                                    FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 1].Resizable = false;
                                    FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 1].Locked = true;
                                    FpAttendanceReport.Sheets[0].Columns[FpAttendanceReport.Sheets[0].ColumnCount - 1].Width = 100;
                                }
                                roll_no = FpAttendanceReport.Sheets[0].Cells[roll, 2].Text.ToString().Trim();
                                ...
                                if (htTotalConductedHrs.Contains(roll_no.Trim().ToLower()))
                                {
                                    ...
                                    FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 4].Text = Convert.ToString(totConducted);
                                }
                                else
                                {
                                    FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 4].Text = Convert.ToString("--");
                                }
                                FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 4].Locked = true;
                                FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 4].Font.Name = "Book Antiqua";
                                FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 4].HorizontalAlign = HorizontalAlign.Center;
                                FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 4].VerticalAlign = VerticalAlign.Middle;
                                if (httotalStudPresentHrs.Contains(roll_no.Trim().ToLower()))
                                {
                                    overallPresent = Convert.ToDouble(GetCorrespondingKey(roll_no.Trim().ToLower(), httotalStudPresentHrs));
                                    FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 3].Text = Convert.ToString(overallPresent);
                                }
                                else
                                {
                                    FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 3].Text = Convert.ToString("--");
                                }
                                FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 3].Locked = true;
                                FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 3].Font.Name = "Book Antiqua";
                                FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 3].HorizontalAlign = HorizontalAlign.Center;
                                FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 3].VerticalAlign = VerticalAlign.Middle;
                                double avg = 0;
                                ...
                                FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 2].Text = Convert.ToString(avg);
                                FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 2].Locked = true;
                                FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 2].Font.Name = "Book Antiqua";
                                FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 2].HorizontalAlign = HorizontalAlign.Center;
                                FpAttendanceReport.Sheets[0].Cells[roll, FpAttendanceReport.Sheets[0].ColumnCount - 2].VerticalAlign = VerticalAlign.Middle;
                            }
                        }
                        FpAttendanceReport.SaveChanges();
                        FpAttendanceReport.Sheets[0].PageSize = FpAttendanceReport.Sheets[0].RowCount;
                        FpAttendanceReport.Height = 400;
                        FpAttendanceReport.Width = subjectNoSelected.Length * 150 + 750;
                        FpAttendanceReport.Visible = true;
            ...
            while (dtTempDate <= dtToDate)
            {
                if (!hatdc.Contains(dtTempDate))
                {
                    ...
                    else
                    {
                        ...
                        {
                            dsSemesterSchedule1.Tables[0].DefaultView.RowFilter = "FromDate <='" + dtTempDate.ToString("MM/dd/yyyy") + "'";
                            DataView dv = dsSemesterSchedule1.Tables[0].DefaultView;
                            dv.Sort = "FromDate desc";
                        ...
                        {
                            dsAlterSchedule1.Tables[0].DefaultView.RowFilter = "FromDate ='" + dtTempDate.ToString("MM/dd/yyyy") + "'";
                        ...
                        if (dsSemesterSchedule.Tables.Count > 0 && dsSemesterSchedule.Tables[0].Rows.Count > 0)
                        {
                            if (noOfHours > 0)
                            {
                                ...
                                for (int temp_hr = split_holiday_status_1; temp_hr <= split_holiday_status_2; temp_hr++)
                                {
                                    ...
                                    date_temp_field = "d" + final_date_string[1].ToString().TrimStart('0') + "d" + temp_hr;
                                    hatattendance.Clear();
                                                    ...
                                                    if (split_single_hour.GetUpperBound(0) >= 1)
                                                    {
                                                        ...
                                                        if (split_single_hour[0].ToString().Trim() == subject_no.Trim())
                                                        {
                                                            if (!temp_has_subj_code.ContainsKey(subject_no.Trim()))
                                                            {
                                                                ...
                                                                {
                                                                    for (int i = 0; i < FpAttendanceReport.Sheets[0].RowCount; i++)
                                                                    {
                                                                        string rollno = Convert.ToString(FpAttendanceReport.Sheets[0].Cells[i, 2].Text).Trim();
                                                                        if (hatattendance.Contains(rollno.Trim().ToLower()))
                                                                        {
                                                                            Admission_date = Convert.ToDateTime(FpAttendanceReport.Sheets[0].Cells[i, 1].Note.Trim());
                                                                            ...
                                                                            {
                                                                                FpAttendanceReport.Sheets[0].Rows[i].Visible = true;
                                                                                if (attvalue == "3")
                                                                                {
                                                                                    temp_tag = "3";
                                                                                }
                                                                                ...
                                                                                if ((attvalue.ToString()) != "8")
                                                                                {
                                                                                    if (value != "HS")
                                                                                    {
                                                                                        if (!has_attnd_masterset_notconsider.ContainsKey(attvalue.ToString().Trim()))
                                                                                        {
                                                                                            ...
                                                                                            {
                                                                                                if (!has_od.ContainsKey(FpAttendanceReport.Sheets[0].Cells[i, 2].Text.ToLower().Trim()))
                                                                                                {
                ...
                if (ds_splhr_query_master.Tables.Count > 0 && ds_splhr_query_master.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow dr_splhr_query_master in ds_splhr_query_master.Tables[0].Rows)
                    {
                        if (hatsplhrattendance.Contains(Convert.ToString(dr_splhr_query_master[0]).Trim().ToLower()))
                        {
                            ...
                            recflag = true;
                            if (FpAttendanceReport.Sheets[0].Cells[roll_count, 2].Text.Trim().ToLower() == Convert.ToString(dr_splhr_query_master[0]).Trim().ToLower())
                            {
                                FpAttendanceReport.Sheets[0].Rows[roll_count].Visible = true;
                                if ((Convert.ToString(dr_splhr_query_master[1]).Trim()) != "8")
                                {
                                    if (Attmark(Convert.ToString(dr_splhr_query_master[1]).Trim()) != "HS")
                                    {
                                        if (has_attnd_masterset.ContainsKey((Convert.ToString(dr_splhr_query_master[1]).Trim())))
                                        {
                                            ...
                                            present_count++;
                                            has_load_rollno[FpAttendanceReport.Sheets[0].Cells[roll_count, 2].Text.Trim().ToLower()] = present_count;
                                        }
                                        if (Attmark(dr_splhr_query_master[1].ToString()) != "NE")
                                        {
                                            ...
                                            present_count++;
                                            has_total_attnd_hour[FpAttendanceReport.Sheets[0].Cells[roll_count, 2].Text.Trim().ToLower()] = present_count;
                                        }
                                    }
                                }
                            }
    ...
    //                    drSchedule["FromDate"] = Convert.ToString(dtTemp.ToString("MM/dd/yyyy"));
    //                    for (int i = 0; i < 7; i++)
    //                    {
    ...
    //                    drAltert["FromDate"] = Convert.ToString(dtTemp.ToString("MM/dd/yyyy"));
    //                    for (int i = 0; i < 7; i++)
    //                    {
    //                        string curday = string.Empty;
    //                        string curdayFull = string.Empty;
    ...
    protected void SemesterandAlternateSchedule(string Collegecode, string Batchyear, string Degreecode, string Semester, string Section, string SemStartdate, string SemEnddate, int intNHrs, ref DataTable dtSchedule, ref DataTable dtAlterSchedule)
    {
        try
        {
            ...
            DataTable dtSelect = dirAcc.selectDataTable("select CONVERT(varchar(20),ct.TT_date,103) as TT_date,ct.TT_degCode as degree_code,ct.TT_classAdvisor as class_advisor,ct.TT_sem as semester,ct.TT_batchyear as batch_year,ltrim(rtrim(isnull(ct.TT_sec,''))) as Sections,ct.TT_lastRec as LastRec,ct.TT_name as ttname,TT_subno,TT_staffcode,TT_Day,TT_Hour,isnull(Lab,'0') as Lab,isnull(Elective,'0') as Elective,isnull(s.practicalPair,0) as practicalpair,do.Daydiscription,(select room_name from Room_Detail rd where rd.roompk = ctd.TT_Room ) as Room,ct.TT_ClassPK from TT_ClassTimetable ct, TT_ClassTimetableDet ctd,subject s,sub_sem ss,TT_Day_Dayorder do where ctd.TT_Day =do.TT_Day_DayorderPK and  s.subject_no = ctd.TT_subno and s.syll_code=ss.syll_code and s.subType_no = ss.subType_no and ct.TT_ClassPK = ctd.TT_ClassFk and ct.TT_colCode='" + Collegecode.Trim() + "' and ct.TT_degCode='" + Convert.ToString(Degreecode).Trim() + "' and ct.TT_batchyear='" + Batchyear + "' and ct.TT_sem='" + Convert.ToString(Semester).Trim() + "' " + qrySection + " and ct.TT_date<='" + SemEnddate + "' order by  ct.TT_date desc");
            dtSchedule = new DataTable();
            dtSchedule.Columns.Add("TT_ClassPK");
            dtSchedule.Columns.Add("FromDate");
            ...
            dtSchedule.Columns.Add("ttname");//ttname
            DataTable dtMinMaxSchedule = new DataTable();
