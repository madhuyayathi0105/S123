...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function clickCells_min(rowIndex) {
            var StudentCount_min = document.getElementById(gvStudentMinCount[rowIndex]);
            var StudentCountLbl_min = document.getElementById(gvStudentMinCount_lbl[rowIndex]);
            if (typeof StudentCount !== 'undefined' && StudentCount != null) {
                if (StudentCountLbl_min.style.display == 'block') {
                    StudentCount_min.style.display = 'block';
                    StudentCountLbl_min.style.display = 'none';
                    StudentCount_min.focus();
                }
                else {
                    StudentCount_min.style.display = 'none';
                    StudentCountLbl_min.style.display = 'block';
                }
                StudentCount_min.focus();
            }
        }

        function focusOut_min(rowIndex) {
            var StudentCount_min = document.getElementById(gvStudentMinCount[rowIndex]);
            var StudentCountLbl_min = document.getElementById(gvStudentMinCount_lbl[rowIndex]);
            if (typeof StudentCount_min !== 'undefined' && StudentCount != null) {
                StudentCountLbl.innerHTML = StudentCount.value;
                if (StudentCount.value != '') {
                    if (StudentCount_min.style.display == 'block') {
                        StudentCount_min.style.display = 'none';
                        StudentCountLbl_min.style.display = 'block';
                    }
                    else {
        ...
        function textBoxClick_min(rowIndex) {
            var StudentCount = document.getElementById(gvStudentMinCount[rowIndex]);
            var StudentCountLbl = document.getElementById(gvStudentMinCount_lbl[rowIndex]);
            if (typeof StudentCount !== 'undefined' && StudentCount != null && StudentCount.value != '') {
                StudentCountLbl_min.innerHTML = StudentCount.value;
                StudentCountLbl_min.style.display = 'none';
                StudentCount_min.style.display = 'block';
                StudentCount_min.focus();
            }
        ...
        function textBoxClicknEW_min(rowIndex) {
            var StudentCount_min = document.getElementById(gvStudentMinCount[rowIndex]);
            var StudentCountLbl_min = document.getElementById(gvStudentMinCount_lbl[rowIndex]);
            if (typeof StudentCount_min !== 'undefined' && StudentCount != null && StudentCount.value != '') {
                StudentCountLbl_min.innerHTML = StudentCount.value;
                StudentCountLbl_min.style.display = 'none';
                StudentCount_min.style.display = 'block';
                StudentCount_min.focus();
    ...
    <center>
        ...
        <div class="maindivstyle" style="width: 950px; height: auto; margin: 0px; margin-top: 15px;
                    ...
                    <td colspan="10">
                        <table>
                            <tr>
                                ...
                                <td>
                                <asp:CheckBox ID="cbequalpapcount" runat="server" Text="Equal Paper Matching" AutoPostBack="true" OnCheckedChanged="cb_eqpapmat_checkedchange" />
            ...
            <center>
                <div id="divMainContent" visible="false" runat="server" style="margin: 0px; margin-bottom: 20px;
                    ...
                    <asp:GridView ID="gvSectionWiseCount" runat="server" CaptionAlign="Top" HorizontalAlign="Justify"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Student Count">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtStudentCount" runat="server" Visible="true" Style="font-weight: bold;"
                                        Width="50px" Text='<%#Eval("studentCount") %>'  AutoPostBack ="true" OnTextChanged = "txtStudentCount_textChange"></asp:TextBox>
                         ...
                         <Columns>
                            <asp:TemplateField HeaderText="Min Student Count">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtStudentCount_min" runat="server" Visible="true" Style="font-weight: bold;"
                                        Width="50px" Text='<%#Eval("studentminCount") %>' AutoPostBack ="true" OnTextChanged = "txtStudentCount_min_textChange"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender runat="server" ID="filterStudentCount_min" FilterType="Numbers"
                                        TargetControlID="txtStudentCount_min">
                                    </asp:FilteredTextBoxExtender>
                                   
                                    <asp:Label ID="lblDegreeCode_min" runat="server" Style="display: none;" Text='<%#Eval("Degree_Code") %>'></asp:Label>
                                    <asp:Label ID="lblStudentCount_min" runat="server" Style="font-weight: bold; display: none;"
                                        Text='<%#Eval("studentminCount") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="40px" />
                            </asp:TemplateField>
                        </Columns>
                ...
                <div id="divmaincontenteqlpapmatch" visible="false" runat="server" style="margin: 0px; margin-bottom: 20px;
                    margin-top: 20px;">
                    <asp:GridView ID="gveqpapmatch" runat="server" CaptionAlign="Top" HorizontalAlign="Justify"
                        CellPadding="4" ForeColor="#333333" BorderStyle="Solid" AutoGenerateColumns="false"
                        GridLines="Both" Style="width: 100%; height: auto;" OnPreRender="gveqpapmatch_PreRender"
                        OnDataBound="gveqpapmatch_DataBound" 
                        >
                        <RowStyle BackColor="#E3EAEB" />
                        <Columns>
                            <asp:TemplateField HeaderText="S.No">
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="subject Details">
                                <ItemTemplate>
                                  <asp:Label ID="lblSubjectDet" runat="server" Visible="true" Style="font-weight: bold;"
                                        ForeColor="#003366" Text='<%#Eval("subject Details") %>'></asp:Label>
                                     <asp:Label ID="lblSubjectNo" runat="server" Style="display: none;" Text='<%#Eval("subject_no") %>'></asp:Label>
                                    <asp:Label ID="lblSubjectCode" runat="server" Style="font-weight: bold; display: none;"
                                        Text='<%#Eval("subject_code") %>'></asp:Label>
                                </ItemTemplate>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="staff Details">
                                <ItemTemplate>
                                    <asp:Label ID="lblStaffName" runat="server" Visible="true" Style="font-weight: bold;"
                                        ForeColor="#660033" Text='<%#Eval("staff Details") %>'></asp:Label>
                                    <asp:Label ID="lblStaffApplId" runat="server" Style="font-weight: bold; display: none;"
                                        Text='<%#Eval("appl_id") %>'></asp:Label>
                                    <asp:Label ID="lblStaffCode" runat="server" Style="font-weight: bold; display: none;"
                                        Text='<%#Eval("staff_code") %>'></asp:Label>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="MaxCount">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtStudentCount" runat="server" Visible="true" Style="font-weight: bold;"
                                        Width="50px" Text='<%#Eval("MaxCount") %>'  AutoPostBack ="true" OnTextChanged = "txtStudentCount_textChange"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender runat="server" ID="filterStudentCount" FilterType="Numbers"
                                        TargetControlID="txtStudentCount">
                                    </asp:FilteredTextBoxExtender>
                                   
                                   <%-- <asp:Label ID="lblStudentCount" runat="server" Style="font-weight: bold; "
                                        Text='<%#Eval("Max Count") %>'></asp:Label>--%>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="40px" />
                            </asp:TemplateField>
                        </Columns>
                         <Columns>
                            <asp:TemplateField HeaderText="MinCount">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtStudentCount_min" runat="server" Visible="true" Style="font-weight: bold;"
                                        Width="50px" Text='<%#Eval("MinCount") %>' AutoPostBack ="true" OnTextChanged = "txtStudentCount_min_textChange"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender runat="server" ID="filterStudentCount_min" FilterType="Numbers"
                                        TargetControlID="txtStudentCount_min">
                                    </asp:FilteredTextBoxExtender>
                                   
                                  
                                    <%--<asp:Label ID="lblStudentCount_min" runat="server" Style="font-weight: bold; "
                                        Text='<%#Eval("Min Count") %>'></asp:Label>--%>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="40px" />
                            </asp:TemplateField>
                        </Columns>
