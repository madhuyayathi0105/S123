<%@ Page Title="" Language="C#" MasterPageFile="~/AttendanceMOD/AttendanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="SchoolAttendanceReport.aspx.cs" Inherits="SchoolAttendanceReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <body>
        ...
        <div>
            <center>
                <div>
                    <span class="fontstyleheader" style="color: Green;">School Attendance Report</span></div>
            </center>
        </div>
        <br />
        <div>
            <center>
                <div id="maindiv" runat="server" class="maindivstyle" style="width: 1000px; height: auto">
                    ...
                    <table class="maintablestyle">
                           ...
                           <td>
                            ...
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtleve" runat="server" Style="height: 25px; width: 150px;" ReadOnly="true">--Select--</asp:TextBox>
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:RadioButton ID="rbdeg" runat="server" AutoPostBack="true" Checked="true" OnCheckedChanged="rbdeg_Changed"
                                    GroupName="s1" />
                                <asp:Label ID="lbldeg" runat="server" Text="Degree"></asp:Label>
                                <asp:RadioButton ID="rbdept" runat="server" AutoPostBack="true" OnCheckedChanged="rbdept_Changed"
                                    GroupName="s1" />
