<%@ Page Title="" Language="C#" MasterPageFile="~/LibraryMod/LibraryMaster.master"
    AutoEventWireup="true" CodeFile="CodeSettings.aspx.cs" Inherits="LibraryMod_CodeSettings" %>
    ...
    <body>
            ...
            function checkvalue1() {
                ...
                for (var u = 0; u < gridViewControls1.length; u++) {
                    if (gridViewControls1[u].name.indexOf("txt_acronym1") > 1) {
                        ...
                        var a = gridViewControls1[u].value;
        ...
        <div>
            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                <ContentTemplate>
                    <div class="maindivstyle" style="height: 275px; width: 1000px; font-family: Book Antiqua;
                        font-weight: bold; margin-left: 230px">
                        <center>
                            <br />
                            <table class="maintablestyle" style="width: 980px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="Label2" Text="Library" runat="server"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="ddllibrary" runat="server" Width="243px" CssClass="textbox ddlstyle ddlheight3"
                                                    OnSelectedIndexChanged="ddl_librarySelectedindexchange" AutoPostBack="true">
                                                </asp:DropDownList>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
                                    ...
                                    <td>
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                <asp:TextBox ID="txt_frmdate" runat="server" CssClass="textbox txtheight2" Width="80px"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2">
                                        <asp:TextBox ID="txt_prvdate" runat="server" CssClass="textbox txtheight2" Width="100px"
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="ddl_PrevDate" runat="server" CssClass="textbox ddlstyle ddlheight3"
                        ...
                        <div>
                            <center>
                                <table class="table">
                                    <tr>
                                        <td>
                                            <asp:Label ID="lbl_count1" runat="server" Text="Fine Recipt No:" Font-Bold="true"
                                                ...
                                                <div>
                                                    <asp:GridView ID="grid_prev" runat="server" AutoGenerateColumns="false" GridLines="None"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Acronym" HeaderStyle-BackColor="#0CA6CA">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txt_acronym1" runat="server" CssClass="textbox txtheight" Enabled="false"
                                                                        onfocus="return myFunction2(this)" MaxLength="35" Style="text-transform: uppercase;"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderText="Size" HeaderStyle-BackColor="#0CA6CA">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txt_size1" runat="server" CssClass="textbox txtheight" Enabled="false"
