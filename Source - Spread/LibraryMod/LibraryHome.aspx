<%@ Page Title="" Language="C#" MasterPageFile="~/LibraryMod/LibraryMaster.master" AutoEventWireup="true" CodeFile="LibraryHome.aspx.cs" Inherits="LibraryMod_LibraryHome" %>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <div>
                            <center>
                                <asp:Label ID="Label1" CssClass="lbl" runat="server" Text="Library"></asp:Label>
                            </center>
                        </div>
                    </td>
                    <td>
