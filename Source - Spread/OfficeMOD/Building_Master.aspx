<%@ Page Title="" Language="C#" MasterPageFile="~/OfficeMOD/OfficeSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="Building_Master.aspx.cs" Inherits="Building_Master" %>
                    ...
                    <fieldset style="border: 2px; border: 1px solid #ccc; background-color: #0ca6ca;
                        ...
                        <table style="margin-left: 0px; margin-top: -3px; width: 650px;">
                            <tr>
                                ...
                                <td>
                                    <asp:RadioButton ID="rb_building" runat="server" Visible="false" Text="Building"
                                        GroupName="bm" Checked="true" AutoPostBack="true" OnCheckedChanged="rb_building_Changed" />
                                </td>
                                <td>
                                    <asp:RadioButton ID="rb_floor" runat="server" Visible="false" Text="Floor" GroupName="bm"
                                        AutoPostBack="true" OnCheckedChanged="rb_floor_Changed" />
                                </td>
                                <td>
                                    <asp:RadioButton ID="rb_room" runat="server" Visible="false" Text="Room" GroupName="bm"
                                        AutoPostBack="true" OnCheckedChanged="rb_room_Changed" />
                                </td>
                                <td>
                ...
                <center>
                    <div id="pop1" runat="server" class="sty2" style="background-color: White; height: 830px;
                        ...
                        <asp:Label ID="lbl_nofbuild" runat="server" Visible="false" Text="Total No Of Buildings"
                            Style="font-weight: bold; font-family: book antiqua; margin-left: -36px; font-size: medium;"></asp:Label>
                        ...
                        <asp:Label ID="lbl_type" runat="server" Text="Building Type" ></asp:Label>
        ...
        <center>
            <div id="div_floor" runat="server" visible="false" style="height: 1000px; z-index: 1000;
                ...
                <center>
                    <div id="Div2" runat="server" class="sty2" style="background-color: White; height: 570px;
                        ...
                        <asp:DropDownList ID="ddlbname" runat="server" Visible="false" OnSelectedIndexChanged="ddlbname_SelectedIndexChanged"
                            AutoPostBack="true" Style="font-weight: bold; font-family: book antiqua; width: 100px;
                            font-size: medium;">
                        </asp:DropDownList>
            ...
            <asp:CheckBox ID="cb_new" runat="server" AutoPostBack="true" Text="Add New Building" style="font-weight: bold;
                        ...
                        <asp:Button ID="btn_flrsave" runat="server" Text="Save" Visible="false" OnClick="btn_flrsave_click"
                            Style="font-weight: bold; font-family: book antiqua; font-size: medium;" />
                        <asp:Button ID="btn_flrdelete" runat="server" Visible="false" Text="Delete" OnClick="btn_flrdelete_Click"
                            Style="font-weight: bold; font-family: book antiqua; font-size: medium;" />
                ...
                <center>
                    <div id="Div3" runat="server" class="sty2" style="background-color: White; height: 570px;
                        ...
                        <asp:TextBox ID="txt_rbn" runat="server" Visible="false" ReadOnly="true" Enabled="false"
                            Style="font-weight: bold; font-family: book antiqua; font-size: medium; width: 75px;"></asp:TextBox>
                        <asp:DropDownList ID="ddlrbname" runat="server" Visible="false" OnSelectedIndexChanged="ddlrbname_SelectedIndexChanged"
                            AutoPostBack="true" Style="font-weight: bold; font-family: book antiqua; width: 100px;
                            font-size: medium;">
                        </asp:DropDownList>
                        </br> </br>
                        ...
                        <asp:TextBox ID="txt_rflrn" runat="server" Visible="false" ReadOnly="true" Enabled="false"
                            Style="font-weight: bold; font-family: book antiqua; font-size: medium; width: 75px;"></asp:TextBox>
                        <asp:DropDownList ID="ddlrflrm" runat="server" Visible="false" OnSelectedIndexChanged="ddlrflrm_SelectedIndexChanged"
                            AutoPostBack="true" Style="font-weight: bold; font-family: book antiqua; width: 100px;
                            font-size: medium;">
                        </asp:DropDownList>
                        ...
                        <asp:Button ID="btn_rsave" runat="server" Text="Save" Visible="false" OnClick="btn_rsave_click"
                            Style="font-weight: bold; font-family: book antiqua; font-size: medium;" />
                        <asp:Button ID="btn_rdelete" runat="server" Visible="false" Text="Delete" OnClick="btn_rdelete_Click"
                            Style="font-weight: bold; font-family: book antiqua; font-size: medium;" />
                                    ...
                                    <td>
                                        <center>
                                            <asp:Button ID="btn_close" CssClass=" textbox btn1 comm" Style="height: 28px; width: 65px;"
                                                OnClick="btn_close_Click" Text="ok" runat="server" />
                                        </center>
                                    </td>
                                </tr>
                            </table>
