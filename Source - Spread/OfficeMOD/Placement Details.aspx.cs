...
public partial class Placement_Details : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       if(gview.Visible==true)
        ...
        if (!IsPostBack)
        {
            ...
            drpdate.Text = DateTime.Now.ToString("dd-MM-yyyy");
            BindCollege();
            bindbatch();
            edu_level();
            degree();
    ...
    public void fpspread1go1()
    {
        try
        {
                ...
                dtTTDisp.Columns.Add("Batch_year");
                ...
                else
                {
                    ...
                    if (chkincluplacement.Checked == true)
                    {
                        string buildvalue = string.Empty;
                        string build = string.Empty;
                        if (cblcom.Items.Count > 0)
                        {
                            ...
                            for (int jj = 0; jj < cblcom.Items.Count; jj++)
                            {
                                if (cblcom.Items[i].Selected == true)
                                {
                                    build = cblcom.Items[jj].Value.ToString();
                                    if (buildvalue == "")
                                    {
                                        buildvalue = build;
                                    }
                        ...
                        {
                            query = "select  distinct  r.Roll_No,r.Batch_Year,r.Stud_Name,r.degree_code,r.Reg_No,a.Admission_Status,r.Exam_Flag,r.CC,r.Current_Semester,r.DelFlag,a.app_no" + columnname1 + ",case when direct_refer='0'  then 'Direct'   when direct_refer='1'  then 'Staff'   when direct_refer='2'  then 'Others'  when direct_refer='3'  then 'Student' end referby,case when a.direct_refer=1 then (select appl_name from staff_appl_master sa,staffmaster s where sa.appl_no=s.appl_no and convert(varchar(20),s.staff_code)=a.refer_stcode) when direct_refer=3 then (select Stud_Name from applyn where convert(varchar(20),App_No)=a.refer_stcode) when direct_refer=2 then ((select textval from textvaltable where convert(varchar,TextCode)= refer_name)) else '' end refer_stcode,case when direct_refer=2 then ((select textval from textvaltable where convert(varchar,TextCode)= refer_agent)) else '' end as refer_agent from Registration r,applyn a,degree d,Department dt,Course C,Company_StudentREgistration cs  where  r.App_No=a.app_no and d.Degree_Code =r.degree_code and d.Dept_Code =dt.Dept_Code and c.Course_Id =d.Course_Id and isconfirm ='1' and admission_status ='1' and CC='0' and DelFlag='0' and Exam_Flag<>'DEBAR' and r.degree_code in('" + dept_tagvalue + "') " + addqur + "  " + StateFilter + " and r.Batch_Year in('" + Batch_tagvalue + "')  and r.App_no=cs.App_no and cs.Shortlist_flag='1' and cs.companyfk in('" + buildvalue + "')";
                        }
                        else 
                        {
                            query = "select  distinct  r.Roll_No,cs.com_round,cms.*,r.Batch_Year,r.Stud_Name,r.degree_code,r.Reg_No,a.Admission_Status,r.Exam_Flag,r.CC,r.Current_Semester,r.DelFlag,a.app_no" + columnname1 + ",case when direct_refer='0'  then 'Direct'   when direct_refer='1'  then 'Staff'   when direct_refer='2'  then 'Others'  when direct_refer='3'  then 'Student' end referby,case when a.direct_refer=1 then (select appl_name from staff_appl_master sa,staffmaster s where sa.appl_no=s.appl_no and convert(varchar(20),s.staff_code)=a.refer_stcode) when direct_refer=3 then (select Stud_Name from applyn where convert(varchar(20),App_No)=a.refer_stcode) when direct_refer=2 then ((select textval from textvaltable where convert(varchar,TextCode)= refer_name)) else '' end refer_stcode,case when direct_refer=2 then ((select textval from textvaltable where convert(varchar,TextCode)= refer_agent)) else '' end as refer_agent from Registration r,applyn a,degree d,Department dt,Course C,Company_StudentREgistration cs,Cm_Studentselection cms  where  r.App_No=a.app_no and d.Degree_Code =r.degree_code and d.Dept_Code =dt.Dept_Code and c.Course_Id =d.Course_Id and isconfirm ='1' and admission_status ='1' and CC='0' and DelFlag='0' and Exam_Flag<>'DEBAR' and r.degree_code in('" + dept_tagvalue + "') " + addqur + "  " + StateFilter + " and r.Batch_Year in('" + Batch_tagvalue + "')  and r.App_no=cs.App_no and cs.Shortlist_flag='1' and cms.App_no=cs.App_no and cs.companyfk=cms.companyfk and cs.companyfk in('" + buildvalue + "')";
                        }
                        query = query + "  and  r.Current_Semester in('" + sem_tagvalue + "') " + sectionvalue + " " + FromdateReg + " " + orderStr + "";
                    }
                    else
                    {
                        query = "select  distinct  r.Roll_No,r.Batch_Year,r.Stud_Name,r.degree_code,r.Reg_No,a.Admission_Status,r.Exam_Flag,r.CC,r.Current_Semester,r.DelFlag,a.app_no" + columnname1 + ",case when direct_refer='0'  then 'Direct'   when direct_refer='1'  then 'Staff'   when direct_refer='2'  then 'Others'  when direct_refer='3'  then 'Student' end referby,case when a.direct_refer=1 then (select appl_name from staff_appl_master sa,staffmaster s where sa.appl_no=s.appl_no and convert(varchar(20),s.staff_code)=a.refer_stcode) when direct_refer=3 then (select Stud_Name from applyn where convert(varchar(20),App_No)=a.refer_stcode) when direct_refer=2 then ((select textval from textvaltable where convert(varchar,TextCode)= refer_name)) else '' end refer_stcode,case when direct_refer=2 then ((select textval from textvaltable where convert(varchar,TextCode)= refer_agent)) else '' end as refer_agent from Registration r,applyn a,degree d,Department dt,Course C  where  r.App_No=a.app_no and d.Degree_Code =r.degree_code and d.Dept_Code =dt.Dept_Code and c.Course_Id =d.Course_Id and isconfirm ='1' and admission_status ='1' and CC='0' and DelFlag='0' and Exam_Flag<>'DEBAR' and r.degree_code in('" + dept_tagvalue + "') " + addqur + "  " + StateFilter + " and r.Batch_Year in('" + Batch_tagvalue + "')  ";
                        //string attme = "";
                ...
                query = query + "   SELECT (select textval from textvaltable where convert(varchar (100),TextCode)=isnull(p.branch_code,'0'))as branch_code,P.percentage,P.securedmark,P.totalmark,Cut_Of_Mark,PCM_Percentage,(select textval from textvaltable where convert(varchar (100),TextCode)=isnull(medium,'0'))as medium,marksheetno,a.app_no,ISNULL(C.TExtVal,'') Course,ISNULL(U.TextVal,'') University,ISNULL(Institute_Name,'') Institute_Name,ISNULL(PassMonth,'') PassMonth,ISNULL(PassYear,'') PassYear,ISNULL(NoOfAttempts ,0) NoOfAttempts,ISNULL(p.Certificate_No,'') Certificate_No,CONVERT(VARCHAR(11),p.Certificate_No,103) as Certificate_Date,(select textval from textvaltable where TextCode=isnull(course_code,'0'))course_code,LastTCNo+' - '+convert(varchar(10),LastTCDate,103)LastTC  FROM Stud_prev_details P INNER JOIN applyn A ON P.app_no = A.app_no LEFT JOIN TextValTable C ON C.TextCode = P.course_code LEFT JOIN TextValTable U ON U.TextCode = P.university_code Where p.app_no = a.app_no";
                ds.Clear();
                ds = d2.select_method_wo_parameter(query, "Text");
                    ...
                    if (query != "")
                    {
                        ...
                        else
                        {
                            ...
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                {
                                    for (int im = 3; im < dtTTDisp.Columns.Count; im++)
                                    {
                                ...
                                for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                                {
                                    if (chkincluplacement.Checked == true)
                                    {
                                        if (ddlfilter.SelectedIndex != 0)
                                        {
                                            string round = Convert.ToString(ds.Tables[0].Rows[i]["com_round"]);
                                    ...
                                    string App_no = ds.Tables[0].Rows[i]["App_no"].ToString();
                                    drrow["Batch_year"] = Batch_tagvalue;
                                    drrow["App_no"] = App_no;
                                    int arrearcun = 0;
                                   ...
                                   string fromsem_tagvalue = ddrsem.SelectedItem.Text;
                                    if (rdb_cumm.Checked == true)
                                    {
                                        string arrearcount = string.Empty;
                                        if (chkabsent.Checked == false)
                                            arrearcount =d2.GetFunction(" select COUNT (distinct subject_no)as noofarrear from mark_entry where roll_no='" + rollno + "' and subject_no not in(select s.subject_no from subject s,mark_entry m where m.subject_no=s.subject_no and m.result='pass' and roll_no='" + rollno + "')");
                                        else
                                            arrearcount =d2.GetFunction( " select COUNT (distinct subject_no)as noofarrear from mark_entry where roll_no='" + rollno + "' and subject_no not in(select s.subject_no from subject s,mark_entry m where m.subject_no=s.subject_no and m.result in('pass','AAA') and roll_no='" + rollno + "')");
                                        int.TryParse(arrearcount, out arrearcun);
                                        if(arrearcount=="0")
                                        {
                                    ...
                                    else if (rdb_detail.Checked == true)
                                    {
                                        ...
                                        if (rdbatt.Checked == true)
                                        {
                                            ...
                                            if (Convert.ToInt32(txtattempts.Text) == att)
                                            {
                                            }
                                            else
                                            {
                                        ...
                                        else
                                        {
                                            ...
                                            if (removerow != 1)
                                            {
                                                string arrcun = string.Empty;
                                                if (chkabsent.Checked == false)
                                                    arrcun = d2.GetFunction(" select COUNT (distinct subject_no)as noofarrear from mark_entry where roll_no='" + rollno + "' and subject_no not in(select s.subject_no from subject s,mark_entry m where m.subject_no=s.subject_no and m.result='pass' and roll_no='" + rollno + "')");
                                                else
                                                    arrcun = d2.GetFunction(" select COUNT (distinct subject_no)as noofarrear from mark_entry where roll_no='" + rollno + "' and subject_no not in(select s.subject_no from subject s,mark_entry m where m.subject_no=s.subject_no and m.result in('pass','AAA') and roll_no='" + rollno + "')");
                                                //string attme = d2.GetFunction("select max(attempts) from mark_entry where roll_no='" + rollno + "' ");
                                                // string attme = ds.Tables[0].Rows[i]["attempts"].ToString();
                                                int att = 0;
                                                int.TryParse(arrcun, out att);
                                                int.TryParse(arrcun, out arrearcun);
                                                if (chksarrear.Checked == true && chsmulti.Checked == true)
                                                {
                                                    if (att >= 1)
                                                    {
                                                ...
                                                else if (chksarrear.Checked == true && chsstill.Checked == true)
                                                {
                                                    ...
                                                    string chkarr = string.Empty;
                                                    if (chkabsent.Checked == false)
                                                        chkarr = d2.GetFunction("select COUNT(distinct subject_no) from mark_entry where exam_code='" + excheck + "' and roll_no='" + rollno + "' and result<>'Pass'");
                                                    else
                                                        chkarr = d2.GetFunction("select COUNT(distinct subject_no) from mark_entry where exam_code='" + excheck + "' and roll_no='" + rollno + "' and result not in('Pass','AAA')");
                                                    if (att == 1 || chkarr != "0")
                                                    {
                                                ...
                                                else if (chsmulti.Checked == true && chsstill.Checked == true)
                                                {
                                                    string excheck = d2.GetFunction("Select top 1 isnull(Exam_Code,-1),exam_month,exam_year from Exam_Details where Degree_Code = '" + dept_tagvalue.ToString() + "' and Current_Semester <= '" + sem_tagvalue + "' and Batch_Year = '" + Batch_tagvalue.ToString() + "' order by exam_year desc");
                                                ...
                                                else if (chksarrear.Checked == true)
                                                {
                                                    if (att == 1)
                                                    {
                                    ...
                                    if (removerow != 1)
                                    {
                                        ...
                                        {
                                            if (gpremark.Rows.Count > 0)
                                            {
                                                ds.Tables[1].DefaultView.RowFilter = "app_no='" + Convert.ToString(ds.Tables[0].Rows[i]["App_No"]) + "'";
                                                DataView dvs = ds.Tables[1].DefaultView;//and P.percentage
                                                Boolean per_flag = false;
                                                if (dvs.Count > 0)
                                                {
                                                    for (int m = 0; m < gpremark.Rows.Count; m++)
                                                    {
                                                        if ((gpremark.Rows[m].FindControl("select") as CheckBox).Checked == true)
                                                        {
                                                            if ((gpremark.Rows[m].FindControl("Label7") as Label).Text == Convert.ToString(dvs[0]["txtcode"]))
                                                            {
                                                                per_flag = true;
                                                                string fromrange = (gpremark.Rows[m].FindControl("txt_gviewfrom") as TextBox).Text;
                                                                string torange = (gpremark.Rows[m].FindControl("txt_gviewto") as TextBox).Text;
                                                                int fromran = 0; int torang = 0;
                                                                int.TryParse(fromrange, out fromran);
                                                                int.TryParse(torange, out torang);
                                                                double fromrandata = 0.0;
                                                                string fomdat = Convert.ToString(dvs[0]["percentage"]);
                                                                
                                                                double.TryParse(fomdat, out fromrandata);
                                                                if (fromrandata >= fromran && fromrandata <= torang)
                                                                {
                                                                }
                                                                else
                                                                    removerow = 1;
                                    ...
                                    if (removerow != 1)
                                    {
                                        ...
                                        for (int k = 3; k < dtTTDisp.Columns.Count; k++)
                                        {
                                            cc++;
                                            ...
                                            else if (col == "noofarrear")
                                            {
                                                ...
                                                {
                                                    text = Convert.ToString(arrearcun);
                                                    noarrear = Convert.ToString(arrearcun); ;
                                                    drrow["No of arrear"] = arrearcun;
                                                }
                          ...
                          if (gview.Rows.Count > 0)
                        {
                            ...
                            CheckBox selectall =gview.Rows[0].FindControl("selectall") as CheckBox;
                            selectall.Visible = true;
                            CheckBox select = gview.Rows[0].FindControl("select") as CheckBox;
    ...
    protected void txtexcelname_TextChanged(object sender, EventArgs e)
    {
        ...
        catch (Exception ex) { d2.sendErrorMail(ex, collegecode1, "Placement Details.aspx"); }
    }
    ...
    protected void without_CheckedChanged(object sender, EventArgs e)
    {
        ...
        else
        {
          ...
          //  noarrear.Visible = false;
            ...
            Txtrange.Text = "";
            Txtto.Text = "";
            //chkabsent.Visible = false;
            Td2.Visible = true;
        }
    }

    protected void rdbatt_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            if (rdbatt.Checked)
            {
                ...
                lblatt.Visible = true;
               // chkstill.Visible = true;
                chksarrear.Visible = false;
                chsmulti.Visible = false;
                chsstill.Visible = false;
            }
            else
            {
                txtattempts.Visible = false;
                lblatt.Visible = false;
               // chkstill.Visible = false;
                chksarrear.Visible = true;
                chsmulti.Visible = true;
                chsstill.Visible = true;
            }
    ...
    public void btnallot_OnClick(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtround.Text != "")
            {
                string round = "if exists(select * from New_InsSettings where LinkName='Interview Rounds' and LinkValue='" + txtround.Text + "' and college_code='" + ddlcollege.SelectedItem.Value + "'  ) update New_InsSettings set LinkValue='" + txtround.Text + "' where  LinkValue='" + txtround.Text + "' and LinkName='Interview Rounds'  and college_code='" + ddlcollege.SelectedItem.Value + "' else insert into New_InsSettings (LinkName,LinkValue,user_code,college_code)values('Interview Rounds','" + txtround.Text + "','" + usercode + "','" + ddlcollege.SelectedItem.Value + "')";
                int vcmg = d2.update_method_wo_parameter(round, "TEXT");
                DateTime comdates = new DateTime();
                comdates = TextToDate(drpdate);
                if (gview.Rows.Count > 0)
                {
                    string getmode = string.Empty;
                    for (int i = 0; i < gridround.Rows.Count; i++)
                    {
                        string interviewmode = Convert.ToString((gridround.Rows[i].FindControl("txt_gviewround") as TextBox).Text);
                        if (interviewmode != "")
                        {
                            string posi = "if exists ( select * from CO_MasterValues where MasterValue ='" + interviewmode + "' and MasterCriteria ='Mode Of Interview' and CollegeCode ='" + ddlcollege.SelectedItem.Value + "') update CO_MasterValues set MasterValue ='" + interviewmode + "' where MasterValue ='" + interviewmode + "' and MasterCriteria ='Mode Of Interview' and CollegeCode ='" + ddlcollege.SelectedItem.Value + "' else insert into CO_MasterValues (MasterValue,MasterCriteria,CollegeCode) values ('" + interviewmode + "','Mode Of Interview','" + ddlcollege.SelectedItem.Value + "')";
                            int vcms = d2.update_method_wo_parameter(posi, "TEXT");
                            string itemname = d2.GetFunction(" select MasterCode from CO_MasterValues where MasterValue ='" + interviewmode + "' and MasterCriteria ='Mode Of Interview' and CollegeCode ='" + ddlcollege.SelectedItem.Value + "'");
                    ...
                    string rounds = "if exists(select * from  com_interviewmode where CompanyFK='" + Convert.ToString(drpcompany.SelectedValue) + "' and interviewdate='" + comdates + "' and  composition='" + Convert.ToString(drbposition.SelectedValue) + "'  ) update com_interviewmode set mode='" + getmode + "' where CompanyFK='" + Convert.ToString(drpcompany.SelectedValue) + "' and interviewdate='" + comdates + "' and  composition='" + Convert.ToString(drbposition.SelectedValue) + "' else insert into com_interviewmode (CompanyFK,interviewdate,composition,mode)values('" + Convert.ToString(drpcompany.SelectedValue) + "','" + comdates + "','" + Convert.ToString(drbposition.SelectedValue) + "','" + getmode + "')";
                    int ins_vcm = d2.update_method_wo_parameter(rounds, "TEXT");
                    if (ins_vcm == 0)
                    {
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, typeof(Page), UniqueID, "alert('Please Enter interview Rounds')", true);
                return;
            }
            //interviewround();
            ...
            comdate = TextToDate(drpdate);
            accessNew();
            string ReqExpectedTime = ddl_hour.SelectedItem.Text + ":" + ddl_minits.SelectedItem.Text + " " + ddl_timeformate.SelectedItem.Text;
            string comsel = "if exists(select * from  Company_datails where CompanyFK='" + Convert.ToString(drpcompany.SelectedValue) + "' and interviewdate='" + comdate + "' and  composition='" + Convert.ToString(drbposition.SelectedValue) + "') update Company_datails set comsalary='" + Convert.ToString(drbsalary.Text) + "',interviewtime='" + ReqExpectedTime + "',rounds='" + txtround.Text + "' where  CompanyFK='" + Convert.ToString(drpcompany.SelectedValue) + "' and interviewdate='" + comdate + "' and  composition='" + Convert.ToString(drbposition.SelectedValue) + "' else  insert into Company_datails (CompanyFK,composition,comsalary,interviewdate,interviewtime,rounds) values('" + Convert.ToString(drpcompany.SelectedValue) + "','" + Convert.ToString(drbposition.SelectedValue) + "','" + Convert.ToString(drbsalary.Text) + "','" + comdate + "','" + ReqExpectedTime + "','" + txtround.Text + "' )";
            int vcm = d2.update_method_wo_parameter(comsel, "TEXT");
            string comdetail=d2.GetFunction("select Companydetailspk from Company_datails where CompanyFK='" + Convert.ToString(drpcompany.SelectedValue) + "' and composition='" + Convert.ToString(drbposition.SelectedValue) + "' and interviewdate='"+comdate+"' order by Companydetailspk desc");
            string app_no = string.Empty;
            string batch_year = string.Empty;
            int stu_desire = 0;
            int shortlist_flag = 0;
            ...
            if (gview.Rows.Count > 0)
            {
                ...
                {
                    batch_year = gview.Rows[row].Cells[1].Text;
                    app_no = gview.Rows[row].Cells[2].Text;

                    CheckBox select = gview.Rows[row].FindControl("select") as CheckBox;
                    if (select.Checked==true)
                    {
                    Hashtable hat = new Hashtable();
                    hat.Add("@APP_No", app_no);
                    hat.Add("@CompanyFK", Convert.ToString(drpcompany.SelectedValue));
                     hat.Add("@composition", Convert.ToString(drbposition.SelectedValue));
                     hat.Add("@comsalary", Convert.ToString(drbsalary.SelectedValue));
                    hat.Add("@interviewdate", comdate);
                    hat.Add("@CompanydetailsFk", comdetail);
                    hat.Add("@interviewtime", ReqExpectedTime);
                    hat.Add("@shortlist_flag", shortlist_flag);
                    hat.Add("@stu_desire", stu_desire);
                    hat.Add("@com_round", txtround.Text);
                    ds = d2.select_method("Company_REgistration",hat,"sp");
                    if (rdbmail.Checked == true)
                        sendmail(app_no);
            ...
            if(vcm!=0)
                ScriptManager.RegisterClientScriptBlock(this, typeof(Page), UniqueID, "alert('Alloted Successfully')", true);
    ...
    public void imagebtnpopclose2_Click(object sender, EventArgs e)
    {
        try
        {
            Div1.Visible = false;
    ...
    public void bindposition()
    {
        ...
        {
            ds.Clear();
            drbposition.Items.Clear();
            
            string itemname = "select distinct MasterCode, MasterValue from CO_MasterValues where MasterCriteria ='Company Position' and CollegeCode ='" + ddlcollege.SelectedItem.Value + "'  order by MasterCode";
            ds.Clear();
            ds = d2.select_method_wo_parameter(itemname, "Text");
            if (ds.Tables[0].Rows.Count > 0)
            {
                drbposition.DataSource = ds;
                drbposition.DataTextField = "MasterValue";
                drbposition.DataValueField = "MasterCode";
                drbposition.DataBind();
                drbposition.Items.Insert(0, "Select");
    ...
    public void Btnposition_Click(object sender, EventArgs e)
    {
        try
        {
            if (Txtposition.Text != "")
            {
                string posi = "if exists ( select * from CO_MasterValues where MasterValue ='" + Txtposition.Text + "' and MasterCriteria ='Company Position' and CollegeCode ='" + ddlcollege.SelectedItem.Value + "') update CO_MasterValues set MasterValue ='" + Txtposition.Text + "' where MasterValue ='" + Txtposition.Text + "' and MasterCriteria ='Company Position' and CollegeCode ='" + ddlcollege.SelectedItem.Value + "' else insert into CO_MasterValues (MasterValue,MasterCriteria,CollegeCode) values ('" + Txtposition.Text + "','Company Position','" + ddlcollege.SelectedItem.Value + "')";
               
                int vcm = d2.update_method_wo_parameter(posi, "TEXT");
                bindposition();
            }
            else
                ScriptManager.RegisterClientScriptBlock(this, typeof(Page), UniqueID, "alert('Please Enter Position Name')", true);
            Div2.Visible = false;
        }
        catch
        {
    ...
    public void btn_position_OnClick(object sender, EventArgs e)
    {
        try
        {
            string posi = "delete from CO_MasterValues where MasterCode='" + Convert.ToString(drbposition.SelectedValue) + "' and MasterCriteria ='Company Position' and CollegeCode ='" + ddlcollege.SelectedItem.Value + "'";
            int vcm = d2.update_method_wo_parameter(posi, "TEXT");
            bindposition();
    ...
    public void btn_positionadd_OnClick(object sender, EventArgs e)
    {
        try
        {
            Div2.Visible = true;
    ...
    public void Btnpositionex_Click(object sender, EventArgs e)
    {
        try
        {
            Div2.Visible = false;
    ...
    public void btnroundgo_OnClick(object sender, EventArgs e)
    {
        try
        {
            DataTable dt = new DataTable();
            dt.Columns.Add("No Of Rounds");
            DataRow dr;
            if (txtround.Text != "")
            {
                for (int i = 0; i < Convert.ToInt32(txtround.Text); i++)
                {
                    dr = dt.NewRow();
                    dt.Rows.Add(dr);
                }
                ...
                if (dt.Rows.Count > 0)
                {
                    gridround.DataSource = dt;
                    gridround.DataBind();
                    gridround.Visible = true;
                }
        }
        catch
        {
    ...
    //public void btnroundex_OnClick(object sender, EventArgs e)
    //{
    //    try
    //    {
    //        string round = "if exists(select * from New_InsSettings where LinkName='Interview Rounds'  and college_code='" + ddlcollege.SelectedItem.Value + "' and LinkValue='" + drpround.SelectedValue + "')     delete from New_InsSettings where LinkName='Interview Rounds'  and college_code='" + ddlcollege.SelectedItem.Value + "' and LinkValue='" + drpround.SelectedValue + "'";
    //        int vcm = d2.update_method_wo_parameter(round, "TEXT");
    //        Div4.Visible = false;
    //        interviewround();
    //    }
    //    catch
    ...
    //    }
    //}
    public void btn_salary_OnClick(object sender, EventArgs e)
    {
        try
        {
    ...
    public void btnex_OnClick(object sender, EventArgs e)
    {
        try
        {
            string round = "if exists(select * from New_InsSettings where LinkName='Company Salary'  and college_code='" + ddlcollege.SelectedItem.Value + "' and LinkValue='" + drbsalary.SelectedValue + "')     delete from New_InsSettings where LinkName='Company Salary'  and college_code='" + ddlcollege.SelectedItem.Value + "' and LinkValue='" + drbsalary.SelectedValue + "'";
            int vcm = d2.update_method_wo_parameter(round, "TEXT");
    ...
    public void btnsaladd(object sender, EventArgs e)
    {
        try
        {
            if (txtsal.Text != "")
            {
                string round = "if exists(select * from New_InsSettings where LinkValue='" + txtsal.Text + "' and LinkName='Company Salary' and college_code='" + ddlcollege.SelectedItem.Value + "'  ) update New_InsSettings set LinkValue='" + txtsal.Text + "' where LinkName='Company Salary'  and college_code='" + ddlcollege.SelectedItem.Value + "' else insert into New_InsSettings (LinkName,LinkValue,user_code,college_code)values('Company Salary','" + txtsal.Text + "','" + usercode + "','" + ddlcollege.SelectedItem.Value + "')";
                int vcm = d2.update_method_wo_parameter(round, "TEXT");
            }
            else
                ScriptManager.RegisterClientScriptBlock(this, typeof(Page), UniqueID, "alert('Please Enter Salary')", true);
            Div6.Visible = false;
            salary();
        }
        catch
    ...
    public void btnsaldex_Click(object sender, EventArgs e)
    {
        try
        {
            Div6.Visible = false;
    ...
    public void salary()
    {
        ...
        {
            ds.Clear();
            drbsalary.Items.Clear();
            string itemname = "select distinct LinkValue from New_InsSettings where LinkName ='Company Salary' and college_code ='" + ddlcollege.SelectedItem.Value + "'  order by LinkValue";
            ds.Clear();
            ds = d2.select_method_wo_parameter(itemname, "Text");
            if (ds.Tables[0].Rows.Count > 0)
            {
                drbsalary.DataSource = ds;
                drbsalary.DataTextField = "LinkValue";
                drbsalary.DataValueField = "LinkValue";
                drbsalary.DataBind();
    ...
    //    {
    //        ds.Clear();
    //        drpround.Items.Clear();
    //        string itemname = "select distinct LinkValue from New_InsSettings where LinkName ='Interview Rounds' and college_code ='" + ddlcollege.SelectedItem.Value + "'  order by LinkValue";
    //        ds.Clear();
    //        ds = d2.select_method_wo_parameter(itemname, "Text");
    //        if (ds.Tables[0].Rows.Count > 0)
    //        {
    //            drpround.DataSource = ds;
    //            drpround.DataTextField = "LinkValue";
    //            drpround.DataValueField = "LinkValue";
    //            drpround.DataBind();
    ...
    public void bindstufilter()
    {
        string type = string.Empty;
        string[] statusname = { "Shortlist","Placed Student", "Not PlacedStudent" };
        for (int i = 0; i < 12; i++)
        {
            ddlfilter.Items.Add(new System.Web.UI.WebControls.ListItem(statusname[i], Convert.ToString(i + 1)));
        }
    }
    public void chkincluplacement_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            if (chkincluplacement.Checked == true)
            {
                colspaan.Visible = true;
                    colspaan1.Visible = true;
                    colspaan2.Visible = true;
                    colspaan3.Visible = true;
                ddlfilter.Visible = true;
                txtcompany.Visible = true;
                lblcom.Visible = true;
                lblstufilter.Visible = true;
                Panel1.Visible = true;
                bindCompanynames();
                bindstufilter();
            }
            ...
            {
                colspaan.Visible = false;
                colspaan1.Visible = false;
                colspaan2.Visible = false;
                colspaan3.Visible = false;
                ddlfilter.Visible = false;
                txtcompany.Visible = false;
                lblcom.Visible = false;
                lblstufilter.Visible = false;
    ...
    public void chkprevious_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            if (chkprevious.Checked == true)
            {
                ...
                DataRow dr;
                string selQ = "select Textval as course,Textcode from textvaltable where textcriteria='cours' and college_code=" + ddlcollege.SelectedValue + "";
                DataSet dsLan = d2.select_method_wo_parameter(selQ, "Text");

                if (dsLan.Tables[0].Rows.Count > 0)
                {
                    for (int i = 0; i < dsLan.Tables[0].Rows.Count; i++)
                    {
                        gpremark.DataSource = dsLan.Tables[0];
                        gpremark.DataBind();
                        gpremark.Visible = true;
                        Div4.Visible = true;
                    }
                }
            }
    ...
    protected void sendmail(string app_no)
    {
        try
        {
            ...
            string strquery = "select massemail,masspwd from collinfo where college_code ='"+Convert.ToString(ddlcollege.SelectedValue)+"' ";
            ds1.Dispose();
            ds1.Reset();
            ...
            string tomail = d2.GetFunction("select emailM from applyn where app_no='" + app_no + "'");
            if (tomail != "")
            {
                ...
                if (spl.Length > 0)
                {
                    for (int mai = 0; mai < spl.Length; mai++)
                    {
                        ...
                        if (send_mail != "")
                        {
                            string q = "select a.stud_name,r.Batch_year, r.Roll_no,r.Stud_Type,c.Course_Name,dt.Dept_Name,r.Current_Semester ,r.Sections, a.parent_name,r.college_code from applyn a,Registration r ,Degree d,course c,Department dt where   a.app_no=r.app_no   and  r.degree_code=d.Degree_Code and d.Course_Id=c.Course_Id and  d.Dept_Code=dt.Dept_Code and r.App_no='" + app_no + "'";
                            ds = d2.select_method_wo_parameter(q, "Text");
                            string name = string.Empty;
                            ...
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                strstuname = Convert.ToString(ds.Tables[0].Rows[0]["stud_name"]);
    ...
    public void mail_onchecked(object sender, EventArgs e)
    {
        if (rdbmail.Checked == true || rdbsms.Checked == true)
        {
    ...
    public void sendsms(string app_no)
    {
       ...
       string  user_id = d2.GetFunction("select SMS_User_ID from Track_Value where college_code='" +Convert.ToString(ddlcollege.SelectedValue)+ "'");
       string stuname = d2.GetFunction("select Stud_Name from Registration where App_No='" + app_no + "'");
       string mobilenos = string.Empty;
       string strmsg = " Dear" + stuname + "" + txtbody.Text+ "";
