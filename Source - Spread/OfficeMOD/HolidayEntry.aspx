...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <body>
        ...
        <div>
                                    ...
                                    <div id="divstf" runat="server" visible="false">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:UpdatePanel ID="updatepnldept" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtdept" Visible="true" runat="server" ReadOnly="true" Width="190px"
                                                                Style=" top: 156px; left: 394px; position: absolute;" CssClass="Dropdown_Txt_Box">---Select---</asp:TextBox>
                                                            <asp:Panel ID="pnldept" runat="server" Height="300px" Width="250" CssClass="multxtpanel">
                                                                <asp:CheckBox ID="cbdepartment" runat="server" Font-Size="Medium" Text="Select All"
                                                                    AutoPostBack="True" OnCheckedChanged="cb_dept_CheckedChanged" />
                                                                <asp:CheckBoxList ID="cbldepartment" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cbl_dept_SelectedIndexChanged">
                                                                </asp:CheckBoxList>
                                                            </asp:Panel>
                                                            <asp:PopupControlExtender ID="PopupControlExtender12" runat="server" TargetControlID="txtdept"
                                                ...
                                                <td>
                                                    <asp:Label runat="server" Text="Staff Category" Style=" top: 159px; left: 591px; position: absolute;"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtstfcat" runat="server" Enabled="false" Style=" top: 156px; left: 705px; position: absolute; height: 20px; width: 205px;"
                                                                ReadOnly="true">--Select--</asp:TextBox>
                                                            <asp:Panel ID="Panel5" runat="server" CssClass="multxtpanel multxtpanleheight" Style="width: 210px;
                                                                height: 120px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:UpdatePanel ID="UpdatePanel_Department" runat="server">
                                                                    <ContentTemplate>
                                                                        <asp:TextBox ID="txt_Department" Visible="true" runat="server" ReadOnly="true" Width="178px"
                                                                            Style="top: 175px; left: 775px; position: absolute;" CssClass="Dropdown_Txt_Box">---Select---</asp:TextBox>
                                                                        <asp:Panel ID="panel_Department" runat="server" Height="300px" Width="250" CssClass="multxtpanel">
                                                                            <asp:CheckBox ID="cb_Department" runat="server" Font-Size="Medium" Text="Select All"
                                                                                AutoPostBack="True" OnCheckedChanged="cb_Department_CheckedChanged" />
                                                                        ...
                                                                        <asp:PopupControlExtender ID="PopupControlExtender10" runat="server" TargetControlID="txt_Department"
                                                ...
                                                <div id="div1" runat="server">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:UpdatePanel ID="UpdatePanelLnk" runat="server">
                                                                    <ContentTemplate>
                                                                        <asp:LinkButton ID="lbtn_Leav" runat="server" Text="Holiday For Particular Day" Font-Bold="true"
                                                                            CssClass="simple" Font-Names="Book Antiqua" Font-Size="Medium" OnClick="lbtn_Leav_Click"></asp:LinkButton>
                                                                    </ContentTemplate>
                                                                    <Triggers>
                                                                        <asp:PostBackTrigger ControlID="lbtn_Leav" />
                                                                    </Triggers>
                                                                </asp:UpdatePanel>
                                                            </td>
                                                        </tr>
            ...
            <center>
                <div id="popLeavedays" runat="server" visible="false" class="popupstyle popupheight">
                    <br />
                    <div class="subdivstyle" style="background-color: White; height: 565px; width: 710px;">
                        <asp:ImageButton ID="ImageButton1" runat="server" Width="40px" Height="40px" ImageUrl="~/images/close.png"
                            Style="height: 30px; width: 30px; position: absolute; margin-top: -37px; margin-left: 340px;"
                            OnClick="imagebtnpopclose1_Click" />
                        <br />
                        <center>
                            <asp:Label ID="lbl_select" runat="server" Font-Bold="true" Style="font-size: large;
                                color: Green;" Text="Holiday Days"></asp:Label>
                        </center>
                        <br />
                        <div>
                            <center>
                                <div>
                                    ...
                                    <p>
                                        <asp:Label ID="lbl_displayHoliday" runat="server" Visible="false" Font-Bold="true"
                                            ForeColor="Blue"></asp:Label>
                                    </p>
                                    <%-- <table>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblfrom" runat="server" Text="From" Style="margin-top: 10px; margin-left: -1px;"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txt_from" runat="server" Style="height: 20px; width: 75px; margin-left: 9px;"></asp:TextBox>
                                                <asp:CalendarExtender ID="CalendarExtender5" TargetControlID="txt_from" runat="server"
                                                    Format="dd/MM/yyyy" CssClass="cal_Theme1 ajax__calendar_active">
                                                </asp:CalendarExtender>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblto" runat="server" Text="To" Style="margin-left: 4px;"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txt_to" runat="server" Style="height: 20px; width: 75px; margin-left: 6px;"></asp:TextBox>
                                                <asp:CalendarExtender ID="CalendarExtender6" TargetControlID="txt_to" runat="server"
                                                    Format="dd/MM/yyyy" CssClass="cal_Theme1 ajax__calendar_active">
                                                </asp:CalendarExtender>
                                            </td>
                                            <td>
                                                <asp:Button ID="btn_go" Visible="true" runat="server" CssClass="textbox btn2" Text="Go"
                                                    Width="50" OnClick="btnGoleave_Click" />
                                            </td>
                                        </tr>
                                    </table>--%>
                                    <br />
                                    <br />
                                    <FarPoint:FpSpread ID="Fp_holiday" runat="server" Visible="false" Width="600px" Style="overflow: auto;
                                        height: 300px; border: 0px solid #999999; border-radius: 10px; background-color: White;
                                        box-shadow: 0px 0px 8px #999999;" OnButtonCommand="Fp_holiday_UpdateCommand">
                                        <Sheets>
                                            <FarPoint:SheetView SheetName="Sheet1">
                                            </FarPoint:SheetView>
                                        </Sheets>
                            ...
                            <center>
                                <div>
                                    <asp:UpdatePanel ID="UpdatePanel22" runat="server">
                                        <ContentTemplate>
                                            <asp:Button ID="btn_save2" Visible="false" runat="server" CssClass="textbox btn2"
                                                Text="Ok" Width="40" OnClick="btnsav_Click" />
                                        </ContentTemplate>
                                        <Triggers>
