...
using System.Web.UI;
using System.IO;
public partial class AdmissionMod_StudentCourseSelectionSplPermission : System.Web.UI.Page
{
    ...
    public void bindBranch()
    {
        try
        {
            string streamValue = ddlfirstStream.SelectedItem.Value;
                ...
                if (checkCategAvailability)
                {
                    ...
                    if (isAdmNoNotGenerated(appNo, admNoGenbatch, collegeCode, ref app_formNo))
                    {
                        ...
                        if (isSeatAvailable(collegeCode, batchYr, streamValue, categCode, degCode))
                        {
                            ...
                            //Fee allot on Save
                            if (ddlfirstStream.SelectedItem.Text != "NRI")
                            {
                            ...
                            sbAdmLetter.Append("<div style='height: 850px; width: 730px; font-family: Times New Roman; font-size: 16px; padding: 10px; padding-left:50px;'> <center><div style='height: 220px;'></div><div style='width: 730px; text-align: center; text-decoration: underline; padding-bottom:25px;'>ADMISSION LETTER</div><div style='width: 730px; padding-bottom:25px;'><span  style='padding-left: 530px;'>" + DateTime.Now.ToString("dd-MM-yyyy") + "</span></div><table style='width: 730px; text-align: left;' cellpadding=5><tr><td style='width:170px;'>Name</td><td>: " + studname.ToUpper() + "</td></tr><tr><td  style='width:170px;'>Application No</td><td>: " + generatedAdmNo + "</td></tr><tr><td  style='width:170px;'>Programme Admitted to</td><td>: " + ddlBranch.SelectedItem.Text + "</td></tr><tr><td  style='width:170px;'>Academic Year</td><td>: 2017-18</td></tr></table><div style='width:730px; padding-top:25px; text-align:left;'><p>Dear <b>" + studname.ToUpper() + "</b><br /><br />Congratulations!<br /><br />Welcome to the SASTRA student fraternity.<br /><br />" + certDet + "Classes for First year will commence on <b>" + getCommenceDateTime(collegeCode) + ".</b><br /><br />Wishing you a fruitful stay at SASTRA UNIVERSITY.<br /><br />Yours faithfully,      <br /><br /><img src='../image/registrarsign" + collegeCode + ".jpeg' style='height:40px; width:120px;'/><br /><br /><b>REGISTRAR</b></p></div></center></div>");
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(appNo))
            {
                ...
                if (!isAdmNoNotGenerated(appNo, admNoGenbatch, collegeCode, ref app_formNo))
                {
                    ...
                    StringBuilder sbAdmLetter = new StringBuilder();
                    sbAdmLetter.Append("<div style='height: 850px; width: 730px; font-family: Times New Roman; font-size: 16px; padding: 10px; padding-left:50px;'> <center><div style='height: 220px;'></div><div style='width: 730px; text-align: center; text-decoration: underline; padding-bottom:25px;'>ADMISSION LETTER</div><div style='width: 730px; padding-bottom:25px;'><span  style='padding-left: 530px;'>" + DateTime.Now.ToString("dd-MM-yyyy") + "</span></div><table style='width: 730px; text-align: left;' cellpadding=5><tr><td style='width:170px;'>Name</td><td>: " + studname.ToUpper() + "</td></tr><tr><td  style='width:170px;'>Application No</td><td>: " + app_formNo + "</td></tr><tr><td  style='width:170px;'>Programme Admitted to</td><td>: " + (course + " " + branch) + "</td></tr></tr><tr><td  style='width:170px;'>Academic Year</td><td>: 2017-18</td></tr></table><div style='width:730px; padding-top:25px; text-align:left;'><p>Dear <b>" + studname.ToUpper() + "</b><br /><br />Congratulations!<br /><br />Welcome to the SASTRA student fraternity.<br /><br />" + certDet + "Classes for First year will commence on <b>" + getCommenceDateTime(collegeCode) + ".</b><br /><br />Wishing you a fruitful stay at SASTRA UNIVERSITY.<br /><br />Yours faithfully,      <br /><br /><img src='../image/registrarsign" + collegeCode + ".jpeg' style='height:40px; width:120px;'/><br /><br /><b>REGISTRAR</b></p></div></center></div>");
                    contentDiv.InnerHtml = sbAdmLetter.ToString();
