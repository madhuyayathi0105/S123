<%@ Page Title="" Language="C#" MasterPageFile="~/AdmissionMod/AttendanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="StudentCourseRejection.aspx.cs" Inherits="AdmissionMod_StudentCourseRejection" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <center>
        <center>
            <span class="fontstyleheader" style="color: Green;">Student Selected Course Rejection</span>
        </center>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btn_register" runat="server" CssClass="textbox btn2" Text="Register"
                                ...
                                OnClick="btn_clear_click"  TabIndex="3" />
                        </td>
                    </tr>
                </table>
                            ...
                            <table width="450px">
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        Branch
                                        <asp:DropDownList ID="ddlBranch" runat="server" CssClass="textbox ddlheight4">
                                        </asp:DropDownList>
                                        <%--AutoPostBack="true"
                                            OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged"--%>
                                        <asp:Button ID="btnSave" runat="server" Text="Reject" CssClass=" textbox btn" BackColor="#89D17C"
                ...
                <div id="Div2" runat="server" class="table" style="background-color: White; height: 120px;
                    ...
                    <center>
                        <table style="height: 100px; width: 100%">
                            <tr>
                                <td align="center">
                                    <asp:Label ID="lblAlertDup" runat="server" Text="Do you want to reject the student?"
