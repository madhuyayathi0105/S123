<%@ Page Title="" Language="C#" MasterPageFile="~/AdmissionMod/AttendanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="StudentCourseSelectionSplPermission.aspx.cs"
    Inherits="AdmissionMod_StudentCourseSelectionSplPermission" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <center>
        <center>
            <span class="fontstyleheader" style="color: Green;">Student Course Selection - Special
                Permission</span>
        </center>
        ...
        <div style="margin-top: 0px; width: 950px;">
            <asp:RadioButtonList ID="rdbtype" runat="server" OnSelectedIndexChanged="rdbtype_SelectedIndexChanged"
                ...
                <asp:ListItem Value="1" Selected="True">Course Selection - Special
                Permission</asp:ListItem>
            </asp:RadioButtonList>
        </div>
        <br />
        <br />
                ...
                <div id="verification_div" runat="server" style="width: 900px;" visible="false">
                    <div id="certificate_grid_div" runat="server" width="450px" style="float: right;">
                        <div id="rankdet_div" runat="server">
                            <table width="450px" style="display: none;">
                                <tr>
                        ...
                        <center>
                            <table width="450px">
                                ...
                                <tr>
                                    <td colspan="2">
                                        Steam
                                        <asp:DropDownList ID="ddlfirstStream" runat="server" CssClass="textbox ddlheight"
