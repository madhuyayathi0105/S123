<%@ Page Title="" Language="C#" MasterPageFile="~/AdmissionMod/AttendanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="Student_verification.aspx.cs" Inherits="AdmissionMod_Student_verification" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <center>
        <center>
            <span class="fontstyleheader" style="color: Green;">Counselling Student Certificate
                Verification</span>
        </center>
        ...
        <div style="margin-top: 0px; width: 950px;">
            <asp:RadioButtonList ID="rdbtype" runat="server" OnSelectedIndexChanged="rdbtype_SelectedIndexChanged"
                ...
                <asp:ListItem Value="1" Selected="True">Verification</asp:ListItem>
            </asp:RadioButtonList>
        </div>
        <br />
        <asp:UpdatePanel ID="updSeatStat" runat="server">
            <contenttemplate>
                    <asp:Timer ID="tmrSeatStat" runat="server" Interval="1000" OnTick="tmrTTStat_OnTick">
                    </asp:Timer>
                    <div> 
                    <table>
                    <tr>
                    ...
                    <td colspan="2">
                        <span>Total verified</span> <span id="RegisterdSpan" runat="server" style="color: Green;">
                        </span>
                    </td>
                    </tr>
                    </table>
        ...
        <br />
        <div class="maindivstyle" style="width: 950px; height: 480px;">
            ...
            <div id="registration_div" runat="server">
                ...
                <div id="verification_div" runat="server" style="width: 900px;" visible="false">
                    <div id="certificate_grid_div" runat="server" width="900px">
                            ...
                            <contenttemplate>
                                <center>
                                    <asp:GridView ID="certificate_grid" runat="server" CaptionAlign="Top" HorizontalAlign="Justify"
                                        CellPadding="1" ForeColor="#333333" GridLines="Vertical" Width="900px" AutoGenerateColumns="false">
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Certificate Name">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lbl_certificateid" Visible="false" runat="server" Text='<%# Eval("CertName") %>'></asp:Label>
                                                </ItemTemplate>
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Received">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="cb_received" runat="server" AutoPostBack="true" OnCheckedChanged="cb_received_Click" />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="30px" />
                                            </asp:TemplateField>
                                        </Columns>
                                        <Columns>
                                            <asp:TemplateField HeaderText="If Not Received - Date">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txt_certidate" runat="server" Text="20/07/2017" Style="text-align: center;" Width="80px"
                                                        CssClass="textbox"></asp:TextBox>
                                                    <asp:CalendarExtender ID="CalendarExtender1" TargetControlID="txt_certidate" runat="server"
                                                        Format="dd/MM/yyyy">
                                    ...
                                    <asp:CheckBox ID="cb_selectall" Visible="false" runat="server" Style="margin-right: -457px;" OnCheckedChanged="cb_selectall_click"
                                        AutoPostBack="true" Text="Select All" />
                                    <br />
                                    <asp:Button ID="btn_shortlist" runat="server" CssClass="textbox btn2" Text="Verified"
                                        Visible="false" OnClick="btn_shortlist_click" TabIndex="3" BackColor="#00CC99"
                                        ForeColor="White" />
                                    <asp:Button ID="btn_clear" runat="server" CssClass="textbox btn2" Text="Clear"
                                        Visible="false" OnClick="btn_clear_click" TabIndex="3" BackColor="#00CC99" ForeColor="White" />
                                </center>
                            </contenttemplate>
                            <triggers>
                                <asp:PostBackTrigger ControlID="btn_shortlist" />
                            </triggers>
                        </asp:UpdatePanel>
                    </div>
                    <div id="Student_details_div" runat="server">
