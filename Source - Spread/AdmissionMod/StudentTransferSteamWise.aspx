<%@ Page Title="" Language="C#" MasterPageFile="~/AdmissionMod/AttendanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="StudentTransferSteamWise.aspx.cs" Inherits="AdmissionMod_StudentTransferSteamWise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <center>
        <center>
            <span class="fontstyleheader" style="color: Green;">Branch Sliding / Change</span>
        </center>
        ...
        <div style="margin-top: 0px; width: 950px;">
            <asp:RadioButtonList ID="rdbtype" runat="server" OnSelectedIndexChanged="rdbtype_SelectedIndexChanged"
                ...
                <asp:ListItem Value="1" Selected="True">Course Transfer / Stream Transfer</asp:ListItem>
            </asp:RadioButtonList>
        </div>
        <br />
        <br />
                            ...
                            <table width="450px">
                                ...
                                <tr style="background-color: #EA88B9;">
                                    ...
                                    <td style="width: 150px; padding-left: 5px;">
                                        <span runat="server" id="rankdet_spanRes"></span>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <center>
                            <table width="450px">
                                ...
                                <tr>
                                    <td colspan="2">
                                        Steam
                                        <asp:DropDownList ID="ddlfirstStream" runat="server" CssClass="textbox ddlheight1"
                                ...
                                <tr>
                                    <td>
                                        Branch
                                        <asp:DropDownList ID="ddlBranch" runat="server" Width="250px" CssClass="textbox ddlheight4">
                                        </asp:DropDownList>
                                        <%--AutoPostBack="true"
                                            OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged"--%>
                                        <asp:Button ID="btnSave" runat="server" Text="Reject" Visible="false" CssClass=" textbox btn"
                                            BackColor="#89D17C" Width="60px" OnClick="btnSave_OnClick" />
                                    </td>
                                </tr>
                            </table>
                        </center>
                        <div id="Div1" runat="server">
                            <table width="450px">
                                ...
                                <tr>
                                    <td colspan="2">
                                        Steam
                                        <asp:DropDownList ID="ddlStream" runat="server" CssClass="textbox ddlheight1" AutoPostBack="true"
                                            OnSelectedIndexChanged="ddlStream_SelectedIndexChanged">
                                        </asp:DropDownList>
                                        Category
                                        <asp:DropDownList ID="ddlcate" runat="server" CssClass="textbox ddlheight" AutoPostBack="true"
                                ...
                                <tr>
                                    <td colspan="2">
                                        Branch
                                        <asp:DropDownList ID="ddlTansferCourse" runat="server" Width="250px" CssClass="textbox ddlheight4">
                                        </asp:DropDownList>
                                        <%--AutoPostBack="true"
                                            OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged"--%>
                                        <asp:Button ID="btn" runat="server" Text="Transfer" CssClass=" textbox btn" BackColor="#89D17C"
        ...
        <div id="divPrintReject" runat="server" visible="false" style="height: 300em; z-index: 1000;
                ...
                <div id="Div2" runat="server" class="table" style="background-color: White; height: 120px;
                    ...
                    <center>
                        <table style="height: 100px; width: 100%">
                            <tr>
                                <td align="center">
                                    <asp:Label ID="lblAlertDup" runat="server" Text="Do you want to transfer the student?"
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <asp:Button ID="btnReject" CssClass=" textbox btn1 comm" Style="height: 28px; width: 65px;"
                                            OnClick="btnReject_Click" Text="Yes" runat="server" />
                                        <asp:Button ID="btnRejectClose" CssClass=" textbox btn1 comm" Style="height: 28px;
                                            width: 65px;" OnClick="btnRejectClose_Click" Text="No" runat="server" />
                                    </center>
                                </td>
                            </tr>
                        </table>
