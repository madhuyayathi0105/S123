<%@ Page Title="" Language="C#" MasterPageFile="~/AdmissionMod/AttendanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="SubjectNoSubjectNameEdit.aspx.cs" Inherits="AdmissionMod_SubjectNoSubjectNameEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <span id="spHeader" class="fontstyleheader" style="margin: 0px; margin-bottom: 10px;
            margin-top: 10px; position: relative; color: Green; font-weight: bold;">Subject
            Code and Subject Name Edit</span>
                    ...
                    <td colspan="10">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnGo" CssClass="textbox textbox1" runat="server" Width="50px" Height="30px"
                                        Style="font-family: 'Book Antiqua'; font-weight: bold; font-size: medium;" Text="Go"
                                        OnClick="btnGo_Click" />
                                </td>
                                <td>
                    ...
                    <asp:GridView ID="gvSectionWiseCount" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Subject Code">
                                <ItemTemplate>
                                    <asp:Label ID="lblDegreeName" runat="server" Visible="true" Text='<%#Eval("subject_code") %>'></asp:Label>
                                </ItemTemplate>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Subject Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblSubjectDet" runat="server" Visible="true" ForeColor="#003366" Text='<%#Eval("subject_name") %>'></asp:Label>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Subject Code">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtStudentCount" runat="server" Visible="true" CssClass="textbox textbox1"
                                        Width="120px" Text='<%#Eval("subject_code") %>'></asp:TextBox>
                                    <asp:FilteredTextBoxExtender runat="server" ID="filterStudentCount" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom"
                                        ValidChars="" TargetControlID="txtStudentCount">
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Subject Name">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtSubjectName" runat="server" Visible="true" CssClass="textbox textbox1"
                                        Width="400px" Text='<%#Eval("subject_name") %>'></asp:TextBox>
                                    <asp:FilteredTextBoxExtender runat="server" ID="file" FilterType="Numbers,UppercaseLetters,LowercaseLetters,Custom"
                                        ValidChars="   /&.-()" TargetControlID="txtSubjectName">
                                    </asp:FilteredTextBoxExtender>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="40px" />
                            </asp:TemplateField>
