<%@ Page Title="" Language="C#" MasterPageFile="~/AdmissionMod/AttendanceSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="Student_Hostelandtransport_request.aspx.cs"
    Inherits="AdmissionMod_Student_Hostelandtransport_request" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <center>
        <center>
            <span class="fontstyleheader" style="color: Green;">Student Hostel and Transport Selection
                Process</span>
        </center>
            ...
            <div id="registration_div" runat="server">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btn_submit" runat="server" CssClass="textbox btn2" Text="Submit"
                                OnClick="btn_submit_click" OnClientClick="return verifyEntry()" TabIndex="2" />
                ...
                <div id="verification_div" runat="server" style="width: 900px;" visible="false">
                    <div id="personaldet_div" runat="server">
                        <table width="900px">
                            <tr>
                                <td colspan="6" style="background-color: #0ca6ca; color: White;">
                                    Personal Details
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <span runat="server" id="applicantno_span"></span><span runat="server" visible="false"
                                        id="app_no_span"></span>
                                </td>
                    ...
                    <div style="margin-top: 0px; width: 950px;">
                        <asp:RadioButtonList ID="rdbtype" runat="server" OnSelectedIndexChanged="rdbtype_SelectedIndexChanged"
                            ...
                            <asp:ListItem Value="0" Selected="True">Hostel</asp:ListItem>
                            <asp:ListItem Value="1">Transport</asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                    <div id="room_div" runat="server" width="450px" visible="false">
                        <table width="900px">
                            <tr>
                                <td colspan="10" style="background-color: #0ca6ca; color: White;">
                                    Room Details
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:DropDownList ID="ddl_hostel" runat="server" CssClass="textbox1 ddlheight4" AutoPostBack="true"
                                        OnSelectedIndexChanged="ddl_hostel_selectedindexchanged">
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    Room Type
                                ...
                                <td>
                                    <asp:DropDownList ID="ddl_buildingname" runat="server" CssClass="textbox1 ddlheight4"
                                        AutoPostBack="true" OnSelectedIndexChanged="ddl_building_selectedindexchanged">
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    Type
                                ...
                                <td>
                                    <asp:DropDownList ID="ddl_filledtype" runat="server" CssClass="textbox1 ddlheight"
                                        AutoPostBack="true" OnSelectedIndexChanged="ddl_filledtype_selectedindexchanged">
                                        <asp:ListItem Value="0">All</asp:ListItem>
                                        <asp:ListItem Value="1">Filled</asp:ListItem>
                                        <asp:ListItem Value="2">Un Filled</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
                        <asp:DataList ID="roomno_datalist" runat="server" Font-Size="Medium" RepeatColumns="8"
                            Width="900px" ForeColor="#333333" OnItemDataBound="roomno_datalist_ItemDataBound">
                            ...
                            <ItemTemplate>
                                <table>
                                    <tr>
                                        <td>
                                            <asp:CheckBox ID="cb_room_dv" runat="server" />
                                        </td>
                                        <td>
                                            <asp:Label ID="lbl_roomname" ForeColor="Green" runat="server" Text='<%# Eval("Room_Name") %>'></asp:Label>
                                            <asp:Label ID="lbl_roompk" Visible="false" ForeColor="Green" runat="server" Text='<%# Eval("roompk") %>'></asp:Label>
                                            <asp:Label ID="lbl_checkcolor" ForeColor="Green" runat="server" Text='<%# Eval("checkval") %>'
                    ...
                    <div id="transport_div" runat="server" visible="false">
                        <table width="900px">
                            <tr>
                                <td colspan="6" style="background-color: #0ca6ca; color: White;">
                                    Transport Details
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddl_stage" runat="server" CssClass="textbox1 ddlheight5" AutoPostBack="true"
                                        OnSelectedIndexChanged="ddl_stage_selectedindexchanged">
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    <span id="span_routename" runat="server">Route Name</span>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddl_route" runat="server" CssClass="textbox1 ddlheight4" AutoPostBack="true"
                                        OnSelectedIndexChanged="ddl_route_selectedindexchanged">
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 195px;">
                                    <span id="availablevehicalseat" runat="server"></span>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <asp:Button ID="btn_register" runat="server" CssClass="textbox btn2" Text="Register"
                        Visible="false" OnClick="btn_register_click" TabIndex="3" />
                    <br />
                    <br />
                </div>
            </div>
