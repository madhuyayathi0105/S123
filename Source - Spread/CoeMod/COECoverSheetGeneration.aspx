<%@ Page Title="Cover Sheet Generation" Language="C#" MasterPageFile="~/CoeMod/COESubSiteMaster.master"
    AutoEventWireup="true" CodeFile="COECoverSheetGeneration.aspx.cs" Inherits="CoeMod_COECoverSheetGeneration"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <span class="fontstyleheader" style="color: Green; font-weight: bold; margin: 0px;
            margin-bottom: 15px; margin-top: 10px;">Cover Sheet Generation</span>
                    ...
                    <div id="divPrintContent" runat="server" style="margin: 0px; margin-top: 20px;">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnPrintCoverSheet" runat="server" Font-Bold="true" Font-Names="Book Antiqua"
                                        OnClick="btnPrintCoverSheet_Click" Font-Size="Medium" Text="Cover Sheet" CssClass="textbox textbox1"
