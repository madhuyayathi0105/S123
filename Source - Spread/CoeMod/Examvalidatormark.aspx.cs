...
public partial class Examvalidatormark : System.Web.UI.Page
{
    ...
    protected void buttongo()
    {
        try
        {
            ...
            if (ddlMonth1.SelectedValue != "" && ddlYear1.SelectedValue != "")//&& ddlSubject.SelectedValue != ""
            {
                ...
                if(!string.IsNullOrEmpty(Convert.ToString(ddlSubject.SelectedValue)) && !ChkBundlewise.Checked)
                {
                ...
                if (chksubwise.Checked == false && !string.IsNullOrEmpty(Convert.ToString(ddlbranch1.SelectedValue)) && Convert.ToString(ddlbranch1.SelectedValue)!="0")
                {
                ...
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if ((Convert.ToString(subjectCodeNew) != "") && !string.IsNullOrEmpty(subjectCodeNew))
                    {
                        ...
                        string type = string.Empty;
                        if (chksubwise.Checked == false && !string.IsNullOrEmpty(Convert.ToString(ddldegree1.SelectedValue)))
                        {
                        ...
                        if (Mark_Difference != "")
                        {
                            Mark_moderation1 = Convert.ToDouble(Mark_moderation);
                        }
                        else
                        {
                            Mark_moderation1 = 0;
                                ...
                                if (!hat.Contains(rollno))
                                {
                                    ...
                                    if (strsetval == "1" && cc.Trim().ToLower() != "true" && cc.ToLower() != "0")
                                    {
                                        ...
                                        if (dsstuatt.Tables.Count > 0 && dsstuatt.Tables[0].Rows.Count > 0)
                                        {
                                            ...
                                            dvst = dsstuatt.Tables[0].DefaultView;
                                        }
                                        if (dvst.Count == 0)
                                        {
                                            setflag = true;
                        ...
                        {   //317CO0417
                            ...
                            {
                                markmodeart = Convert.ToDouble(modemarkval);
                            }
                            else
                            {
                            ...
                            {
                                minintmodeallmar = Convert.ToDouble(minintmoderationallow);
                            }
                            else
                            {
                                                    ...
                                                    if (abse1 != -1 && abse2 != -1)
                                                    {
                                                        ...
                                                        if (ev1 != "" && ev2 != "" && ev2 != "NE" && ev1 != "NE")
                                                        {
                                                            ...
                                                            if (dv3.Count > 0)
                                                            {
                                                                ...
                                                                fpspread.Sheets[0].Cells[row_cnt, 8].Text = Convert.ToString(externn);
                                                            }
                                                            else
                                                            {
                                                                externn = dv1[0]["external_mark"].ToString();
                                                                ...
                                                                if (total.Trim() != "" && intermarkforab.Trim() != "")
                                                                {
                                                                    ...
                                                                    //{
                                                                        if (getval < mintolmarks1)
                                                                        {
                                                                            ...
                                                                            if (Convert.ToDouble(external_mark) < min_ext_marks1)
                                                                            {
                                                                        ...
                                                                        //else if (min_ext_marks1 > Convert.ToDouble(external_mark))
                                                                        //{
            ...
            for (int i = 0; i < fpspread.Sheets[0].Rows.Count; i++)
            {
                if (fpspread.Sheets[0].Cells[i, 5].BackColor == Color.SkyBlue && chkincluevel2.Checked==false)
                {
    ...
    public void marksavefunction()
    {
        try
        {
            ...
            double evalmaxmark = Convert.ToDouble(fpspread.Sheets[0].ColumnHeader.Cells[2, 2].Tag);
            double markdifffmoderer = Convert.ToDouble(fpspread.Sheets[0].ColumnHeader.Cells[2, 6].Note.ToString());
            ...
            {  //317CO0417
                ...
                maxinternalmarkvalue = Convert.ToDouble(fpspread.Sheets[0].Cells[r, 6].Tag.ToString());
                ...
                if (chk_onlycia.Checked == false)
                {
                    ...
                    else if (evauation1.Trim() != "" && evauation2.Trim() != "" && evauation3.Trim() == "")
                    {
                        ...
                        else
                        {
                            ...
                            extmark = Math.Round(extmark, 2, MidpointRounding.AwayFromZero);// added by jairam 02-02-2016
                            ...
                            else
                            {
                                ...
                                {
                                    double moderationmark1 = 0;
                                    moderationmark1 = avg + Convert.ToDouble(Math.Round(Convert.ToDouble(maderonmark)));
                                    moderationmark1 = moderationmark1 / evalmaxmark * maxexternal;
                                    moderationmark1 = Math.Round(moderationmark1, markround, MidpointRounding.AwayFromZero);
                                    moderationmark1 = Math.Round(moderationmark1, MidpointRounding.AwayFromZero);
                                    moderationmark1 = moderationmark1 + intark;
                                    if (moderationmark1 >= mintotalv)
                                    {
                                       // maderonmark = string.Empty;
                                    }
                                    else
                                    {
                                        maderonmark = string.Empty;
                    ...
                    else if (evauation1.Trim() != "" && evauation2.Trim() != "" && evauation3.Trim() != "")
                    {
                      ...
                      //  extmark = Math.Round(extmark, markround, MidpointRounding.AwayFromZero);
                        extmark = Math.Round(extmark, 2, MidpointRounding.AwayFromZero); //added by Mullai
                        extmark = Math.Round(extmark, MidpointRounding.AwayFromZero);
                        ese = extmark.ToString();
                        totalmarkvalue = extmark + intark;
                        totalmarkvalu = totalmarkvalue.ToString();
                    ...
                    if (chkicaretake.Checked == true || chkmarkbased.Checked == true)
                    {
                        ...
                        {
                            double mmark = 0;
                            if (ese.Trim() != "" && double.TryParse(ese.Trim(), out mmark))
                            {
                        ...
                        totalmarkvalue = 0;
                        double externssMArkNew = 0;
                        if (ese.Trim() != "" && double.TryParse(ese.Trim(), out externssMArkNew))
                        {
                    ...
                    if (maderonmark != "" && chkmoderation.Checked == true)
                    {
                        moderationmark = avg + Convert.ToDouble(Math.Round(Convert.ToDouble(maderonmark)));
                        ...
                        moderationmark = Math.Round(moderationmark, MidpointRounding.AwayFromZero);
    ...
    //    if (!string.IsNullOrEmpty(Convert.ToString(ddldegree1.SelectedValue)) && Convert.ToString(ddldegree1.SelectedValue)!="0")
    //    {
    //        Course = "and de.course_id='" + Convert.ToString(ddldegree1.SelectedValue) + "'";
    //    }
    //    if (!string.IsNullOrEmpty(Convert.ToString(ddlbranch1.SelectedValue)) && Convert.ToString(ddlbranch1.SelectedValue)!="0")
    //    {
    //        degree = "and r.degree_code='" + Convert.ToString(ddlbranch1.SelectedValue) + "'";
    //    }

    //    //if (!string.IsNullOrEmpty(Convert.ToString(ddlsem1.SelectedValue)) && Convert.ToString(ddlsem1.SelectedValue) != "0")
    //    //{
    //    //    cursem = "and r.current_semester='" + Convert.ToString(ddlsem1.SelectedValue) + "'";
    //    //}
    //    //if (!string.IsNullOrEmpty(Convert.ToString(ddlsubtype.SelectedValue)) && Convert.ToString(ddlsubtype.SelectedValue) != "0")
    //    //{
    //    //    subType = "and s.subtype_no='" + Convert.ToString(ddlsubtype.SelectedValue) + "'";
    //    //}

    //    if (!string.IsNullOrEmpty(Convert.ToString(ddlSubject.SelectedValue)))
    //    {
    //        subjectCode = "and s.subject_code='" + Convert.ToString(ddlSubject.SelectedValue) + "'";
    //    }

    //    string SelBundle = string.Empty;

    //    if (!string.IsNullOrEmpty(examyear) && !string.IsNullOrEmpty(examMonth))
    //    {
    //        //SelBundle = "select distinct ISNULL(es.bundle_no,'0') as bundleNo from exam_seating es,Exam_Details ed where ed.Exam_Month='" + examMonth + "' and ed.Exam_year='" + examyear + "' order by bundleNo asc";

    //        //SelBundle = "select distinct ISNULL(es.bundle_no,'0') as bundleNo from exam_seating es,Exam_Details ed,subject s where es.subject_no=s.subject_no and ed.Exam_Month='" + examMonth + "' and ed.Exam_year='" + examyear + "' and s.subject_code='" + subjectCode + "' order by bundleNo asc";
    //        SelBundle = "select distinct ISNULL(es.bundle_no,'0') as bundleNo from exam_seating es,Exam_Details ed,subject s,registration r,degree d,course de where  r.degree_code=d.degree_code and d.course_id=de.course_id and r.reg_no=es.regno and es.subject_no=s.subject_no and ed.Exam_Month='" + examMonth + "' and ed.Exam_year='" + examyear + "'" + Course + degree + subjectCode + "order by bundleNo asc";//and r.current_semester='' and s.subtype_no=''


    //        ds = da.select_method_wo_parameter(SelBundle, "text");
    //        if (ds.Tables[0].Rows.Count > 0)
    //        {
    //            cbl_bundle.DataSource = ds;
    //            cbl_bundle.DataTextField = "bundleNo";
    //            cbl_bundle.DataValueField = "bundleNo";
    //            cbl_bundle.DataBind();
    //            checkBoxListselectOrDeselect(cbl_bundle, true);
    //            CallCheckboxListChange(cb_Bundle, cbl_bundle, txt_Bundle, "", "--Select--");
    //        }
    //    }
    //}
    ...
    protected void cbl_Bundle_SelectedIndexChanged(object sender, EventArgs e)
    {
        //CallCheckboxListChange(cb_Bundle, cbl_bundle, txt_Bundle, "", "--Select--");
    }

    protected void cb_Bundle_checkedchange(object sender, EventArgs e)
    {
        
        //CallCheckboxChange(cb_Bundle, cbl_bundle, txt_Bundle, "", "--Select--");
    }
