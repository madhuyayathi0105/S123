<%@ Page Title="Subject Wise Exam Eligibility" Language="C#" MasterPageFile="~/CoeMod/COESubSiteMaster.master"
    AutoEventWireup="true" CodeFile="COESubjectWiseExamEligibility.aspx.cs" Inherits="CoeMod_COESubjectWiseExamEligiblity" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <%--<script type="text/javascript">
        $(document).load(function () {
            $('<%#txtMinAttForEligiblePercentage.ClientID %>').focusout(function () {
                var minPercentage = $('<%#txtMinAttForEligiblePercentage.ClientID %>').valueOf();
                if (minPercentage > 100) {
                    $('<%#txtMinAttForEligiblePercentage.ClientID %>').val = 0;
                }
            });
        }
    );
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:UpdatePanel ID="upd" runat="server">
        <ContentTemplate>
            <asp:UpdateProgress ID="UpdateProgress123" runat="server" DynamicLayout="true" AssociatedUpdatePanelID="upd">
                <ProgressTemplate>
                    <div style="height: 1000px; width: 100%; position: fixed; top: 0; left: 0px; background-color: White;">
                        <center>
                            <img src="../images/progress2.gif" style="margin-top: 100px; height: 150px;" />
                            <br />
            ...
            <center>
                <span class="fontstyleheader" style="color: Green; font-weight: bold; margin: 0px;
                    margin-bottom: 15px; margin-top: 10px;">Subject Wise Exam Eligibility</span>
                            ...
                            <div style="position: relative;">
                                <asp:UpdatePanel ID="upnlCollege" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:DropDownList ID="ddlCollege" Width="200px" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                                            Font-Size="Medium" CssClass="arrow" AutoPostBack="true" OnSelectedIndexChanged="ddlCollege_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                        ...
                        <td>
                            <div style="position: relative;">
                                <asp:UpdatePanel ID="upnlBatch" runat="server">
                                    ...
                                    Font-Size="Medium" CssClass="textbox  txtheight2" ReadOnly="true">--Select--</asp:TextBox>
                                <asp:Panel ID="pnlSem" runat="server" CssClass="multxtpanel" Style="width: 260px;
                        ...
                        <td>
                            <div style="position: relative;">
                                <asp:UpdatePanel ID="upnlBranch" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtBranch" Visible="false" Width="85px" runat="server" Font-Bold="True"
                                            Font-Names="Book Antiqua" Font-Size="Medium" CssClass="textbox  txtheight2" ReadOnly="true">--Select--</asp:TextBox>
                                        <asp:Panel ID="pnlBranch" Visible="false" runat="server" CssClass="multxtpanel" Style="width: 260px;
                                            height: 230px; overflow: auto; margin: 0px; padding: 0px;">
                                        ...
                                        <asp:DropDownList ID="ddlBranch" Width="150px" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                                            Font-Size="Medium" CssClass="arrow" AutoPostBack="true" OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:UpdatePanel ID="upnlSec" runat="server">
                                            <ContentTemplate>
                                                <asp:TextBox ID="txtSec" Visible="false" Width="80px" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                                                    Font-Size="Medium" CssClass="textbox  txtheight2" ReadOnly="true">-- Select --</asp:TextBox>
                                                <asp:Panel ID="pnlSec" Visible="false" runat="server" CssClass="multxtpanel">
                                    ...
                                    <td>
                                        <div style="position: relative;">
                                            <asp:UpdatePanel ID="upnlSubject" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="txtSubject" Width="135px" Visible="false" runat="server" Font-Bold="True"
                                                        Font-Names="Book Antiqua" Font-Size="Medium" CssClass="textbox  txtheight2" ReadOnly="true">--Select--</asp:TextBox>
                                                    <asp:Panel ID="pnlSubject" Visible="false" runat="server" CssClass="multxtpanel"
                                                        Style="width: 280px; height: 300px; overflow: auto; margin: 0px; padding: 0px;">
                                                    ...
                                                    <asp:DropDownList ID="ddlSubejct" Width="135px" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                                                        Font-Size="Medium" CssClass="arrow" AutoPostBack="true" OnSelectedIndexChanged="ddlSubejct_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                    ...
                    <tr>
                        <td colspan="12">
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblMinAttForEligible" runat="server" Text="Min.Attendance % For Eligibility To Write Exam"
                                            Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Medium" Style="width: auto;"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtMinAttForEligiblePercentage" runat="server" Font-Bold="True"
                                            Font-Names="Book Antiqua" Font-Size="Medium" Width="40px" MaxLength="5"></asp:TextBox>
                                        <asp:FilteredTextBoxExtender ID="filterMinAttForEligiblePercentage" runat="server"
                                            TargetControlID="txtMinAttForEligiblePercentage" FilterType="Custom,Numbers"
                                            ValidChars="." />
                                    </td>
                                    <%--<td>
                                        <asp:Label ID="lblPercentageType" runat="server" Text="Percentage Type" Font-Bold="True"
                                            Font-Names="Book Antiqua" Font-Size="Medium" Style="width: auto;"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlPercentageType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPercentageType_SelectedIndexChanged"
                                            RepeatDirection="Horizontal" Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Medium">
                                            <asp:ListItem Selected="True" Text="Daywise" Value="0"></asp:ListItem>
                                            <asp:ListItem Selected="False" Text="Hourwise" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>--%>
                                    <td>
                                        <asp:Label ID="lblReport" runat="server" Text="Report Type" Font-Bold="True" Font-Names="Book Antiqua"
                                            Font-Size="Medium" Style="width: auto;"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlShowReport" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlShowReport_SelectedIndexChanged"
                                            RepeatDirection="Horizontal" Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Medium">
                                            <asp:ListItem Selected="True" Text="Both" Value="0"></asp:ListItem>
                                            <asp:ListItem Selected="False" Text="Eligible" Value="1"></asp:ListItem>
                                            <asp:ListItem Selected="False" Text="Not Eligible" Value="2"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td>
            ...
            <center>
                <div id="divMainContents" runat="server" visible="false" style="margin: 0px; margin-bottom: 5px;
                    margin-top: 10px;">
                    <center>
                        <div id="divEligiblity" style="margin: 0px; margin-bottom: 5px; margin-top: 10px;">
                            <div id="divPrintContent" runat="server" style="margin: 0px; margin-top: 20px;">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnSaveEligiblity" runat="server" Font-Bold="true" Font-Names="Book Antiqua"
                                                OnClick="btnSaveEligiblity_Click" Font-Size="Medium" Text="Save" CssClass="textbox textbox1"
                                                Style="width: auto; height: auto;" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <FarPoint:FpSpread ID="FpExamEligiblity" autopostback="false" runat="server" Visible="true"
                                BorderStyle="Solid" OnButtonCommand="FpExamEligiblity_ButtonCommand" BorderWidth="0px"
