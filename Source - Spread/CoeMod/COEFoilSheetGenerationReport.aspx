<%@ Page Title="Foil Sheet Generation Report" Language="C#" MasterPageFile="~/CoeMod/COESubSiteMaster.master"
    AutoEventWireup="true" CodeFile="COEFoilSheetGenerationReport.aspx.cs" Inherits="CoeMod_COEFoilSheetGenerationReport"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <span class="fontstyleheader" style="color: Green; font-weight: bold; margin: 0px;
            margin-bottom: 15px; margin-top: 10px;">Foil Sheet Generation Report</span>
                ...
                <td colspan="12">
                    <table>
                        <tr>
                            ...
                            <td>
                                    <asp:Label ID="lblFormat" runat="server" Font-Bold="true" Font-Size="Medium"
                                        Text="Format"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlFormat" Width="90px" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                                        Font-Size="Medium" CssClass="arrow" AutoPostBack="true" OnSelectedIndexChanged="ddlFormat_SelectedIndexChanged">
                                        <asp:ListItem Text="Valuation" Selected="True" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="After Valuation" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="ReValuation" Value="2"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            <td>
                            ...
                            <td>
                                <asp:CheckBox ID="chkRevaluation" Visible="false" Checked="false" Font-Bold="True" Font-Names="Book Antiqua"
                                    Font-Size="Medium" runat="server" Text="Revaluation" AutoPostBack="True" Style="width: auto;
                                    height: auto; margin: 0px; padding: 0px; border: 0px;" OnCheckedChanged="chkRevaluation_CheckedChanged" />
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <center>
        <div id="divMainContents" runat="server" visible="false" style="margin: 0px; margin-bottom: 5px;
            margin-top: 10px;">
            <center>
                <div id="divPhasing" style="margin: 0px; margin-bottom: 5px; margin-top: 10px;">
                    <div id="divPrintContent" runat="server" style="margin: 0px; margin-top: 20px;">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lblReportType" runat="server" Font-Bold="true" Font-Size="Medium"
                                        Text="Report"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlReport" Width="90px" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                                        Font-Size="Medium" CssClass="arrow">
                                        <asp:ListItem Text="With Mark" Selected="True" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Without Mark" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    <asp:Label ID="lblValuation" runat="server" Font-Bold="true" Font-Size="Medium" Text="Valuation"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtValuation" Visible="true" Font-Size="Medium" Font-Bold="True"
                                        Font-Names="Book Antiqua" Width=" 45px" runat="server" Text="" CssClass="textbox  txtheight2"
                                        MaxLength="1"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="filterValuation" runat="server" TargetControlID="txtValuation"
                                        FilterType="Numbers">
                                    </asp:FilteredTextBoxExtender>
                                </td>
                                <td>
                                    <asp:Button ID="btnPrintFoilSheet" runat="server" Font-Bold="true" Font-Names="Book Antiqua"
                                        OnClick="btnPrintFoilSheet_Click" Font-Size="Medium" Text="Foil Sheet" CssClass="textbox textbox1"
                                        Style="width: auto; height: auto;" />
                                </td>
                            </tr>
                        </table>
                    </div>
                    <FarPoint:FpSpread ID="FpPhasing" autopostback="false" runat="server" Visible="true"
                        BorderStyle="Solid" OnButtonCommand="FpPhasing_ButtonCommand" BorderWidth="0px"
