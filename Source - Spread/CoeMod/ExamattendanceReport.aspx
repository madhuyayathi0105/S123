<%@ Page Title="Exam Attendance Report" Language="C#" MasterPageFile="~/CoeMod/COESubSiteMaster.master"
    AutoEventWireup="true" CodeFile="ExamattendanceReport.aspx.cs" Inherits="CoeMod_ExamAttendanceReportNew"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        ...
        <table class="maintablestyle" style="margin: 0px; margin-bottom: 10px; margin-top: 10px;
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnsettings" runat="server" Font-Bold="True" Text="Settings" Font-Names="Book Antiqua"
                        Font-Size="Medium" OnClick="btnsettings_Click" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <asp:DropDownList ID="ddlSubject" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                        Visible="false" Font-Size="Medium" AutoPostBack="True" Width="180px" OnSelectedIndexChanged="ddlsubject_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="false" Font-Bold="True"
                        Font-Names="Book Antiqua" Font-Size="Medium" Text="Without footer" Visible="true" />
                </td>
                <td>
                    <asp:CheckBox ID="chkincludenote" runat="server" Text="Include Note" Font-Bold="true"
                ...
                <td>
                    <asp:CheckBox ID="chkBatch" runat="server" Text="Batch Wise" Font-Bold="True" Font-Names="Book Antiqua"
                        Font-Size="Medium" AutoPostBack="true" OnCheckedChanged="chkBatch_OnCheckedChanged" />
                </td>
                <td>
                    <asp:DropDownList ID="ddlBatch" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                        Visible="false" Font-Size="Medium" Width="90px">
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
        ...
        <table style="margin: 0px; margin-bottom: 5px; margin-top: 5px; position: relative;
            ...
            <tr>
                <td align="center">
                    ...
                    <%--Deepali 12.5.18===========================--%>
                    <fieldset runat="server" id="fsPrintSetting" visible="false" style="width: -moz-fit-content;">
                        <legend style="font-weight: bold">Print Settings</legend>
                        <fieldset>
                            <legend style="font-weight: bold">Header</legend>
                            <asp:RadioButtonList ID="rblPrintSettingsHeader" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Text="All Pages" Value="0" Selected="True"></asp:ListItem>
                                <asp:ListItem Text="First Page" Value="1"></asp:ListItem>
                            </asp:RadioButtonList>
                        </fieldset>
                        <fieldset>
                            <legend style="font-weight: bold">Footer</legend>
                            <asp:RadioButtonList ID="rblPrintSettingsFooter" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Text="All Pages" Value="0" Selected="True"></asp:ListItem>
                                <asp:ListItem Text="Last Page" Value="1"></asp:ListItem>
                            </asp:RadioButtonList>
                        </fieldset>
                    </fieldset>
                    <br />
    ...
    <center>
        <div id="divsettings" runat="server" visible="false" style="height: 400em; z-index: 2000;
            width: 100%; background-color: rgba(54, 25, 25, .2); position: absolute; top: 0;
            left: 0px;">
            <center>
                <div id="divset" runat="server" class="table" style="background-color: White; height: auto;
                    width: 500px; border: 5px solid #0CA6CA; border-top: 25px solid #0CA6CA; margin-top: 200px;
                    border-radius: 10px;">
                    <center>
                    ...
                    <table style="margin: 0px; margin-bottom: 10px; margin-top: 10px; position: relative;
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblnote" runat="server" Text="Note:Use $ for the next line" Style="color: Green"
                                    Font-Size="Small"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblsignature1" runat="server" Text="Signature1"></asp:Label>
                                <asp:TextBox ID="txtsignature1" runat="server" Style="width: 150px; height: 40px"></asp:TextBox>
                                <asp:Label ID="lblsignature2" runat="server" Text="Signature2"></asp:Label>
                                <asp:TextBox ID="txtsignature2" runat="server" Style="width: 150px; height: 23px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Button ID="btnsaveformatsetting" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                                    Font-Size="Medium" OnClick="btnsaveformsetting_Click" Text="Save" Style="margin-left: 193px;" />
