<%@ Page Title="" Language="C#" MasterPageFile="~/CoeMod/COESubSiteMaster.master" AutoEventWireup="true" CodeFile="Supplymentary Exam Eligible Students Report.aspx.cs" Inherits="CoeMod_Supplymentary" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <center>
        <span id="spPageHeading" runat="server" class="fontstyleheader" style="color: Green;
            margin: 0px; margin-bottom: 10px; margin-top: 10px; position: relative;">Supplymentary Exam Eligible Students Report</span>
        <div style="width: 100%; margin: 0px; margin-bottom: 10px; margin-top: 10px;" visible="true">
            <table class="maintablestyle" style="height: auto; width: auto;">
                <tr>
                    <td>
                     ...
                     <td>
                        ...
                        <asp:DropDownList ID="ddlyear" runat="server" AutoPostBack="true" Width="57px" Font-Names="Book Antiqua"
                            Style="" Font-Bold="true" Font-Size="Medium" Height="25px">
                        </asp:DropDownList>
                    ...
                    <tr>
                     <td>
                     <asp:Label ID="lbl_org_sem" Text="Semester" runat="server" font-name="Book Antiqua"
                     ...
                     <td>
                      <asp:Label ID="lblmaxArrCount" Text="Max.Arrear Count" runat="server" font-name="Book Antiqua"
                            Font-Size="Medium" Font-Bold="true"></asp:Label>
                     </td>
                     <td>
                      <asp:TextBox ID="txtMaxArrCount" runat="server" Width="67px" CssClass="textbox textbox1 txtheight3"></asp:TextBox>
                     
                        <asp:Button ID="btnGo" CssClass="textbox textbox1 commonHeaderFont" runat="server"
                            OnClick="btnGo_Click" Text="Go" Style="width:45px ; height: auto;" />
                    </td>
                    <%-- <td align="right">
        ...
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Visible="false" Width="95px" Height="20px"
                    Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Medium" Text="Export Excel"
                    ForeColor="Black"></asp:Label>
                <asp:TextBox ID="TextBox1" runat="server" Visible="false" Height="20px" Width="180px"
                ...
                <asp:Button ID="Button1" runat="server" OnClick="g1btnexcel_OnClick" Visible="false"
                    Text="Export Excel" Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Medium"
                    Style="margin-left: 6px;" />
            </td>
            <td>
                <asp:Button ID="Button2" runat="server" OnClick="g1btnprint_OnClick" Visible="false"
                    Text="Print" Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Medium" />
                <Insproplus:PRINTPDF  ID="PRINTPDF1"  runat="server" Visible="false" />
            </td>
        </tr>
    </table>
