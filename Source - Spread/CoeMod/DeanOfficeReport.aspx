<%@ Page Title="Dean Office Report" Language="C#" AutoEventWireup="true" CodeFile="DeanOfficeReport.aspx.cs"
    Inherits="CoeMod_DeanOfficeReport" MasterPageFile="~/CoeMod/COESubSiteMaster.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <br />
    <center>
    <asp:Label ID="Label2" runat="server" Text=" Dean Office Report" Font-Bold="True"
