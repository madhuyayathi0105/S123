<%@ Page Title="Date Wise Student Strength & Summary Report" Language="C#" MasterPageFile="~/CoeMod/COESubSiteMaster.master"
    AutoEventWireup="true" CodeFile="COEDateWiseStudentStrengthReport.aspx.cs" Inherits="CoeMod_COEDateWiseStudentStrengthReport"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <span class="fontstyleheader" style="color: Green; font-weight: bold; margin: 0px;
            margin-bottom: 15px; margin-top: 10px;">Date Wise Student Strength & Summary Report</span>
        <table class="maintablestyle" style="width: auto; height: auto; font-weight: bold;
                ...
                <td colspan="12">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblReportFormat" runat="server" Text="Format" Font-Bold="true" Font-Names="Book Antiqua"
                                    Font-Size="Medium"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlReportFormat" Visible="true" runat="server" Font-Bold="True"
                                    Font-Names="Book Antiqua" Font-Size="Medium" CssClass="arrow" AutoPostBack="true"
                                    OnSelectedIndexChanged="ddlReportFormat_SelectedIndexChanged">
                                    <asp:ListItem Selected="True" Text="Date Wise Student Detail" Value="0"></asp:ListItem>
                                    <asp:ListItem Selected="False" Text="Summary Sheet" Value="1"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td>
            ...
            <tr>
                <td colspan="12">
                    <div id="divDateWiseReport" runat="server" visible="true">
                        <table>
                            <tr>
                                <td>
                                    <asp:CheckBox ID="chkDepartmentWise" AutoPostBack="true" Text="Include Department Wise" runat="server"
                                        Checked="true" Font-Bold="true" Font-Size="Medium" OnCheckedChanged="chkDepartmentWise_CheckedChanged"/>
                                </td>
                                <td>
                                    <asp:CheckBox ID="chkNeedSubjectTotal" Text="Need Subject Total" runat="server" Checked="false"
                                        Font-Bold="true" Font-Size="Medium" />
                                </td>
                                <td>
                                    <asp:CheckBox ID="chkNeedDateWiseTotal" Text="Need Date Wise Total" runat="server"
                                        Checked="true" Font-Bold="true" Font-Size="Medium" />
                                </td>
                                <td>
                                    <asp:CheckBox ID="chkNeedOverallTotal" Text="Need Overall Total" runat="server" Checked="true"
                                        Font-Bold="true" Font-Size="Medium" />
                                </td>
                                 <td>
                                    <asp:CheckBox ID="chkWithoutRegularArrear" Text="Without Regular/Arrear" runat="server" Checked="true"
                                        Font-Bold="true" Font-Size="Medium" />
                                </td>
                            </tr>
                        </table>
                    ...
                    <div id="divPrintContent" runat="server" style="margin: 0px; margin-top: 20px;">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnPrintCoverSheet" Visible="false" runat="server" Font-Bold="true"
                                        Font-Names="Book Antiqua" OnClick="btnPrintCoverSheet_Click" Font-Size="Medium"
                                        Text="Cover Sheet" CssClass="textbox textbox1" Style="width: auto; height: auto;" />
                                </td>
                            </tr>
                        </table>
                    </div>
                    <FarPoint:FpSpread ID="FpStudentStrength" autopostback="false" runat="server" Visible="true"
                        BorderStyle="Solid" OnButtonCommand="FpStudentStrength_ButtonCommand" BorderWidth="0px"
