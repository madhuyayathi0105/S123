<%@ Page Title="" Language="C#" MasterPageFile="~/CoeMod/COESubSiteMaster.master" AutoEventWireup="true" CodeFile="Course_Programme_wise_Classification_Report.aspx.cs" Inherits="CoeMod_Course_Programme_wise_Classification_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <center>
        <span class="fontstyleheader" style="color: Green;">Course/Programme wise Classification Report </span>
            ...
            <tr>
                            ...
                            <td>
                                <asp:UpdatePanel ID="upnlCollege" runat="server">
                                    ...
                                    Font-Size="Medium" Width="300px" AutoPostBack="true" OnSelectedIndexChanged="ddlCollege_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                            ...
                            <td>
                                        ...
                                        Font-Size="Medium"  Style="" Text="Go" OnClick="btnGo_Click" />
                ...
                <div id="divMainContents" runat="server" visible="false" style="margin: 0px; margin-bottom: 5px;
                    ...
                    <center>
                        <div id="divEligiblity" style="margin: 0px; margin-bottom: 5px; margin-top: 10px;">
                            ...
                            <FarPoint:FpSpread ID="FpSpread1" autopostback="false" runat="server" Visible="true"
