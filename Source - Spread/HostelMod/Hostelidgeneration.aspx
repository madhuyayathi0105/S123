<%@ Page Title="" Language="C#" MasterPageFile="~/Hostelmod/hostelsite.master"
    AutoEventWireup="true" CodeFile="Hostelidgeneration.aspx.cs" Inherits="Hostelidgeneration" %>
            ...
            <div class="maindivstyle" style="height: 275px; width: 1000px;">
                <center>
                    ...
                    <table class="maintablestyle" style="width: 980px">
                        ...
                        <fieldset style="width: 344px; height: 15px;">
                            
                            <asp:RadioButton ID="rdbhostel" runat="server" Text="Hostel Wise" GroupName="Move" AutoPostBack="true" OnCheckedChanged="rdbhostel_CheckedChange" Checked="true" />
                            <asp:RadioButton ID="rdbind" runat="server" Text="Indival" GroupName="Move" AutoPostBack="true"  OnCheckedChanged="rdbhostel_CheckedChange" />
                            
                        </fieldset>
                    </td>
                    <td>
                    
                                <asp:DropDownList ID="ddlhostel" runat="server" Width="149px" CssClass="textbox1 ddlstyle ddlheight6" OnSelectedIndexChanged="ddlhostel_SelectedIndexChanged"
                                   AutoPostBack="true">
                                </asp:DropDownList>
                            </td>
