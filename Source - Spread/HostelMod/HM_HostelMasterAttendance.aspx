<%@ Page Title="" Language="C#" MasterPageFile="~/Hostelmod/hostelsite.master" AutoEventWireup="true"
    CodeFile="HM_HostelMasterAttendance.aspx.cs" Inherits="HM_HostelMasterAttendance"
                ...
                <center>
                    <table style="margin-left: 11px; height: 40px;" class="maintablestyle">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:UpdatePanel ID="UpdatePanelnew" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txt_hostelname" runat="server" CssClass="textbox textbox1" ReadOnly="true"  Width="102px">--Select--</asp:TextBox>
                             ...
                             <td>
                                <asp:Label ID="Label1" Text="Batch" runat="server" Width="52px"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlBatchyear" runat="server" CssClass="textbox1 ddlheight1"
                                    Width="58px" AutoPostBack="true" OnSelectedIndexChanged="ddlBatchyear_SelectedIndexChanged" Visible="false">
                                </asp:DropDownList>
                                 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="Txtbatch" runat="server" CssClass="textbox textbox1" ReadOnly="true" Width="72px">--Select--</asp:TextBox>
                                        <asp:Panel ID="Panel2" runat="server" CssClass="multxtpanel" Width="200px" Height="200px">
                                            <asp:CheckBox ID="Chkbatch" runat="server" Text="Select All" AutoPostBack="true"
                                                OnCheckedChanged="Chkbatch_CheckedChanged" />
                                            <asp:CheckBoxList ID="Cblbatch" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Cblbatch_SelectIndexChange">
                                            </asp:CheckBoxList>
                                        </asp:Panel>
                             ...
                             <td>
                                <asp:Label ID="Label2" Text="Building Name" runat="server" Width="52px"></asp:Label>
                            </td>
                            <td>
                                ...
                                <asp:UpdatePanel ID="upp1" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txt_floorname" runat="server"  CssClass="textbox textbox1"
                                            Width="102px" ReadOnly="true" Height="20px">--Select--</asp:TextBox>
                                        ...
                                        <asp:DropDownList ID="ddl_floorname" Visible="false" runat="server" CssClass="textbox textbox1 ddlheight1"
                        ...
                        <tr>
                           ...
                           <tr>
                        <td colspan="5">
                        <fieldset style="width: 300px; height: 35px;">
                      
                            <asp:RadioButton ID="rdbroom" runat="server" Text="RoomWise"
                                 GroupName="Attendance" Checked="true"  />
                       
                            <asp:RadioButton ID="rdbrollno" runat="server" Text="Rollnowise" GroupName="Attendance"
                              />
