...
public partial class CO_StudentTutor : System.Web.UI.Page
{
    ...
    //        clgbuild(ddl_hostelname.SelectedItem.Value.ToString());
    ...
    //            ddl_hostelname.DataValueField = "Hostel_code";
    //            ddl_hostelname.DataBind();
    //            //  ddl_hostelname.Items.Insert(0, "--Select--");

    //            ddl_hostelname1.DataSource = ds;
    //            ddl_hostelname1.DataTextField = "Hostel_Name";
    //            ddl_hostelname1.DataValueField = "Hostel_code";
    //            ddl_hostelname1.DataBind();
    //            //ddl_hostelname1.Items.Insert(0, "--Select--");

    //            build = ddl_hostelname.SelectedValue;
    //            string buildvalue = "";
    //            string build1 = "";
    //            int seatcount = 0;
    //            for (int i = 0; i < cbl_buildingname.Items.Count; i++)
    ...
    protected void btn_go_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string buildname = "";
            string floorname, locfloorname = "";
            string roomtype, locroomtype = "";
            string hostelcode = "";
            ...
            // cbl_columnorder_SelectedIndexChanged(sender, e);
            for (int i = 0; i < cbl_buildingname.Items.Count; i++)
            {
                if (cbl_buildingname.Items[i].Selected == true)
                {
                    build = cbl_buildingname.Items[i].Value.ToString();
                    if (buildname == "")
                    {
                        buildname = build;
                    }
            ...
            for (int i = 0; i < cbl_floorname.Items.Count; i++)
            {
                if (cbl_floorname.Items[i].Selected == true)
                {
                    floorname = cbl_floorname.Items[i].Value.ToString();
                    if (locfloorname == "")
                    {
                        locfloorname = floorname;
                    }
                    else
                    {
                        locfloorname = locfloorname + "'" + "," + "'" + floorname;
                    }
                }
            }
            for (int i = 0; i < cbl_roomname.Items.Count; i++)
            {
                if (cbl_roomname.Items[i].Selected == true)
                {
                    roomtype = cbl_roomname.Items[i].Value.ToString();
                    if (locroomtype == "")
                    {
                        locroomtype = roomtype;
                    }
                    else
                    {
                        locroomtype = locroomtype + "'" + "," + "'" + roomtype;
                    }
                }
            }
            ...
            if (hostelcode.Trim() != "" && buildname.Trim() != "" && locfloorname.Trim() != "" && locroomtype.Trim() != "")
            {
                if (txt_staffname.Text != "")
                {
                    ...
                    sql = "select st.APP_No,r.Roll_No,r.Reg_No,r.Stud_Name,sm.Staff_Name,h.HostelName,hs.BuildingFK,hs.FloorFK,hs.RoomFK from HM_HostelMaster h,HT_HostelRegistration hs,Registration r,staff_appl_master a,CO_StudentTutor as st,staffmaster as sm  where h.HostelMasterPK =hs.HostelMasterFK and a.appl_no=sm.appl_no and a.appl_id=st.StaffMasterFK   and r.App_No =st.App_No and hs.APP_No =r.App_No  and CC=0 and DelFlag =0 and Exam_Flag <>'DEBAR'  and h.HostelMasterPK in('" + hostelcode + "') and hs.BuildingFK in ('" + buildname + "') and hs.FloorFK in ('" + locfloorname + "') and hs.RoomFK in ('" + locroomtype + "') and st.StaffMasterFK ='" + applid + "'";

                }
                else if (txt_studname.Text.Trim() != "")
                {
                    sql = "select st.APP_No,r.Roll_No,r.Reg_No,r.Stud_Name,sm.Staff_Name,h.HostelName,hs.BuildingFK,hs.FloorFK,hs.RoomFK from HM_HostelMaster h,HT_HostelRegistration hs,Registration r,staff_appl_master a,CO_StudentTutor as st,staffmaster as sm  where h.HostelMasterPK =hs.HostelMasterFK and a.appl_no=sm.appl_no and a.appl_id=st.StaffMasterFK   and r.App_No =st.App_No and hs.APP_No =r.App_No  and CC=0 and DelFlag =0 and Exam_Flag <>'DEBAR' and h.HostelMasterPK in('" + hostelcode + "') and hs.BuildingFK in ('" + buildname + "') and hs.FloorFK in ('" + locfloorname + "') and hs.RoomFK in ('" + locroomtype + "') and r.Stud_Name='" + Convert.ToString(txt_studname.Text) + "'";
                }
                else
                {

                    sql = "select st.APP_No,r.Roll_No,r.Reg_No,r.Stud_Name,sm.Staff_Name,h.HostelName,hs.BuildingFK,hs.FloorFK,hs.RoomFK from HM_HostelMaster h,HT_HostelRegistration hs,Registration r,staff_appl_master a,CO_StudentTutor as st,staffmaster as sm  where h.HostelMasterPK =hs.HostelMasterFK and a.appl_no=sm.appl_no and a.appl_id=st.StaffMasterFK   and r.App_No =st.App_No and hs.APP_No =r.App_No  and CC=0 and DelFlag =0 and Exam_Flag <>'DEBAR'  and h.HostelMasterPK in('" + hostelcode + "') and hs.BuildingFK in ('" + buildname + "') and hs.FloorFK in ('" + locfloorname + "') and hs.RoomFK in ('" + locroomtype + "')";
                    //and hs.Roll_Admit =r.Roll_Admit
                ...
                if (checkval == 1)
                {
                    ...
                    for (int j = 0; j < rno.Length; j++)
                    {
                        if (txt_staffname.Text != "")
                        {
                            ...
                            string staff_code = d2.GetFunction("select Staff_Code from staffmaster where Staff_Name='" + txt_staffname.Text + "'");
                            applid = d2.GetFunction("select appl_id  from staff_appl_master sam,staffmaster sm where  sm.staff_code='" + staff_code + "' and sam.appl_no = sm.appl_no");
                            sql = "DELETE FROM CO_StudentTutor WHERE App_No='" + rno[j] + "'  AND StaffMasterFK ='" + applid + "'";
                        }
                        else if (txt_staffname.Text == "")
                        {
                            flag = true;
                            sql = "DELETE FROM CO_StudentTutor WHERE App_No='" + rno[j] + "'";
                        }
            ...
            if (txt_staffname1.Text.Trim() != "")
            {
                for (int i = 0; i < cbl_hostelnameadd.Items.Count; i++)
                {
                    if (cbl_hostelnameadd.Items[i].Selected == true)
                    {
                        if (hostelcode == "")
                        {
                            hostelcode = "" + cbl_hostelnameadd.Items[i].Value.ToString() + "";
                        }
                        else
                        {
                            hostelcode = hostelcode + "'" + "," + "'" + cbl_hostelnameadd.Items[i].Value.ToString() + "";
                        }
                    }
                }
                for (int i = 0; i < cbl_building1.Items.Count; i++)
                {
                    if (cbl_building1.Items[i].Selected == true)
                    {
                        build = cbl_building1.Items[i].Value.ToString();
                        if (buildname == "")
                        {
                            buildname = build;
                        }
                ...
                for (int i = 0; i < cbl_floorname1.Items.Count; i++)
                {
                    if (cbl_floorname1.Items[i].Selected == true)
                    {
                        floorname = cbl_floorname1.Items[i].Value.ToString();
                        if (locfloorname == "")
                        {
                            locfloorname = floorname;
                        }
                ...
                for (int i = 0; i < cbl_roomname1.Items.Count; i++)
                {
                    if (cbl_roomname1.Items[i].Selected == true)
                    {
                        roomtype = cbl_roomname1.Items[i].Value.ToString();
                        if (locroomtype == "")
                        {
                            locroomtype = roomtype;
                        }
                ...
                {
                    //q = "select r.Roll_No,r.Reg_No,r.Stud_Name,h.Hostel_Name,hs.Building_Name,hs.Floor_Name,hs.Room_Name,hs.Room_Type,h.Hostel_code  from Hostel_Details h,Hostel_StudentDetails hs,Registration r where h.Hostel_code =hs.Hostel_Code and hs.Roll_No =r.Roll_No and CC=0 and DelFlag =0 and Exam_Flag <>'DEBAR'  and h.Hostel_Code in('" + hostelcode + "') and hs.Building_Name in ('" + buildname + "') and hs.Floor_Name in ('" + locfloorname + "') and hs.Room_Name in ('" + locroomtype + "') and r.Roll_No not in( select Roll_No  from StudentTutor_Details where Hostel_Code in('" + hostelcode + "'))";
                        ...
                        if (buildname != "" && locfloorname != "" && locroomtype != "")
                        {
                            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                            {
                                ...
                                for (int j = 0; j < ds.Tables[0].Columns.Count; j++)
                                {
                                    ...
                                    //Fpspread2.Sheets[0].Cells[Fpspread2.Sheets[0].RowCount - 1, 6].Text = Convert.ToString(ds.Tables[0].Rows[i]["BuildingFK"]);
                                    ...
                                    //Fpspread2.Sheets[0].Cells[Fpspread2.Sheets[0].RowCount - 1, 7].Text = Convert.ToString(ds.Tables[0].Rows[i]["FloorFK"]);
                                    ...
                                    //Fpspread2.Sheets[0].Cells[Fpspread2.Sheets[0].RowCount - 1, 8].Text = Convert.ToString(ds.Tables[0].Rows[i]["RoomFK"]);
                                ...
                                //Fpspread2.Sheets[0].Cells[Fpspread2.Sheets[0].RowCount - 1, 9].Text = Convert.ToString(ds.Tables[0].Rows[i]["Room_Type"]);
                            ...
                            //{
                            //    Fpspread2.Sheets[0].Cells[i, 1].CellType = check;
            ...
            for (int i = 1; i < Fpspread2.Sheets[0].RowCount; i++)
            {
                ...
                if (checkval == 1)
                {
                    ...
                    for (int ij = 0; ij < rno.Length; ij++)
                    {
                        ...
                        string sql = "";
                        sql = "if exists (select * from CO_StudentTutor where App_No ='" + rno[ij] + "') update CO_StudentTutor set StaffMasterFK ='" + applid + "', TutorFor=1 where  App_No ='" + rno[ij] + "'  else INSERT INTO CO_StudentTutor(App_No,StaffMasterFK,TutorFor) values ('" + rno[ij] + "','" + applid + "','1')";
                        int insert = d2.update_method_wo_parameter(sql, "TEXT");
                        if (insert != 0)
                        {
                            flag = true;
