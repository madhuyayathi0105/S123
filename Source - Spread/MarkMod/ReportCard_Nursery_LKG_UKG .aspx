<%@ Page Title="" Language="C#" MasterPageFile="~/MarkMod/CAMSubSiteMaster.master" AutoEventWireup="true" CodeFile="ReportCard_Nursery_LKG_UKG .aspx.cs" Inherits="ReportCard_Nursery_LKG_UKG_"  EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 <title>Report Card For Nursery LKG And UKG</title>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
  ...
  <%--  <div class="maindivstyle">
        <asp:Image ID="image1" runat="server" ImageUrl="~/Handler/Handler6.ashx" Style="height: 100px;
    ...
    <center>
        <div>
            <span class="fontstyleheader" style="color: Green">Report Card For Nursery LKG And UKG</span>
        </div>
    </center>
    <center>
       <%-- <div style="width: 978px; height: 26px; padding-left: auto; padding-right: auto;
            background-color: Teal; text-align: right;">
            <div style="float: right;">
                <asp:LinkButton ID="lbtnBack" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                    Font-Size="Small" ForeColor="Blue" PostBackUrl="~/Default_login.aspx" CausesValidation="False">Back</asp:LinkButton>
                &nbsp;
                <asp:LinkButton ID="lbtnHome" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                    Font-Size="Small" ForeColor="Blue" PostBackUrl="~/Default_login.aspx" CausesValidation="False">Home</asp:LinkButton>
                &nbsp;
                <asp:LinkButton ID="lbtnLogout" runat="server" Visible="true" Font-Bold="True" Font-Names="Book Antiqua"
                    Font-Size="Small" ForeColor="Blue" CausesValidation="False" OnClick="lbtnLogout_Click">Logout</asp:LinkButton>
            </div>--%>
        </div>
    </center>
    <center>
    ...
    <br />
    <center>
        <div id="divViewSpread" runat="server" visible="false">
            <table>
                <tr>
                    <td>
