<%@ Page Title="" Language="C#" MasterPageFile="~/MarkMod/CAMSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="YearwiseResultAnalysis.aspx.cs" Inherits="YearwiseResultAnalysis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <body>
        ...
        <br />
        <center>
            <asp:Label ID="Label1" runat="server" Text="Year wise Result Analysis" Font-Bold="True"
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddl_dept" runat="server" CssClass="textbox  ddlheight3 multxtpanleheight"
                            AutoPostBack="true" OnSelectedIndexChanged="ddl_dept_OnSelectedIndexChanged"
                            Font-Bold="True" Font-Names="Book Antiqua">
                        </asp:DropDownList>
                    </td>
                </tr>
                ...
                <ContentTemplate>
                    ...
                    <div id="divspread" runat="server" style="width: 950px; height: 390px; overflow: auto;"
                        ...
                        <FarPoint:FpSpread ID="FpSpread1" runat="server" Visible="false" BorderStyle="Solid"
                            ...
                            Width="950px" ShowHeaderSelection="false">
                            <Sheets>
