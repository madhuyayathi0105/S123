<%@ Page Title="Report Card For CBSE" Language="C#" MasterPageFile="~/MarkMod/CAMSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="ReportCard_CBSE.aspx.cs" Inherits="ReportCard_CBSE" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="FarPoint.Web.Spread" Namespace="FarPoint.Web.Spread" TagPrefix="FarPoint" %>
<%@ Register Src="~/Usercontrols/PrintMaster.ascx" TagName="printmaster" TagPrefix="Insproplus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Report Card For CBSE</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <div>
            <span class="fontstyleheader" style="color: Green">Report Card For CBSE</span>
        </div>
                ...
                <tr>
                    <td>
                        <asp:Label runat="server" ID="Label1" Text="Header" Font-Bold="True" Font-Names="Book Antiqua"
                            Font-Size="Medium" Style="font-family: Book Antiqua; font-size: medium; color: Black;
                            font-weight: bold; width: 118px;"></asp:Label>
                    </td>
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txtaccheader" ReadOnly="true" Font-Bold="True" Font-Names="Book Antiqua"
                                    Width="70px" runat="server" Font-Size="Medium" CssClass="textbox  txtheight2">---Select---</asp:TextBox>
                                <asp:Panel ID="paccheader" runat="server" CssClass="multxtpanel">
    ...
    <center>
        <div id="divViewSpread" runat="server" visible="false" style="margin-top: 10px; margin-bottom: 10px;
            position: relative;">
            <table>
                <tr>
                    <td>
                ...
                <tr>
                    <td align="center">
                        ...
                        <asp:Button ID="btnGrade" runat="server" Height="27px" Font-Bold="True" Font-Names="Book Antiqua"
                            Font-Size="Medium" ForeColor="Black" Style="background-color: #e6e6e6; box-shadow: 1px 11px 10px -11px;
                            color: darkslategrey; border: 2px solid teal;" Text="Gradesheet" OnClick="btnGrade_Click" />
                    </td>
                </tr>
                <tr>
                    <td>
