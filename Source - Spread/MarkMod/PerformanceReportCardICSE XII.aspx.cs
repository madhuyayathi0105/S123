...
public partial class MarkMod_PerformanceReportCardICSE_XII : System.Web.UI.Page
{
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    //qrySemester = " and r.current_semester <= " + semester + "";
                    qrySemester1 = " and srh.semester in(" + semester + ")";
                }
            }
            ...
            //&& !string.IsNullOrEmpty(qrySemester) 
            //commented on 5/12/2017 by prabha
            if (!string.IsNullOrEmpty(qryBatchYear) && !string.IsNullOrEmpty(qryBatchYear1) && !string.IsNullOrEmpty(qrySemester1) && !string.IsNullOrEmpty(qryDegreeCode) && !string.IsNullOrEmpty(qryDegreeCode1) && !string.IsNullOrEmpty(qryCollegeCode) && !string.IsNullOrEmpty(qryCollegeCode1))
            {
    ...
    protected void btnMarkTypeSettings_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string BestOfSelctedSubjects = string.Empty;
            BestOfSelctedSubjects = dirAcc.selectScalarString("select LinkValue from New_InsSettings where LinkName='XII BestOfSubjects' and college_code='" + ddlCollege.SelectedValue + "' ");
            //if (ddlTest.Items.Count > 0 && ddlTest.Visible)
            //{
            //    testNo = Convert.ToString(ddlTest.SelectedValue).Trim();
            //    testName = Convert.ToString(ddlTest.SelectedItem.Text).Trim();
            ...
            if (!string.IsNullOrEmpty(batchYear) && !string.IsNullOrEmpty(degreeCode) && !string.IsNullOrEmpty(semester))
            {
                ...
                if (isSubjectType)
                    qry = "select distinct sm.Batch_Year,sm.degree_code,sm.semester,ss.subject_type,ss.subType_no,'' subject_name,'' subject_code,'' acronym,'0' as subjectpriority,ISNULL(ss.isSingleSubject,'0') as isSingleSubject,'1' as subjectMarkOrGrade,'' subject_no,ISNULL(isCompulsaoryForGrandTotal,'0') isCompulsaoryForGrandTotal,ISNULL(isConsiderForGrandTotal,'0') isConsiderForGrandTotal from subject s,syllabus_master sm,sub_sem ss where sm.syll_code=s.syll_code and ss.syll_code=sm.syll_code and s.syll_code=ss.syll_code and s.subType_no=ss.subType_no and sm.degree_code='" + degreeCode + "' and sm.Batch_Year='" + batchYear + "' and sm.semester='" + semester + "' order by sm.Batch_Year,sm.degree_code,sm.semester,subjectpriority,ss.subType_no,s.subject_code";
            ...
            if (dtSubjects.Rows.Count > 0)
            {
                ...
                if (!isSubjectType)
                {
                    ...
                    if (!string.IsNullOrEmpty(BestOfSelctedSubjects))
                        FpSubjectList.Sheets[0].Cells[FpSubjectList.Sheets[0].RowCount - 1, 7].Text = BestOfSelctedSubjects;
                    else
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (FpSubjectList.Sheets[0].RowCount > 1)
            {
                ...
                string bestOfSubjectsqry = "if exists (select LinkValue from New_InsSettings where LinkName='XII BestOfSubjects' and college_code='" + ddlCollege.SelectedValue + "' )update New_InsSettings set  LinkValue='" + BestOfSubjects + "'  where LinkName='XII BestOfSubjects' and college_code='" + ddlCollege.SelectedValue + "'  else insert into New_InsSettings (LinkName,LinkValue,user_code,college_code) values('XII BestOfSubjects','" + BestOfSubjects + "','0','" + ddlCollege.SelectedValue + "')";
            ...
            else if (FpSubjectList.Sheets[0].ColumnHeader.Cells[0, j].Text.Trim().ToLower() != "select")
            {
                if (r == 0)
                {
                    if (FpSubjectList.Sheets[0].RowCount > 0)
                    {
                        ...
                        for (int i = 1; i < FpSubjectList.Sheets[0].RowCount; i++)
                        {
                            if (checkval == "0" || string.IsNullOrEmpty(checkval))
                            {
                                value = 1;
                            }
                            else if (checkval == "1")
    ...
    private void setLabelText()
    {
        try
        {
            ...
            {
                lblBatch.Text = "Year";
                spPageHeading.InnerHtml = "Performance Report Card ICSE XII";
                Page.Title = "Performance Report Card ICSE XII";
            }
            else
            {
                lblBatch.Text = "Batch";
    ...
    #region existing Academic Performance Report
    ...
    //            BestOfSubjects =
    //                dirAcc.selectScalarString("select LinkValue from New_InsSettings where LinkName='XII BestOfSubjects' and college_code='" +ddlCollege.SelectedValue+ "'");
    ...
    //                        dtCurrentSemesterSubject = dsStudMarks.Tables[1].DefaultView.ToTable(true, "subject_name", "subject_code", "subjectpriority", "acronym", "subjectMarkType", "isCompulsaoryForGrandTotal", "isConsiderForGrandTotal");
    ...
    //                        int totalRows = dtCurrentSemesterSubject.Rows.Count + 2;
    //                        int totalColumns = (dtDistinctTestName.Rows.Count - dtOtherSubjects.Rows.Count) + 2;
    ...
    //                                                dicSubjectWiseOverAllTotal[subjectTCode.Trim().ToLower()] += convertTestMark;
    //                                            else
    //                                                dicSubjectWiseOverAllTotal.Add(subjectTCode.Trim().ToLower(), convertTestMark);
    //                                        }
    ...
    //                                    if (others)
    //                                    {
    //                                        tblStudentMarks.Cell(subjectRow, 1).ColSpan = totalColumns - 2;
    //                                    }
    //                                    else
    //                                    {
    //                                        if (includeTest)
    ...
    //                                    tblStudentMarks.Cell(subjectRow + 1, 1).ColSpan = totalColumns - 2;
    ...
    //                                        double sum = dicCompulsarysubjectsTotal.Sum(x => Math.Round((x.Value), 0, MidpointRounding.AwayFromZero)) + subjectTypeWiseTotal;
    ...
    //                                        subjectWiseTotal = Math.Round((dicSubjectWiseTotal[subjectTCode.Trim().ToLower()]), 0, MidpointRounding.AwayFromZero);
    ...
    //                        #region commented on jan 08 2018
    ...
    //                string szFile = "PerformanceReportCardICSE_XII" + DateTime.Now.ToString("ddMMyyyy") + DateTime.Now.ToString("HHMMss") + ".pdf";
    ...
    private void AcademicPerformanceReport(List<string> lstAppNo, string rollNo)
    {
        try
        {
            ...
            if (lstAppNo.Count > 0)
            {
                ...
                BestOfSubjects = dirAcc.selectScalarString("select LinkValue from New_InsSettings where LinkName='XII BestOfSubjects' and college_code='" + ddlCollege.SelectedValue + "' ");
                BestOfSubjects = Convert.ToString(BestOfSubjects.Split('@').Last());
                int bestOfSubjectCount = 0;
                int.TryParse(BestOfSubjects, out bestOfSubjectCount);
                if (dtStudentDetails.Rows.Count > 0)
                {
                    foreach (DataRow drStudent in dtStudentDetails.Rows)
                    {
                        ...
                        if (dtCurrentStudentMarks.Rows.Count > 0)
                        {
                            ...
                            if (ddlSem.SelectedItem.Text.Trim() == "2" || ddlSem.SelectedItem.Text.Trim() == "3")
                                ...
                                foreach (DataRow dtTest in dtDistinctTestName.Rows)
                                {
                                    ...
                                    if (dvStudMarks.Count > 0)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (testSubMaxMarks > 0 && testMaxMark > 0)
                                                convertTestMark = (testSubMarks / testSubMaxMarks) * testMaxMark;
                                            //convertTestMark = Math.Round(convertTestMark, 2, MidpointRounding.AwayFromZero);  //TBM
                                            displayMark1 = convertTestMark.ToString();
                                            if (testSubMaxMarks > 0 && testSubMarks > 0)
                                                outOff100 = (testSubMarks / testSubMaxMarks) * 100;
                                        ...
                                        {
                                            if (ddlSem.SelectedItem.Text.Trim() == "2")
                                            {
                                                tblStudentMarks.Cell(subjectRow, totalColumns - 2).SetContent(String.IsNullOrEmpty(displayMark1) ? "--" : displayMark1);
                                                tblStudentMarks.Cell(subjectRow, totalColumns - 2).SetContentAlignment(ContentAlignment.MiddleCenter);
                                            }
                                            else
                                            {
                                                tblStudentMarks.Cell(subjectRow, totalColumns - 2).SetContent(String.IsNullOrEmpty(displayMark1) ? "--" : displayMark1);
                                    ...
                                    if (testColumn == dtDistinctTestName.Rows.Count - dtOtherSubjects.Rows.Count)
                                    {
                                        ...
                                        switch (semester.Trim().ToLower())
                                        {
                                            ...
                                            case "3":
                                                ...
                                                //tblStudentMarks.Cell(subjectRow, testColumn + 1).SetContent((isSubjectAbsent || isPrevSubjectAbsent) ? "--" : (subjectWiseTotal > 0) ? displayTotal : "--");
                                                //tblStudentMarks.Cell(subjectRow, testColumn + 1).SetContentAlignment(ContentAlignment.MiddleCenter);
                                                //if (subjectRow == dtCurrentSemesterSubject.Rows.Count + dtCurrentSingleSubjectType.Rows.Count)
                                                //{
                                                //    tblStudentMarks.Cell(subjectRow + 1, testColumn + 1).SetFont(fontReportContentBold);
                                ...
                                if ((isSingleSubject.Trim() == "1" || isSingleSubject.Trim().ToLower() == "true") && subjectCount == subjectTypeWiseSubjectCount)
                                {
                                    ...
                                    foreach (DataRow dtTest in dtDistinctTestName.Rows)
                                    {
                                        ...
                                        if (subjectRow == dtCurrentSemesterSubject.Rows.Count + dtCurrentSingleSubjectType.Rows.Count)
                                        {
                                            ...
                                            if (testColumn == dtDistinctTestName.Rows.Count - dtOtherSubjects.Rows.Count)
                                            {
                                                double subjectTypeWiseTotalNEW = 0;
                                                Dictionary<string, double> dicOtherSubjectTotal = dicConsiderSubjectTotal.OrderByDescending(x => x.Value).ToDictionary(x => x.Key, x => x.Value);
                                                int count = 0;
                                                if (bestOfSubjectCount <= 0)
                                                    bestOfSubjectCount = 3;
                                                ...
                                                double sum = dicCommonSubjectWiseTotal.Sum(x => Math.Round((x.Value), 2, MidpointRounding.AwayFromZero)) + dicSingleSubjectWiseTotal.Sum(x => Math.Round(x.Value, 2, MidpointRounding.AwayFromZero));  //TBCL
                                                tblStudentMarks.Cell(subjectRow + 1, testColumn + 1).SetContent((isAbsent) ? "--" : (sum > 0) ? sum.ToString() : "--");
                                                tblStudentMarks.Cell(subjectRow + 1, testColumn + 1).SetFont(fontReportContentBold);
                                                tblStudentMarks.Cell(subjectRow + 1, testColumn + 1).SetContentAlignment(ContentAlignment.MiddleCenter);
                                            }
        ...
        {
            da.sendErrorMail(e, collegeCode, "Performance Report Card XII");
        }
    }
