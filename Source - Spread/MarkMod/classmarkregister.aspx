<%@ Page Title="" Language="C#" MasterPageFile="~/MarkMod/CAMSubSiteMaster.master" AutoEventWireup="true" CodeFile="classmarkregister.aspx.cs" Inherits="classmarkregister" %>
            ...
            <center>
                <div style="width: 1016px; height: 26px; margin-left: 10px; margin: 50px auto 159px -28px;
                    ...
                    <center>
                        ...
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        <asp:Label ID="lbl" runat="server" Text="Class Register Mark And Grade Report" Font-Bold="true" Font-Names="Bood Antiqua"
