<%@ Page Title="Report Card For ICSE XI To XII" Language="C#" MasterPageFile="~/MarkMod/CAMSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="ReportCardICSE_XI_To_XII.aspx.cs" Inherits="ReportCardICSE_XI_To_XII" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>
        <center>
            Report Card For ICSE XI To XII
        </center>
    </title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <div>
            <span class="fontstyleheader" style="color: Green">Report Card For ICSE XI To XII</span>
        </div>
    </center>
    <center>
        <div style="width: 995px; height: 26px; background-color: Teal; text-align: right;
            margin-top: 10px;">
        </div>
        <div id="divSearch" runat="server" visible="true" style="width: 995px; height: auto;
