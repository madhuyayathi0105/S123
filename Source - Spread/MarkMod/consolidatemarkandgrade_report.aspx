<%@ Page Title="" Language="C#" MasterPageFile="~/MarkMod/CAMSubSiteMaster.master" AutoEventWireup="true" CodeFile="consolidatemarkandgrade_report.aspx.cs" Inherits="consolidatemarkandgrade_report" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <center>
                <div style="width: 1016px; height: 26px; margin-left: 10px; margin: 50px auto 159px -28px;
                    ...
                    <center>
                        ...
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        <asp:Label ID="lbl" runat="server" Text="Consolidated Mark And Grade Report" Font-Bold="true" Font-Names="Bood Antiqua"
            ...
            <div style="width: 996px; height: 65px; background-color: -webkit-border-radius: 10px;
                ...
                margin: -159px  auto -159px -28px; background-color: #219DA5;">
                <center>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lblschool" runat="server" Width="46px" Height="20px" Font-Bold="True"
                                            Font-Names="Book Antiqua" Style="position: absolute; margin-left:20px; left: 99px; top: 225px;"
                                        ...
                                        <asp:DropDownList ID="ddschool" runat="server" Width="185px" Height="25px" Font-Bold="True"
                                            Font-Names="Book Antiqua" Style="position: absolute; margin-left:10px; left: 158px; top: 225px;"
                                    ...
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddstandard" runat="server" Width="95px" Height="25px" AutoPostBack="true"
                                    ...
                                    <td>
                                        <asp:Label ID="lblterm" runat="server" Font-Color="white" Width="100px" Height="20px"
                                            Font-Bold="True" Font-Names="Book Antiqua" Style="position: absolute; left: 828px;
                                    ...
                                    Font-Size="Medium" AutoPostBack="true" OnSelectedIndexChanged="dropterm_OnSelectedIndexChanged">
                                        ...
                                        <asp:TextBox ID="txtterm" runat="server" CssClass="Dropdown_Txt_Box" Font-Bold="True"
                                            ...
                                            Width="77px" Style="position: absolute; left: 873px; top: 225px;"></asp:TextBox>
                                        <asp:Panel ID="pnlterm" runat="server" CssClass="MultipleSelectionDDL" BackColor="White" BorderColor="Black" 
BorderStyle="Solid" Height="200"
                    Width="175" 
                                    ...
                                    <td>
                                        <asp:Label ID="Iblsec" runat="server" Style="position: absolute; left: 959px; width: 40px;
                                    ...
                                    Font-Bold="true" Font-Size="Medium">
                                        ...
                                        <asp:TextBox ID="txtsec" runat="server" CssClass="Dropdown_Txt_Box" Font-Bold="True"
                                            ...
                                            Style="position: absolute; left: 984px; top: 225px;" Width="72px"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btngo" runat="server" Style="background-color: silver; border: 2px solid white;
                                            ...
                                            height: 27px;     margin-left: 1060px;
    margin-top: 177px; position: absolute; width: 42px;"
            ...
            <asp:Label ID="lblerrormsg" runat="server" Text="" Width="302px" Style="position: absolute;
                margin-left: 0px; margin-top: 169px;" Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Medium"
