<%@ Page Title="Report Card For ICSE IX To X" Language="C#" MasterPageFile="~/MarkMod/CAMSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="ReportCardICSE_IX_To_X.aspx.cs" Inherits="ReportCardICSE_IX_To_X" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="FarPoint.Web.Spread" Namespace="FarPoint.Web.Spread" TagPrefix="FarPoint" %>
<%@ Register Src="~/Usercontrols/PrintMaster.ascx" TagName="printmaster" TagPrefix="Insproplus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Report Card For ICSE IX To X</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <div>
            <span class="fontstyleheader" style="color: Green">Report Card For ICSE IX To X</span>
        </div>
    </center>
    <center>
        <div style="width: 1020px; height: 26px; margin-top: 10px; background-color: Teal;
            text-align: right;">
        </div>
        <div id="divSearch" runat="server" visible="true" style="width: 1020px; height: auto;
