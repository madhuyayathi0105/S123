<%@ Page Title="" Language="C#" MasterPageFile="~/MarkMod/CAMSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="cam_planed_mark.aspx.cs" Inherits="cam_planed_mark" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <body oncontextmenu="return false">
        ...
        <div>
            <br />
            <center>
                <span class="fontstyleheader" style="color: Green;">CAM Planed Mark</span>
            </center>
            <br />
            <center>
                <asp:Panel ID="pnlHeadingCAM" runat="server" Height="52px">
                    <table id="Table1" class="maintablestyle" style="height: 30px; margin-top: 0px; width: 926px;
                        margin-left: 0px;">
                        <tr>
                            <td>
                                <asp:Label ID="lblBatch" runat="server" Text="Batch" Font-Bold="True" Font-Names="Book Antiqua"
                                    Font-Size="Medium" Style="height: 21px; width: 41px"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlBatch" runat="server" Height="20px" Width="59px" AutoPostBack="True"
                                    OnSelectedIndexChanged="ddlBatch_SelectedIndexChanged" Font-Bold="True" Style="">
                                </asp:DropDownList>
                            </td>
                            <td>
                            ...
                            <td class="style2">
                                <asp:DropDownList ID="ddlDegree" runat="server" AutoPostBack="True" Height="21px"
                                    OnSelectedIndexChanged="ddlDegree_SelectedIndexChanged" Width="74px" Style=""
                            ...
                            <td>
                                <asp:DropDownList ID="ddlTest" runat="server" AutoPostBack="false" Style="height: 23px;
                                    width: 117px;" Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Medium">
                                </asp:DropDownList>
                            </td>
                            <td>
        ...
        <asp:Panel ID="pnlEntry" runat="server" Height="215px" Width="835px">
            ...
            <center>
                <FarPoint:FpSpread ID="FpEntry" runat="server" ActiveSheetViewIndex="0" BorderColor="Black"
                    ...
                    scrollcontentcolumns="" scrollcontentmaxheight="50" scrollcontenttime="500" Width="831px" ShowHeaderSelection="false">
        ...
        <center>
            ...
            <Ajax:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server" TargetControlID="pnlEntry"
            ...
            <asp:Panel ID="pHeaderReport" runat="server" CssClass="style9" Width="949px">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lblSub" Text="Student Details" runat="server" Font-Size="Medium" Font-Bold="True"
        ...
        <br />
        <asp:Panel ID="pnlReport" runat="server" Height="131px" Width="822px" Style="margin-left: 44px;">
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    <center>
                        <FarPoint:FpSpread ID="FpSettings" runat="server" BorderColor="Black" HorizontalScrollBarPolicy="AsNeeded"
                            VerticalScrollBarPolicy="AsNeeded" BorderStyle="Solid" BorderWidth="1px" Height="180px"
                            Width="800px" ClientAutoCalculation="true" OnCellClick="FpSettings_CellClick"
                            OnUpdateCommand="FpSpread3cmd" OnEditCommand="FpSettings_EditChanged" ScrollBar3DLightColor="Yellow"
                            ScrollBarArrowColor="Brown" KeyPress="FpSettings_KeyPress" ScrollBarBaseColor="Goldenrod"
                            ScrollBarDarkShadowColor="DarkOrange" ScrollBarFaceColor="RosyBrown" ScrollBarHighlightColor="#006699"
                            ScrollBarShadowColor="#9999FF" ActiveSheetViewIndex="0" currentPageIndex="0"
                            ...
                            scrollContentTime="500" Style="margin-left: 36px; margin-top: 30px;"  ShowHeaderSelection="false">
                        ...
                        <FarPoint:FpSpread ID="FpReport" runat="server" BorderColor="Black" BorderStyle="Solid"
                            BorderWidth="1px" Height="400px" Width="900px" HorizontalScrollBarPolicy="Never"
                            VerticalScrollBarPolicy="Never" CommandBar-Font-Names="Arial" ActiveSheetViewIndex="0"
                            currentPageIndex="0" DesignString="&lt;?xml version=&quot;1.0&quot; encoding=&quot;utf-8&quot;?&gt;&lt;Spread /&gt;"
                            OnLoad="FpReport_OnLoad" Style="margin-left: 35px"  ShowHeaderSelection="false">
                            <CommandBar BackColor="Control" ButtonFaceColor="Control" ButtonHighlightColor="ControlLightLight"
                                ButtonShadowColor="ControlDark" Visible="False" Font-Bold="False" Font-Italic="False"
            ...
            <center>
                ...
                <asp:Panel ID="sdr" runat="server">
                    <table style="margin-left: 134px; margin-top: -2px;">
                        <tr>
                            <td>
                    ...
                    <table style="margin-left: 134px; margin-top: -5px;">
                        <tr>
                            <td>
                                <asp:Button ID="Save1" runat="server" Font-Bold="true" Font-Names="Book Antiqua"
                                    Font-Size="Medium" OnClick="Save1_Click" Text="Save" Width="60px" />
                            </td>
                            <td>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Button ID="printfp" runat="server" Font-Bold="true" Font-Names="Book Antiqua"
                                    OnClick="printfp_Click" Font-Size="Medium" Text="Print" Width="127px" />
        ...
        <center>
            <Ajax:CollapsiblePanelExtender ID="CollapsiblePanelExtender2" runat="server" TargetControlID="pnlReport"
                CollapseControlID="pHeaderReport" ExpandControlID="pHeaderReport" AutoExpand="false"
