<%@ Page Title="CAM" Language="C#" MasterPageFile="~/MarkMod/CAMSubSiteMaster.master" AutoEventWireup="true"
    CodeFile="CAMHome.aspx.cs" Inherits="CAMHome" %>
        ...
        <div style="width: 700px;">
            <table>
                <tr>
                    ...
                    <td>
                        <center>
                            <asp:Label ID="Label1" CssClass="lbl" runat="server" Text="MARK"></asp:Label>
                        </center>
                    </td>
                    <td>
                    </td>
