...
public partial class ReportCardICSE_IX_To_X : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (status == true)
            {
                ...
                if (appPath != "")
                {
                    ...
                    string szFile = Convert.ToString("ICSE_IX_To_X_Reportcard" + DateTime.Now.ToString("ddMMyyyy") + DateTime.Now.ToString("HHmmss")).Trim().Replace(" ", "").Trim() + ".pdf";
