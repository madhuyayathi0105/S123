<%@ Page Title="Report Card For KG" Language="C#" MasterPageFile="~/MarkMod/CAMSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="ReportCard_For_KG.aspx.cs" Inherits="ReportCard_For_KG"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Report Card For KG</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <div>
            <span class="fontstyleheader" style="color: Green">Report Card For KG</span>
        </div>
    ...
    <asp:Label ID="lblErrSearch" runat="server" Text="" ForeColor="Red" Visible="False"
        ...
        margin-top: 10px; margin-bottom: 10px; position: relative;"></asp:Label>
    <center>
        <div id="divViewSpread" runat="server" visible="false" style="margin: 0px; margin-top: 10px;
        ...
        <div id="divHeaderSettings" runat="server" visible="false" style="height: 100em;
            ...
            <center>
                <div id="divHeaderContents" runat="server" class="table" style="background-color: White;
                    ...
                    <center>
                        <table style="height: 100px; width: 100%; margin: 0px; margin-top: 10px; margin-bottom: 10px;">
                            <tr>
