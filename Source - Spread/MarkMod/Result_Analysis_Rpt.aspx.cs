                            ...
                            for (int seccount = 1; seccount <= dsv; seccount++)
                            {
                                ...
                                if (dsstaff.Tables.Count > 0 && dsstaff.Tables[0].Rows.Count > 0)
                                {
                                    foreach (DataRow row in dsstaff.Tables[0].Rows)
                                    {
                                        ...
                                        if (chklstaff.SelectedIndex == 1)
                                        {
                                            drow["Subject Teacher"] = Convert.ToString(row["staff_code"]);
                                        ...
                                        ds_exam1.Tables[0].DefaultView.RowFilter = "criteria_no=" + criteria_no + " and subject_no=" + ds_has.Tables[0].Rows[i]["subject_no"] + " " + strsec + " and staff_code='" + Convert.ToString(row["staff_code"]) + "'";
                                        ...
                                        if (ds_exam.Tables.Count > 0 && ds_exam.Tables[0].Rows.Count > 0)
                                        {
                                            ...
                                            {
                                                str_staff_qry = "and sc.staffCode like '%" + Convert.ToString(row["staff_code"]) + "%'";
                                            }
                                            string totstu = "";
                                            string totstudcnt = "";
                                            int gtotstu = 0;
