...
public partial class MarkMod_PerformanceReportCardICSE_IV___VIII : System.Web.UI.Page
{
    ...
    private void setLabelText()
    {
        try
        {
            ...
            {
                lblBatch.Text = "Year";
                spPageHeading.InnerHtml = "Performance Report Card ICSE IV - VIII";
                Page.Title = "Performance Report Card ICSE IV - VIII";
            }
            else
            {
                lblBatch.Text = "Batch";
        ...
        try
        {
                ...
                if (dtStudentDetails.Rows.Count > 0)
                {
                    foreach (DataRow drStudent in dtStudentDetails.Rows)
                    {
                        ...
                        if (dsStudMarks.Tables.Count > 1 && dsStudMarks.Tables[1].Rows.Count > 0)
                        {
                            ...
                            dtCurrentSemesterSubject = dsStudMarks.Tables[1].DefaultView.ToTable(true, "subject_name", "subject_code", "subjectpriority", "acronym", "subjectMarkType");
                            ...
                            dsStudMarks.Tables[1].DefaultView.Sort = "subjectpriority,subType_no,subject_code";
                            dtPreviousSemesterSubject = dsStudMarks.Tables[1].DefaultView.ToTable(true, "subject_name", "subject_code", "subjectpriority", "acronym", "subjectMarkType");
                        ...
                        if (dtCurrentStudentMarks.Rows.Count > 0)
                        {
                            ...
                            int totalRows = dtCurrentSemesterSubject.Rows.Count + 3;
                            int totalColumns = dtDistinctTestName.Rows.Count + 2;
                            ...
                            foreach (DataRow drSubjects in dtCurrentSemesterSubject.Rows)
                            {
                                ...
                                foreach (DataRow dtTest in dtDistinctTestName.Rows)
                                {
                                    ...
                                    if (subjectRow == dtCurrentSemesterSubject.Rows.Count)
                                    {
                                        ...
                                        {
                                            double sum = dicSubjectWiseTotal.Sum(x => Math.Round((x.Value / maxTestMark) * 100, 0, MidpointRounding.AwayFromZero));
                                            ...
                                            double average = Math.Round(sum / dtCurrentSemesterSubject.Rows.Count, 2, MidpointRounding.AwayFromZero);
                                            tblStudentMarks.Cell(subjectRow + 2, testColumn + 1).SetContent((sum > 0) ? average.ToString() : "--");
                                            tblStudentMarks.Cell(subjectRow + 2, testColumn + 1).SetContentAlignment(ContentAlignment.MiddleCenter);
                                        }
                                    }
                                    if (testColumn == dtDistinctTestName.Rows.Count)
                                    {
            ...
            if (status == true)
            {
                ...
                if (appPath != "")
                {
                    ...
                    string szFile = "PerformanceReportCardICSE_I_To_III" + DateTime.Now.ToString("ddMMyyyy") + DateTime.Now.ToString("HHMMss") + ".pdf";
    ...
    private void AcademicPerformanceReport(List<string> lstAppNo, string rollNo)
    {
        try
        {
                ...
                if (dtStudentDetails.Rows.Count > 0)
                {
                    foreach (DataRow drStudent in dtStudentDetails.Rows)
                    {
                        ...
                        if (dsStudMarks.Tables.Count > 1 && dsStudMarks.Tables[1].Rows.Count > 0)
                        {
                            ...
                            dsStudMarks.Tables[1].DefaultView.RowFilter = " Batch_Year='" + batchYear + "' and degree_code='" + degreeCode + "' and semester='" + semester + "' and sections='" + section + "' and App_No='" + appNo + "' and subjectMarkType<>'2'";
                            dsStudMarks.Tables[1].DefaultView.Sort = "subjectpriority,subType_no,subject_code";
                        ...
                        if (dtCurrentStudentMarks.Rows.Count > 0)
                        {
                            ...
                            if (dtPreviousStudentMarks.Rows.Count > 0)
                            {
                                ...
                                foreach (DataRow drTerm in dtTerm.Rows)
                                {
                                    ...
                                    foreach (DataRow drSubject in dtPreviousSemesterSubject.Rows)
                                    {
                                        ...
                                        if (!dicSubjectWiseAbsent.ContainsKey(subjectTCode.Trim().ToLower()))
                                            dicSubjectWiseAbsent.Add(subjectTCode.Trim().ToLower(), isSubjectWiseAbsent);
                                        else if (dicSubjectWiseAbsent.ContainsKey(subjectTCode.Trim().ToLower()) && !dicSubjectWiseAbsent[subjectTCode.Trim().ToLower()] && isSubjectWiseAbsent)
                                        {
                                            dicSubjectWiseAbsent[subjectTCode.Trim().ToLower()] = isSubjectWiseAbsent;
                                        }
                                        if (!dicSubjectWiseAbsent1.ContainsKey(subjectTCode.Trim().ToLower()))
                                            dicSubjectWiseAbsent1.Add(subjectTCode.Trim().ToLower(), isSubjectWiseAbsent);
                                    }
                            ...
                            foreach (DataRow drSubjects in dtCurrentSemesterSubject.Rows)
                            {
                                ...
                                foreach (DataRow dtTest in dtDistinctTestName.Rows)
                                {
                                        ...
                                        else
                                        {
                                            ...
                                            if (subjectTSingle.Trim() == "0" || subjectTSingle.Trim().ToLower() == "false")
                                            {
                                                ...
                                                if (includeTest && markOrGrade != "2")// 
                                                {
                                                    ...
                                                    else if (subjectTypeName.Trim().ToLower() == "others")  //modified by prabha
                                                    {
                                                        if (dicCommonSubjectWiseOverAllTotal.ContainsKey(subjectTCode.Trim().ToLower()))
                                                            dicCommonSubjectWiseOverAllTotal[subjectTCode.Trim().ToLower()] += convertTestMark;
                                                        else
                                    ...
                                    if (testColumn == dtDistinctTestName.Rows.Count - dtOtherSubjects.Rows.Count)
                                    {
                                        ...
                                        switch (semester.Trim().ToLower())
                                        {
                                            ...
                                            case "3":
                                                ...
                                                tblStudentMarks.Cell(subjectRow, testColumn + 2).SetContent((isSubjectAbsent || isPrevSubjectAbsent) ? "--" : (dicSubjectWiseAbsent.ContainsKey(subjectTCode.Trim().ToLower()) && dicSubjectWiseAbsent[subjectTCode.Trim().ToLower()]) ? "" : (subjectWiseTotal > 0) ? displayTotal : "--");
                                                ...
                                                {
                                                    //tblStudentMarks.Cell(subjectRow + 1, testColumn + 2).SetContent((isAbsent || isPrevAbsent) ? "" : ((!isWeighted) ? ((overAllSubjectWeightage > 0) ? overAllSubjectWeightage.ToString() : "--") : ""));
                                    ...
                                    if (subjectRow == dtCurrentSemesterSubject.Rows.Count + dtCurrentSingleSubjectType.Rows.Count)
                                    {
                                        ...
                                        if (testColumn == dtDistinctTestName.Rows.Count - dtOtherSubjects.Rows.Count)
                                        {
                                            //double sum = dicCommonSubjectWiseOverAllTotal.Sum(x => Math.Round((x.Value), 0, MidpointRounding.AwayFromZero)) + dicSingleSubjectWiseOverAllTotal.Sum(x => Math.Round(x.Value, 0, MidpointRounding.AwayFromZero));
                                            double sum = dicCommonSubjectWiseOverAllTotal.Sum(x => Math.Round((x.Value), 2, MidpointRounding.AwayFromZero)) + dicSingleSubjectWiseOverAllTotal.Sum(x => Math.Round(x.Value, 2, MidpointRounding.AwayFromZero));
                                            if (semester.Trim() == "2")
                                            {
                            ...
                            if (dtPreviousStudentMarks.Rows.Count > 0)
                            {
                                ...
                                if (dtTerm.Rows.Count > 0)
                                {
                                    ...
                                    if (differneceCount == 2)//last modified on jan 28 2018 by prabha
                                    ...
                                    foreach (DataRow drTerm in dtTerm.Rows)
                                    {
                                        ...
                                        string term = Convert.ToString(drTerm["semester"]).Trim();
                                        Int32.TryParse(term.Trim(),out termCount);
                                        double maxTestMark = 0;
                                        dicSubjectWiseTotal.Clear();
                                        dicTestWiseTotal.Clear();
                                        termRow++;
                                        ...
                                        foreach (DataRow drSubject in dtPreviousSemesterSubject.Rows)
                                        {
                                                    ...
                                                    if (testColumn == dtDistinctTestName.Rows.Count)
                                                    {
                                                        ...
                                                        if (dicSubjectWiseTotal.ContainsKey(subjectTCode.Trim().ToLower()))
                                                        {
                                                            if (subjectTAcronymn.ToLower().Trim() == "eng")
                                                            {
                                                                ...
                                                                //subjectWiseTotal = (dicSubjectWiseTotal[subjectTCode.Trim().ToLower()]);
                                                                subjectWiseTotal = subjectWiseTotal / 2;   //TBC 
                                            ...
                                            //        tblStudentPerformanceAnalysis.Cell(0, subjectCol).SetFont(fontReportFooter);
                                            //        tblStudentPerformanceAnalysis.Cell(0, subjectCol).SetContentAlignment(ContentAlignment.MiddleCenter);
                                            //        addedcolumn.Add(subjectTAcronymn, subjectTypeno);
                                            //    }
                                            //    foreach (DataRow dtTest in dtDistinctTestName.Rows)
                                            //    {
                                            //        string subjectMaxMark = string.Empty;
                                            ...
                                            //        //if (dvStudMarks.Count > 0)
                                            //        //{
                                            //        //    //dicSingleSubjecttotalMarks
                                            //        //    foreach (KeyValuePair<string, double> kp in dicSingleSubjectOveralltotalMarks)
                                            //        //    {
                                            //        //        if (kp.Key.ToLower() == subjectTCode.ToLower())
                                            //        //        {
                                            //        //            avgCount++;
                                            //        //            SubjectTypeMark += kp.Value;
                                            //        //        }
                                            //        //    }
                                            ...
                                            //    {
                                            //        double subjectWiseTotal = 0;
                                            //        subjectWiseTotal = SubjectTypeMark / avgCount;
                                            //        subjectWiseTotal = Math.Round(subjectWiseTotal, 0, MidpointRounding.AwayFromZero);
                                            //        tblStudentPerformanceAnalysis.Cell(termRow, subjectCol).SetContent((isPrevTAbsent) ? "" : Convert.ToString(subjectWiseTotal));
                                            //    }
                                            //    else
                                            //        tblStudentPerformanceAnalysis.Cell(termRow, subjectCol).SetContent((isPrevTAbsent) ? "" : "--");
                                            //    tblStudentPerformanceAnalysis.Cell(termRow, subjectCol).SetContentAlignment(ContentAlignment.MiddleCenter);
            ...
            if (status == true)
            {
                ...
                {
                    string szPath = appPath + "/Report/";
                    string szFile = "PerformanceReportCardICSE_IV_To_VIII" + DateTime.Now.ToString("ddMMyyyy") + DateTime.Now.ToString("HHMMss") + ".pdf";
                    pdfDocumentReport.SaveToFile(szPath + szFile);
                    Response.ClearHeaders();
                    Response.AddHeader("Content-Disposition", "attachment; filename=" + szFile);
                    Response.ContentType = "application/pdf";
        ...
        {
            da.sendErrorMail(ex, collegeCode, "Performance Report Card IV-VII");
        }
    }
