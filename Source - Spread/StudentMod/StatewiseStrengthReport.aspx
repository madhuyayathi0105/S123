<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMod/StudentSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="StatewiseStrengthReport.aspx.cs" Inherits="StatewiseStrengthReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <div>
            <center>
                <div>
                    <span class="fontstyleheader" style="color: #008000; font-size: xx-large">Student Strength Report</span>
                </div>
            </center>
            <br />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddl_reporttype" CssClass="ddlheight4 textbox1" runat="server"
                                AutoPostBack="true" OnSelectedIndexChanged="ddl_reporttype_selectedchange">
                                <asp:ListItem Value="0">State</asp:ListItem>
                                <asp:ListItem Value="1">Board</asp:ListItem>
                                <asp:ListItem Value="2">University</asp:ListItem>
                                <asp:ListItem Value="3">Ex-Service Man</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td id="lbl_state" runat="server" visible="false">
                            <asp:Label ID="lbl_Filtertype" runat="server"></asp:Label>
                        </td>
                        <td id="state" runat="server" visible="false">
                            <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="txt_comm" runat="server" CssClass="textbox textbox1 txtheight3"
                                        ReadOnly="true">-- Select--</asp:TextBox>
                                    <asp:Panel ID="Panel7" runat="server" CssClass="multxtpanel" Height="250px" Width="200px">
                                        <asp:CheckBox ID="cb_state" runat="server" Text="Select All" AutoPostBack="true"
                        ...
                        <td id="td_board" runat="server" visible="false">
                            <asp:TextBox ID="txtBoardUniv" runat="server" CssClass="textbox textbox1 txtheight3"
                                ReadOnly="true">Board</asp:TextBox>
                            <asp:Panel ID="pnlBoardUniv" runat="server" CssClass="multxtpanel" Width="200px"
                                Height="250px">
