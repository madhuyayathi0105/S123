<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMod/StudentSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="DeptmentGrouping.aspx.cs" Inherits="DeptmentGrouping"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <span class="fontstyleheader" style="color: Green;">Department Grouping</span>
    </center>
    <br />
    <center>
        <table class="maintablestyle">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlcollege" runat="server" CssClass="textbox1 ddlheight5" Style="font-family: 'Book Antiqua';"
            ...
            <tr>
                <td colspan="5">
                    <span style="font-size: medium; font-family: 'Book Antiqua'; font-weight: bold;">Group
                        Name</span>
                    <asp:Button ID="titleplus" runat="server" Text="+" CssClass="textbox1 btn1" Font-Bold="true"
                    ...
                    <asp:DropDownList ID="ddltitlename" runat="server" AutoPostBack="true" CssClass="textbox1 ddlheight3"
                        Width="115px" Font-Names="Book Antiqua" OnSelectedIndexChanged="ddltitlename_OnSelectedIndexChanged"
                        Font-Bold="true" Font-Size="Medium">
                    </asp:DropDownList>
                    <asp:Button ID="titleminus" runat="server" CssClass="textbox1 btn1" Text="-" Font-Bold="true"
                        ...
                        <center>
                            <asp:Panel ID="pnltitle" runat="server" Visible="false" Style="background-color: #add8e6;
                                ...
                                <asp:Button ID="btnadd2" runat="server" Text="Add" Style="height: 28px; width: 80px"
                                    Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Medium" OnClick="btnadd2_OnClick" />
            ...
            <ContentTemplate>
                <div id="movdiv" runat="server">
                    <table>
                        ...
                        <tr>
                            <td>
                                <FarPoint:FpSpread ID="FpSpread1" runat="server" CssClass="spreadborder" Visible="true"
                                    VerticalScrollBarPolicy="AsNeeded" HorizontalScrollBarPolicy="Never" ShowHeaderSelection="false">
                            ...
                            <td>
                                <FarPoint:FpSpread ID="FpSpread2" runat="server" CssClass="spreadborder" Visible="true"
                                    VerticalScrollBarPolicy="AsNeeded" HorizontalScrollBarPolicy="Never" ShowHeaderSelection="false">
                                    <CommandBar BackColor="Control" ButtonFaceColor="Control" ButtonHighlightColor="ControlLightLight"
                                        ButtonShadowColor="ControlDark">
                                    </CommandBar>
