<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMod/StudentSubSiteMaster.master" AutoEventWireup="true" CodeFile="RegNoAllocation.aspx.cs" Inherits="RegNoAllocation" %>

<%@ Register Src="~/Usercontrols/PrintMaster.ascx" TagName="printmaster" TagPrefix="Insproplus" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="FarPoint.Web.Spread" Namespace="FarPoint.Web.Spread" TagPrefix="FarPoint" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>RegNo Allocation</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function changeFromToSer() {
            var fromNo = document.getElementById('<%=txtserFrom.ClientID %>');
            var toNo = document.getElementById('<%=txtserTo.ClientID %>');

            var fromNum = fromNo.value.trim();
            var toNum = toNo.value.trim();
    ...
    <asp:ScriptManager ID="scrptMgr" runat="server">
        ...
        <center>
            <div>
                <span class="fontstyleheader" style="color: Green">	Register Number Mapping</span>
            </div>
        </center>
    </div>
    <center>
    ...
    <center>
        <div id="popwindow" runat="server" visible="false" class="popupstyle popupheight1 ">
            ...
            <br />
            <div style="background-color: White; height: 620px; width: 950px; border: 5px solid #0CA6CA;
                border-top: 30px solid #0CA6CA; border-radius: 10px;">
                <center>
                    <div>
                        <span class="fontstyleheader" style="color: Green;">Register Number Mapping</span></div>
                </center>
                <table class="maintablestyle">
                    <tr>
                        <td>
                    ...
                    <div id="divAcronyms" runat="server" visible="false" style="border: 1px solid black;
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <table style="border: 1px solid green; border-radius: 5px;">
                                        <tr>
                                            <td>
                                                From
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtserFrom" runat="server" CssClass="textbox txtheight" Width="20px"
                                                    onchange="changeFromToSer();" MaxLength="3"></asp:TextBox>
                                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txtserFrom"
                                                    FilterType="Numbers">
                                                </asp:FilteredTextBoxExtender>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtserTo" runat="server" CssClass="textbox txtheight" Width="20px"
                                                    onchange="changeFromToSer();" MaxLength="3"></asp:TextBox>
                                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" TargetControlID="txtserTo"
                                                    FilterType="Numbers">
                                                </asp:FilteredTextBoxExtender>
                                            </td>
                                        </tr>
                                ...
                                <td colspan="10">
                                    <center>
                                        <div>
                                            ...
                                            <asp:Button ID="btn_Clr" runat="server" CssClass="textbox btn2 textbox1" Text="Clear"
                ...
                <div id="Div2" runat="server" class="table" style="background-color: White; height: 120px;
                    ...
                    <center>
                        <table style="height: 100px; width: 100%">
                            <tr>
                                <td align="center">
                                    <asp:Label ID="lblconfirmRes" runat="server" Text="Do You Want To Reset Register Number?" Style="color: Red;" Font-Bold="true"
