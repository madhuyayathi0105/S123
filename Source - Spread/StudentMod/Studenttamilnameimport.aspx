<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMod/StudentSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="Studenttamilnameimport.aspx.cs" Inherits="StudentMod_Studenttamilnameimport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center style="margin: 0px; margin-bottom: 5px; padding: 0px; border: 0px;">
            <span class="fontstyleheader" style="color: Green; font-weight: bold; margin: 0px;
                margin-bottom: 15px; margin-top: 10px; position: relative; padding: 3px;">Student Tamilname Import</span>
        </center>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Download">
                                <ItemTemplate>
                                    ...
                                    <asp:Image ID="d1" runat="server" ImageUrl="~/images/d3.jpg" Width="35px" Height="35px" />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="85px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Upload">
                                <ItemTemplate>
                                    ...
                                    <asp:Image ID="d2" runat="server" ImageUrl="~/images/d4.jpg" Width="35px" Height="35px" />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="85px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Help">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_help" runat="server" Text="" ForeColor="Blue" Font-Underline="True"
                                        Font-Size="Small"></asp:Label>
                                    <asp:Image ID="help" runat="server" ImageUrl="~/images/h.jpg" Height="25px" Width="25px" />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="85px" />
                            </asp:TemplateField>
                        </Columns>
