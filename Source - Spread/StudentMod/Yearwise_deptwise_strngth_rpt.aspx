<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMod/StudentSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="Yearwise_deptwise_strngth_rpt.aspx.cs" Inherits="Yearwise_deptwise_strngth_rpt"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <span class="fontstyleheader" style="color: Green;">Yearwise & Departmentwise Strength
            Report</span>
        <br />
        <br />
        <table class="maintablestyle">
            <tr>
                ...
                <td>
                    <asp:Label ID="lblbach" runat="server" Visible="false" Text="Batch" Font-Bold="True"
                ...
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Panel ID="pbatch" runat="server" Visible="false" CssClass="multxtpanel" Height="150px"
            ...
            <tr>
                ...
                <td>
                 <asp:CheckBox ID="cbacr" AutoPostBack="true" Font-Size="Medium"
                                    runat="server" Text="Acronym" /><%--OnCheckedChanged="cb_selectedchange_Click"--%><%--added abarna--%>
                </td>
            </tr>
        </table>
        <br />
