<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMod/StudentSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="Districtwise_report.aspx.cs" Inherits="Districtwise_report"
        ...
        <div>
            <center>
                <center>
                    <br />
                    <div>
                        <span class="fontstyleheader" style="color: #008000;">Admission Status - Districtwise
                            Report</span>
                    </div>
                </center>
                ...
                <table  class="maintablestyle">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddl_batch" runat="server" CssClass="textbox1  ddlheight" AutoPostBack="true"
                                OnSelectedIndexChanged="ddlBatchYear_selectIndexChange">
                            </asp:DropDownList>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lbl_comm" Text="District" runat="server"></asp:Label>
                        </td>
                        <td>
                            <asp:UpdatePanel ID="uoi" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="txt_comm" runat="server" CssClass="textbox  textbox1 txtheight4"
                                        ReadOnly="true">--Select--</asp:TextBox>
                        ...
                        <%-----------------------------------------------------------------%>
                        <td colspan="2">
                            <asp:RadioButton ID="rdb_deptname" runat="server" GroupName="de" />
                        </td>
                        <td>
                            <asp:RadioButton ID="rdb_deptacr" Checked="true" runat="server" GroupName="de" />
                        </td>
                        <td>
