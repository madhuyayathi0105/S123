<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMod/StudentSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="ReAdmissionProcess.aspx.cs" Inherits="StudentMod_ReAdmissionProcess" %>
            ...
            <table class="maintablestyle">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <asp:DropDownList ID="ddl_searchtype" runat="server" CssClass="textbox1  ddlheight1"
                    ...
                    <td>
                        ...
                        <asp:Button ID="btn_save" runat="server" Text="ReAdmit" CssClass="textbox textbox1 btn1" Width="75px"
        ...
        <center>
            <div id="pop_readmissiondet" runat="server" visible="false" style="height: 48em;
                ...
                <div style="background-color: White; height: auto; width: 350px; border: 5px solid #0CA6CA;
                    ...
                    <br />
                    <table>
                     <%--    Added By Saranyadevi 21.2.2018--%>
                        <tr>
                            <asp:Label ID="lblstuddetails" runat="server" Style="color: Green;" Font-Bold="true"
                                Font-Size="Medium" Visible="false"></asp:Label>
                        </tr>
                        <%--    End By Saranyadevi 21.2.2018--%>
                        <tr>
                            <td>
                                Batch Year
                            </td>
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <asp:Button ID="btnReadmissionSave" runat="server" Text="Save" CssClass="textbox textbox1 btn2"
                                    OnClick="btn_ReadmissionSave_OnClick" />
                            </td>
                        </tr>
                    </table>
                </div>
