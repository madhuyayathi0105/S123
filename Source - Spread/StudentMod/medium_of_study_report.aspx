<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMod/StudentSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="medium_of_study_report.aspx.cs" Inherits="medium_of_study_report"
        ...
        <div>
            <center>
                <center>
                    <br />
                    <div>
                        <span class="fontstyleheader" style="color: #008000;">Admission Status - Medium Of Study
                            Report</span>
                    </div>
                </center>
                <div class="maindivstyle" style="height: auto; width: 1000px;">
                    ...
                    <table class="maintablestyle">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lbl_comm" Text="Medium" runat="server"></asp:Label>
                            </td>
                            <td colspan="3">
