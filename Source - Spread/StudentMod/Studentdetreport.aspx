<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMod/StudentSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="Studentdetreport.aspx.cs" Inherits="StudentMod_Studentdetreport" %>
                            ...
                            <table class="maintablestyle" width="800px">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:UpdatePanel ID="updclg" runat="server">
                                            <ContentTemplate>
                                                <asp:TextBox ID="txt_clgname" runat="server" CssClass="textbox textbox1 txtheight3"
                                                    ReadOnly="true"></asp:TextBox>
                                                <asp:Panel ID="pnlClg" runat="server" CssClass="multxtpanel" Height="300px">
                                                    <asp:CheckBox ID="cb_clgname" runat="server" Text="Select All" OnCheckedChanged="collegeCheckChange"
                                                        AutoPostBack="true" />
                                                    <asp:CheckBoxList ID="cbl_clgname" runat="server" AutoPostBack="true" OnSelectedIndexChanged="collegeSelectedIndexChange">
                                                    </asp:CheckBoxList>
                                                </asp:Panel>
                                                <asp:PopupControlExtender ID="pceCollege" runat="server" TargetControlID="txt_clgname"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="Label1" Width="100px" Text="Order by" runat="server"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlOrderby" Height="30px" runat="server" CssClass="textbox1 ddlheight1"
                        ...
                        <td>
                            <span id="spanGen" runat="server" visible="false">Gender</span>--%>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <asp:CheckBox ID="cbTransfer" runat="server" Text="Transfer Students" AutoPostBack="true"
                                            OnCheckedChanged="cbTransfer_Changed" />
                                    </td>
                                    <%--<td>
                                    Search
                                </td>
                                ...
                                <tr>
                                    <td>
                                        <asp:CheckBox ID="chkinclude" runat="server" AutoPostBack="true" Width="158px" Text="Include Discontinue"
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                            <ContentTemplate>
                                                <asp:TextBox ID="txtinclude" Style="height: 20px; width: 155px;" CssClass="Dropdown_Txt_Box"
                                                    runat="server" Enabled="false" ReadOnly="true">--Select--</asp:TextBox>
