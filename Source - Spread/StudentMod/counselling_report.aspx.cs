...
public partial class counselling_report : System.Web.UI.Page
{
    ...
    protected void bind_comm()
    {
        try
        {
            if (ddl_college.Items.Count > 0)
            {
                q1 = "SELECT Distinct community,T.TextVal  FROM applyn A,TextValTable T WHERE  T.TextCode =A.community  AND TextVal<>'' and t.college_code='" + Convert.ToString(ddl_college.SelectedItem.Value) + "'";
                ds = d2.select_method_wo_parameter(q1, "Text");
    ...
    protected void btn_go_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (rdb_communtity.Checked == true)
            {
                #region communtity wise
                ...
                if (txt_comm.Text != "--Select--" && txt_degree.Text != "--Select--" && txt_branch.Text != "--Select--")
                {
                    ...
                    if (cbl_comm.Items.Count > 0)
                    {
                        for (i = 0; i < cbl_comm.Items.Count; i++)
                        {
                            if (cbl_comm.Items[i].Selected == true)
                            {
                                ...
                                Fpspread1.Sheets[0].ColumnHeader.Cells[0, Fpspread1.Sheets[0].ColumnCount - 1].Text = Convert.ToString(cbl_comm.Items[i].Text);
                                Fpspread1.Sheets[0].ColumnHeader.Cells[0, Fpspread1.Sheets[0].ColumnCount - 1].Tag = Convert.ToString(cbl_comm.Items[i].Value);
                    ...
                    {
                        q1 = "";
                        q1 = " select community,count(app_no)as total,degree_code,seattype from applyn where date_applied between '" + dt.ToString("MM/dd/yyyy") + "' and '" + dt1.ToString("MM/dd/yyyy") + "' and community<>'-1' and college_code='" + Convert.ToString(ddl_college.SelectedItem.Value) + "' and seattype<>'-1' and batch_year='" + Convert.ToString(ddl_batch.SelectedValue) + "' group by community,degree_code,seattype";
                        ds.Clear();
                        ds = d2.select_method_wo_parameter(q1, "text");
                        int r = 1; int availabletotal = 0; int totallast = 0;
                        ...
                        if (cbl_seat.Items.Count > 0)
                        {
                            ...
                            for (int i = 0; i < cbl_seat.Items.Count; i++)
                            {
                                if (cbl_seat.Items[i].Selected == true)
                                {
                                    if (empty == "")
                                    {
                                        empty = Convert.ToString(cbl_seat.Items[i].Text);
                                    }
                                    else
                                    {
                                        empty = empty + "," + Convert.ToString(cbl_seat.Items[i].Text);
                                    }
                                }
                            }
                            string[] selectedseat = empty.Split(',');
                            if (selectedseat.Length == 1)
                            {
                                Fpspread1.Sheets[0].RowCount++;
                                Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, 0].Text = Convert.ToString(empty);
                        ...
                        string seatval = returnwithsinglecodevalue(cbl_seat);
                        DataTable dv_tbl = new DataTable(); int totalval = 0;
                        for (i = 0; i < cbl_branch.Items.Count; i++)
                        {
                            ...
                            if (cbl_branch.Items[i].Selected == true)
                            {
                                ...
                                for (int k = 2; k < Fpspread1.Sheets[0].ColumnHeader.Columns.Count - 1; k++)
                                {
                                    ...
                                    if (ds.Tables[0].Rows.Count > 0)
                                    {
                                        ds.Tables[0].DefaultView.RowFilter = " seattype in('" + seatval + "') and community='" + seattypevalue + "'and degree_code=" + Convert.ToString(cbl_branch.Items[i].Value) + " ";
                                        DataView dv = ds.Tables[0].DefaultView;
                                        if (dv.Count > 0)
                                        {
                                            dv_tbl = null;
                                            dv_tbl = dv.ToTable();
                                            totalval = Convert.ToInt32(dv_tbl.Compute("sum(total)", ""));
                                            Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, k].Text = Convert.ToString(totalval);// Convert.ToString(dv[0]["total"]);
                                            totallast += totalval;// Convert.ToInt32(dv[0]["total"]);
                                            if (totalvalue_dic.Contains(seattypevalue))
                                            {
                                                ...
                                                int total = Convert.ToInt32(value) + totalval;// Convert.ToInt32(dv[0]["total"]);
                                                totalvalue_dic.Add(seattypevalue, total);
                                            }
                                            else
                                            {
                                                totalvalue_dic.Add(seattypevalue, totalval);//Convert.ToInt32(dv[0]["total"]));
                                            }
                                        }
                                        else
                                        {
                                ...
                                //string expamt = Convert.ToString(ds.Tables[0].Compute("Sum(total)", " degree_code=" + Convert.ToString(cbl_branch.Items[i].Value) + " "));
                                //if (expamt.Trim() == "")
                                //{
                                //    expamt = "0";
                                //}
                                Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, Fpspread1.Sheets[0].ColumnHeader.Columns.Count - 1].Text = Convert.ToString(totallast);
                                availabletotal += Convert.ToInt32(totallast);
            ...
            else if (rdb_seatwise.Checked == true)
            {
                #region seattype wise
                ...
                if (txt_comm.Text != "--Select--" && txt_degree.Text != "--Select--" && txt_branch.Text != "--Select--")
                {
                    ...
                    if (cbl_seat.Items.Count > 0)
                    {
                        ...
                        for (i = 0; i < cbl_seat.Items.Count; i++)
                        {
                            if (cbl_seat.Items[i].Selected == true)
                            {
                                ...
                                Fpspread1.Sheets[0].ColumnHeader.Cells[1, Fpspread1.Sheets[0].ColumnCount - 1].Text = "Un Paid";
                                Fpspread1.Sheets[0].ColumnHeader.Cells[1, Fpspread1.Sheets[0].ColumnCount - 1].Tag = Convert.ToString(cbl_seat.Items[i].Value);
                                Fpspread1.Sheets[0].ColumnHeader.Cells[1, Fpspread1.Sheets[0].ColumnCount - 1].Font.Bold = true;
                                Fpspread1.Sheets[0].ColumnHeader.Cells[1, Fpspread1.Sheets[0].ColumnCount - 1].Font.Name = "Book Antiqua";
                                Fpspread1.Sheets[0].ColumnHeader.Cells[1, Fpspread1.Sheets[0].ColumnCount - 1].Font.Size = FontUnit.Medium;
                        ...
                        #endregion
                        double totallast = 0; int r = 1;
                        q1 = ""; q1 = " select COUNT(isnull(Admission_Status,0))Unpaid,degree_code,batch_year,seattype from applyn where isnull(Admission_Status,0)=0 and degree_code is not null and seattype is not null and batch_year='" + ddl_batch.SelectedValue.ToString() + "' and seattype<>'-1'  group by degree_code,Admission_Status,batch_year,seattype ";

                        q1 += " select COUNT(Admission_Status)paid,degree_code,batch_year,seattype from applyn where Admission_Status=1 and degree_code is not null and seattype is not null and batch_year='" + ddl_batch.SelectedValue.ToString() + "' and seattype<>'-1'  group by degree_code,Admission_Status,batch_year,seattype ";
                        ds.Clear();
                        ds = d2.select_method_wo_parameter(q1, "text");
                        for (i = 0; i < cbl_branch.Items.Count; i++)
                        {
                            ...
                            if (cbl_branch.Items[i].Selected == true)
                            {
                                ...
                                //unpaid 1
                                #region unpaid
                                for (int k = 2; k < Fpspread1.Sheets[0].ColumnHeader.Columns.Count - 1; k += 3)
                                {
                                    string seattypevalue = Convert.ToString(Fpspread1.Sheets[0].ColumnHeader.Cells[1, k].Tag);
                                    if (ds.Tables[0].Rows.Count > 0)
                                    {
                                        ds.Tables[0].DefaultView.RowFilter = " seattype in('" + seattypevalue + "') and batch_year='" + Convert.ToString(ddl_batch.SelectedItem.Text) + "'and degree_code=" + Convert.ToString(cbl_branch.Items[i].Value) + " ";
                                        DataView dv = ds.Tables[0].DefaultView;
                                        if (dv.Count > 0)
                                        {
                                            Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, k].Text = Convert.ToString(dv[0]["Unpaid"]);
                                            if (totalvalue_dic.Contains(seattypevalue + "-1"))
                                            {
                                                string value = totalvalue_dic[seattypevalue + "-1"].ToString();
                                                totalvalue_dic.Remove(seattypevalue + "-1");
                                                int total = Convert.ToInt32(value) + Convert.ToInt32(dv[0]["Unpaid"]);
                                                totalvalue_dic.Add(seattypevalue + "-1", total);
                                            }
                                            else
                                            {
                                                totalvalue_dic.Add(seattypevalue + "-1", Convert.ToInt32(dv[0]["Unpaid"]));
                                            }
                                        }
                                        else
                                        {
                                ...
                                #endregion
                                #region paid
                                for (int k = 3; k < Fpspread1.Sheets[0].ColumnHeader.Columns.Count - 1; k += 3)
                                {
                                    string seattypevalue = Convert.ToString(Fpspread1.Sheets[0].ColumnHeader.Cells[1, k].Tag);
                                    if (ds.Tables[1].Rows.Count > 0)
                                    {
                                        ds.Tables[1].DefaultView.RowFilter = " seattype in('" + seattypevalue + "') and batch_year='" + Convert.ToString(ddl_batch.SelectedItem.Text) + "'and degree_code=" + Convert.ToString(cbl_branch.Items[i].Value) + " ";
                                        DataView dv1 = ds.Tables[1].DefaultView;
                                        if (dv1.Count > 0)
                                        {
                                            Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, k].Text = Convert.ToString(dv1[0]["paid"]);
                                            if (totalvalue_dic.Contains(seattypevalue + "-2"))
                                            {
                                                string value = totalvalue_dic[seattypevalue + "-2"].ToString();
                                                totalvalue_dic.Remove(seattypevalue + "-2");
                                                int total = Convert.ToInt32(value) + Convert.ToInt32(dv1[0]["paid"]);
                                                totalvalue_dic.Add(seattypevalue + "-2", total);
                                            }
                                            else
                                            {
                                                totalvalue_dic.Add(seattypevalue + "-2", Convert.ToInt32(dv1[0]["paid"]));
                                            }
                                        }
                                        else
                                        {
                                ...
                                #endregion
                                #region Total
                                for (int k = 4; k < Fpspread1.Sheets[0].ColumnHeader.Columns.Count - 1; k += 3)
                                {
                                    double paid = 0; double unpaid = 0;
                                    double.TryParse(Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, k - 2].Text, out  paid);
                                    double.TryParse(Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, k - 1].Text, out  unpaid);
                                    double total = paid + unpaid;
                                    totallast += total;
                                    string seattypevalue = Convert.ToString(Fpspread1.Sheets[0].ColumnHeader.Cells[1, k].Tag);
                                    if (totalvalue_dic.Contains(seattypevalue + "-3"))
                                    {
                                        string value = totalvalue_dic[seattypevalue + "-3"].ToString();
                                        totalvalue_dic.Remove(seattypevalue + "-3");
                                        int total2 = Convert.ToInt32(value) + Convert.ToInt32(total);
                                        totalvalue_dic.Add(seattypevalue + "-3", total2);
                                    }
                                    else
                                    {
                                        totalvalue_dic.Add(seattypevalue + "-3", total);
                                    }
                                    Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, k].Text = Convert.ToString(total);
                                    Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, k].HorizontalAlign = HorizontalAlign.Center;
                                    Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, k].Font.Size = FontUnit.Medium;
                                    Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, k].Font.Name = "Book Antiqua";
                                }
                    ...
                    for (int k = 2; k < Fpspread1.Sheets[0].ColumnHeader.Columns.Count - 1; k += 3)
                    {
                        ...
                        if (totalvalue_dic.Count > 0)
                        {
                            ...
                            if (totalvalue_dic.Contains(seattypevalue + "-1"))
                            {
                                value = totalvalue_dic[seattypevalue + "-1"].ToString();
                            }
                            else
                            {
                                value = "0";
                    ...
                    for (int k = 3; k < Fpspread1.Sheets[0].ColumnHeader.Columns.Count - 1; k += 3)
                    {
                        ...
                        if (totalvalue_dic.Count > 0)
                        {
                            ...
                            if (totalvalue_dic.Contains(seattypevalue + "-2"))
                            {
                                value = totalvalue_dic[seattypevalue + "-2"].ToString();
                            }
                            else
                            {
                                value = "0";
                    ...
                    for (int k = 4; k < Fpspread1.Sheets[0].ColumnHeader.Columns.Count - 1; k += 3)
                    {
                        ...
                        if (totalvalue_dic.Count > 0)
                        {
                            ...
                            if (totalvalue_dic.Contains(seattypevalue + "-3"))
                            {
                                value = totalvalue_dic[seattypevalue + "-3"].ToString();
                            }
                            else
                            {
                                value = "0";
                    ...
                    Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, Fpspread1.Sheets[0].ColumnHeader.Columns.Count - 1].Text = Convert.ToString(availabletotal);
                    Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, Fpspread1.Sheets[0].ColumnHeader.Columns.Count - 1].HorizontalAlign = HorizontalAlign.Center;
                    Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, Fpspread1.Sheets[0].ColumnHeader.Columns.Count - 1].Font.Size = FontUnit.Medium;
                    Fpspread1.Sheets[0].Cells[Fpspread1.Sheets[0].RowCount - 1, Fpspread1.Sheets[0].ColumnHeader.Columns.Count - 1].Font.Name = "Book Antiqua";
                    Fpspread1.Sheets[0].Rows[Fpspread1.Sheets[0].RowCount - 1].BackColor = Color.Bisque;
        ...
        catch (Exception ex)
        {
            ...
            d2.sendErrorMail(ex, collegecode1, "Counselling_report");
        }
    }
