<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMod/StudentSubSiteMaster.master"
    AutoEventWireup="true" CodeFile="StudentAdmittedCommunitywiseReport.aspx.cs"
    Inherits="StudentMod_StudentAdmittedCommunitywiseReport" %>
        ...
        <div>
            <center>
                <div>
                    ...
                    <span class="fontstyleheader" style="color: #008000; font-size: xx-large">Student Community
                        wise Details </span>
                </div>
            </center>
            <br />
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" BackColor="White" BorderColor="Black" BorderStyle="Solid"
                                        BorderWidth="2px" CssClass="multxtpanel" Style="width: 180px; height: 130px;">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:Panel ID="p3" runat="server" runat="server" BackColor="White" BorderColor="Black"
                                        BorderStyle="Solid" BorderWidth="2px" CssClass="multxtpanel" Height="250px" Width="180px"
                            ...
                            <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="txt_comm" runat="server" CssClass="textbox textbox1 txtheight3"
                                        ReadOnly="true">-- Select--</asp:TextBox>
                                    <asp:Panel ID="Panel7" runat="server" CssClass="multxtpanel" Height="250px" Width="180px">
