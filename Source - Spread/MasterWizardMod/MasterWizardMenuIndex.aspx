<%@ Page  Title="" Language="C#" MasterPageFile="~/MasterWizardMod/MasterWizard.master"  AutoEventWireup="true" CodeFile="MasterWizardMenuIndex.aspx.cs" Inherits="MasterWizardMenuIndex" %>
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td>
                        <center>
                            <asp:Label ID="Label1" CssClass="lbl" runat="server" Text="Master Wizard"></asp:Label>
                        </center>
                    </td>
                    <td>
                    </td>
