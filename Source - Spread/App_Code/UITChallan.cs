...
/// <summary>
/// Summary description for VITChallan
/// </summary>
public class UITChallan : ReuasableMethods
{
        ...
        try
        {
            ...
            if (lastRecptNo != "")
            {
                    ...
                    for (int row = 1; row < Fpspread1.Sheets[0].RowCount; row++)
                    {
                        ...
                        if (checkval == 1)
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    bankName = "Bank : " + ddl_collegebank.SelectedItem.Text.Split('-')[0];
                                    bankPK = ddl_collegebank.SelectedItem.Value;
                                    string ifsc = d2.GetFunction("SELECT DISTINCT IFSCCode FROM FM_FinBankMaster  where BankPk=" + bankPK + " and CollegeCode=" + collegecode1 + "");

                                    bankCity = String.Format("A/c No. " + ddl_collegebank.SelectedItem.Text.Split('-')[1] + "\n IFSC Code : " + ifsc);
                                }
                                        ...
                                        if (ds.Tables[0].Rows.Count > 0)
                                        {
                                            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                                            {
                                                ...
                                                PdfTextArea ORGI = new PdfTextArea(Fontbold1, System.Drawing.Color.Black,
                                                                                                       new PdfArea(mychallan, 270, 30, 100, 20), System.Drawing.ContentAlignment.MiddleLeft, "Banker Copy");
                ...
                else
                {
                                    ...
                                    if (ds.Tables[0].Rows.Count > 0)
                                    {
                                        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                                        {
                                                                ...
                                                                if (grandtotal > 0)
                                                                {
                                                                    ...
                                                                    if (totalAmt > 0)
                                                                    {
                                                                        if (chk == 0)
                                                                        {
                                                                            ...
                                                                            recptNo = generateChallanNo(usercode, collegecode1, ref accidRecpt, ref lastRecptNo);
                                                                            txt_rcptno.Text = recptNo;
                                                                            generateChallanNo(usercode, collegecode1, ref accidRecpt, ref lastRecptNo);
                                            ...
                                            if (addpageOK)
                                            {
                                                ...
                                                table5.Cell(1, 2).SetContentAlignment(ContentAlignment.MiddleCenter);
                                                table5.Cell(1, 2).SetFont(Fontbold1);
                                                Gios.Pdf.PdfTablePage myprov_pdfpagetable31 = table5.CreateTablePage(new Gios.Pdf.PdfArea(mychallan, 680, y + 300, 310, 500));
                                                myprov_pdfpage.Add(myprov_pdfpagetable31);
                    ...
                    catch (Exception ex) { d2.sendErrorMail(ex, collegecode1, "UIT Challan"); }
