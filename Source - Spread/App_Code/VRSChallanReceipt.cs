...
/// <summary>
/// Summary description for VRSChallanReceipt
/// </summary>
public class VRSChallanReceipt : ReuasableMethods
{
    ...
    private string degAcr = string.Empty;
    private string narration = string.Empty;

    DAccess2 d2 = new DAccess2();

    public VRSChallanReceipt()
    {
    }
    /// <summary>
    ...
    /// <returns></returns>
    public VRSChallanReceipt(string Appno, string Rollno, string Collegecode, string Usercode, byte GpHdrType, string Studname, string RecptDt, string RcptTime, string RecptNo, string Cursem, string DegString, string DeptString, string degacr, string Narration)
    {
        appno = Appno;
        rollno = Rollno;
    ...
    public StringBuilder returnHtmlString(out bool createPDFOK)
    {
        ...
        try
        {
            ...
            sbHtml.Append("<div style='padding-left:0px;height: 576px;width: 1000px;'><table cellpadding='0' cellspacing='0' style='text-align:center; width: 1000px;  ' class='classBold10'>");

            sbHtml.Append("<tr><td><table style='width:400px; height:80px;padding-top:150px;' class='classBold10' cellpadding='2'><tr><td style='text-indent:50px;'>" + recptNo + "</td><td style='text-indent:50px;'>" + recptDt + "</td></tr> <tr><td style='text-indent:60px;'>" + rollno + "</td><td>" + degString + "-" + degAcr + "</td></tr> <tr><td style='text-indent:30px;'>" + studname.ToUpper() + "</td><td>" + cursem + "</td></tr> </table></td><td style='width:60px;'></td><td><table style='width:400px; height:80px;padding-top:150px;' class='classBold10' cellpadding='2'><tr><td style='text-indent:50px;'>" + recptNo + "</td><td style='text-indent:50px;'>" + recptDt + "</td></tr> <tr><td style='text-indent:60px;'>" + rollno + "</td><td>" + degString + "-" + degAcr + "</td></tr> <tr><td style='text-indent:60px;'>" + studname.ToUpper() + "</td><td>" + cursem + "</td></tr> </table></td><td style='width:150px;'></td></tr>");
            #endregion

            #region Receipt Body

            sbHtml.Append("<tr><td><div style='width:400px; height:300px; padding-top:10px; '><table  class='classBold10'>");
            StringBuilder tempHtml = new StringBuilder();
            tempHtml.Append("<td><div style='width:400px; height:300px; padding-top:10px; '><table  class='classBold10'></td>");
            int rows = 0;
                ...
                if (dsHeaders.Tables.Count > 0)
                {
                    if (dsHeaders.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int head = 0; head < dsHeaders.Tables[0].Rows.Count; head++)
                        {
                            ...
                            indx++;
                            createPDFOK = true;
                            sbHtml.Append("<tr><td style='width:30px;text-align:right;'>" + sno + "</td><td style='width:265px;'>" + disphdr + "</td><td style='width:62px;text-align:right;'>" + returnIntegerPart(creditAmt0) + "</td><td style='width:23px;text-align:right;'>" + returnDecimalPart(creditAmt0) + "</td></tr>");

                            tempHtml.Append("<tr><td style='width:30px;text-align:right;'>" + sno + "</td><td style='width:265px;'>" + disphdr + "</td><td style='width:62px;text-align:right;'>" + returnIntegerPart(creditAmt0) + "</td><td style='width:23px;text-align:right;'>" + returnDecimalPart(creditAmt0) + "</td></tr>");
                        }

                        sbHtml.Append("<tr><td style='width:30px;text-align:right;'></td><td style='width:265px;'>" + narration + "</td><td style='width:62px;text-align:right;'></td><td style='width:23px;text-align:right;'></td></tr>");

                        tempHtml.Append("<tr><td style='width:30px;text-align:right;'></td><td style='width:265px;'>" + narration + "</td><td style='width:62px;text-align:right;'></td><td style='width:23px;text-align:right;'></td></tr>");

                        sbHtml.Append("</table></div></td><td style='width:50px;'></td>" + tempHtml.ToString() + "</td></table></div></td>" + "<td style='width:150px;'></td><tr>");

                        double totalamount = curpaid;

                        sbHtml.Append("<tr><td><table style='width:400px; height:30px;' class='classBold10'><tr></td><td style='width:290px;'>Received Rupees " + DecimalToWords((decimal)totalamount) + " Only</td><td style='width:42px;text-align:right;'>" + returnIntegerPart(totalamount) + "</td><td style='width:18px;text-align:right;'>" + returnDecimalPart(totalamount) + "</td></tr></table></td><td style='width:50px;'></td><td><table style='width:400px; height:30px;' class='classBold10'><tr><td style='width:290px;'>Received Rupees " + DecimalToWords((decimal)totalamount) + " Only</td><td style='width:42px;text-align:right;'>" + returnIntegerPart(totalamount) + "</td><td style='width:18px;text-align:right;'>" + returnDecimalPart(totalamount) + "</td></tr></table></td><td style='width:150px;'></td></tr>");
                    }
                }
            }
    ...
    /// <summary>
    /// Returns Html For Original Receipt
    /// </summary>
    /// <param name="createPDFOK">Pass variable to check the Pdf creation</param>
    /// <returns></returns>
...
(txtTobePaidamt.Text);
                ...
                if (creditamt > 0)
                {
                    ...
                    sbHtml.Append("<tr><td style='width:30px;text-align:right;'>" + sno + "</td><td style='width:265px;'>" + lblFeeCategory.Text + "</td><td style='width:62px;text-align:right;'>" + returnIntegerPart(creditamt) + "</td><td style='width:23px;text-align:right;'>" + returnDecimalPart(creditamt) + "</td></tr>");

                    tempHtml.Append("<tr><td style='width:30px;text-align:right;'>" + sno + "</td><td style='width:265px;'>" + lblFeeCategory.Text + "</td><td style='width:62px;text-align:right;'>" + returnIntegerPart(creditamt) + "</td><td style='width:23px;text-align:right;'>" + returnDecimalPart(creditamt) + "</td></tr>");
                }
            }
