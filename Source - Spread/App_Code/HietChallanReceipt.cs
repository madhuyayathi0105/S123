...
/// <summary>
/// Summary description for HietChallanReceipt
/// </summary>
public class HietChallanReceipt:ReuasableMethods
{
    ...
    /// <returns></returns>
    public HietChallanReceipt(string Appno, string Rollno, string Collegecode, string Usercode, byte GpHdrType, string Studname, string RecptDt, string RcptTime, string RecptNo, string Cursem, string DegString, string DeptString, string Narration)
    {
        appno = Appno;
        rollno = Rollno;
    ...
    public StringBuilder returnHtmlString(out bool createPDFOK)
    {
        ...
        try
        {
            ...
            sbHtml.Append("<div style='padding-left:5px;height: 763.5px;'><table cellpadding='0' cellspacing='0' style='text-align:center; width: 700px; ' class='classBold10'><tr><td>");

            sbHtml.Append("<table style='width:700px; height:180px; padding-left:5px;padding-top:83px; ' class='classReg12'><tr><td colspan='3' style='text-align:right;'>" + recptNo + "</td></tr><tr><td colspan='3' ><br><center>" + studname.ToUpper() + "</center><br/></td></tr><tr><td style='width:200px; text-align:right;'>" + "" + rollno + "</td><td style='width:200px; text-align:right;'>" + "" + romanLetter(returnYearforSem(cursem)) + " Year" + "</td><td style='width:300px; text-align:right;'>" + "" + recptDt + "</td></tr><tr><td style='width:200px; text-align:right;'><br>" + degString + "</td><td style='width:500px; text-align:right;' colspan='2'><br>" + deptString + "</td></tr></table>");

            #endregion

            #region Receipt Body

            sbHtml.Append("<div style='width:700px; height:218px; padding-top:70px;padding-left:-50px; '><table  class='classReg12'>");
            int rows = 0;
                ...
                if (dsHeaders.Tables.Count > 0)
                {
                    if (dsHeaders.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int head = 0; head < dsHeaders.Tables[0].Rows.Count; head++)
                        {
                            ...
                            sbHtml.Append("<tr><td style='width:30px;text-align:right;'>" + sno + "</td><td style='width:470px;text-indent:40px;'>" + disphdr + "</td><td style='width:150px;text-align:right;'>" + returnIntegerPart(creditAmt0) + "</td><td style='width:50px;text-align:right;'>" + returnDecimalPart(creditAmt0) + "</td></tr>");
                        }
                        sbHtml.Append("<tr><td style='width:30px;text-align:right;'></td><td style='width:470px;text-indent:40px;'>" + narration + "</td><td style='width:150px;text-align:right;'></td><td style='width:50px;text-align:right;'></td></tr>");
                        sbHtml.Append("</table></div>");

                        double totalamount = curpaid;
                        sbHtml.Append("<div style='width:700px;padding-left:-50px;height:100px;padding-top:10px; '><table  class='classReg12'><tr><td style='width:30px;text-align:right;'>&nbsp;</td><td style='width:470px; font-size:12px;'>(" + DecimalToWords((decimal)totalamount) + " Rupees Only.)</td><td style='width:150px;text-align:right;'></td><td style='width:50px;text-align:right;'></td></tr><tr><td style='width:30px;text-align:right;'>&nbsp;</td><td style='width:470px;'>&nbsp;</td><td style='width:150px;text-align:right;'>" + returnIntegerPart(totalamount) + "</td><td style='width:50px;text-align:right;'>" + returnDecimalPart(totalamount) + "</td></tr></table></div>");
...
(txtTobePaidamt.Text);
                ...
                if (creditamt > 0)
                {
                    ...
                    sbHtml.Append("<tr><td style='width:30px;text-align:right;'>" + sno + "</td><td style='width:470px;text-indent:40px;'>" + lblFeeCategory.Text + "</td><td style='width:150px;text-align:right;'>" + returnIntegerPart(creditamt) + "</td><td style='width:50px;text-align:right;'>" + returnDecimalPart(creditamt) + "</td></tr>");
                }
            }
