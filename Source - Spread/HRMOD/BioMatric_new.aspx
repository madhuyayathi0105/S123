<%@ Page Title="" Language="C#" MasterPageFile="~/HRMOD/HRSubSiteMaster.master" AutoEventWireup="true"
    CodeFile="BioMatric_new.aspx.cs" Inherits="BioMatric_new" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <body>
        ...
        <table style="margin-left: 0px; width: 750px;">
            <tr>
                <td id="myvis1" runat="server" visible="false">
                    <asp:RadioButton ID="rdodaily" runat="server" Visible="false" OnCheckedChanged="rdodaily_CheckedChanged"
                        AutoPostBack="true" Width="19px" Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Medium"
                        Height="20px" GroupName="a" />
                </td>
                <td id="myvis2" runat="server" visible="false">
                    <asp:Image ID="Image17" runat="server" Visible="false" ImageUrl="~/bioimage/Daily Report.jpg"
                ...
                <td>
                    <asp:RadioButton ID="rdoinout" runat="server" AutoPostBack="True" Font-Bold="True"
                        ...
                        Font-Names="Book Antiqua" Height="16px" GroupName="a" />
                ...
                <td>
                    <asp:RadioButton ID="rdooutonly" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                        ...
                        GroupName="a" />
                    <asp:Image ID="Image16" runat="server" ImageUrl="~/bioimage/Out Only.jpg" Height="20px" />
                </td>
                <td>
                    <asp:RadioButton ID="rdounreg" runat="server" GroupName="a" Font-Bold="True" Font-Names="Book Antiqua"
                        Font-Size="Medium" Height="16px" AutoPostBack="true" OnCheckedChanged="rdounreg_CheckedChanged" />
                    <asp:Image ID="Image20" runat="server" ImageUrl="~/bioimage/Un Register Staff.jpg"
                        Height="20px" />
                </td>
                <td id="myvis3" runat="server" visible="true">
                    <asp:RadioButton ID="rdoboth1" runat="server" Visible="true" Font-Bold="True" Font-Names="Book Antiqua"
                        Font-Size="Medium" GroupName="a" Text="Both" Height="22px" OnCheckedChanged="rdoboth1_CheckedChanged"
                        AutoPostBack="true" Width="95px" />
                </td>
                <td id="myvis4" runat="server" visible="true">
                    <asp:RadioButton ID="rbdailylog" runat="server" Visible="true" Font-Bold="True" Font-Names="Book Antiqua"
        ...
        <table id="myvis" runat="server" visible="false" class="style1" style="margin-left: -0px;">
            <%--Hide By Jeyaprakash--%>
            <tr>
                <td>
        ...
        <div>
            <asp:Panel ID="pheaderfilter" runat="server" CssClass="cpHeader" BackColor="#0CA6CA"
                Height="14px" Style="margin-left: 0px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBoxList ID="cblsearch" runat="server" OnSelectedIndexChanged="cblsearch_SelectedIndexChanged1"
                                ...
                                <asp:ListItem Value="8">Finger ID</asp:ListItem>
                                <asp:ListItem Value="9">Att Till Percentage</asp:ListItem>
                                <asp:ListItem Value="10">In Time</asp:ListItem>
                                <asp:ListItem Value="11">Out Time</asp:ListItem>
                                <asp:ListItem Value="12">Total Hrs</asp:ListItem>
                                <asp:ListItem Value="13">Morning</asp:ListItem>
                                <asp:ListItem Value="14">Evening</asp:ListItem>
                                <asp:ListItem Value="15">Manual</asp:ListItem>
                                <asp:ListItem Value="16">Leave</asp:ListItem>
                            </asp:CheckBoxList>
                        </td>
                        <td>
