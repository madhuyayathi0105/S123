<%@ Page Title="" Language="C#" MasterPageFile="~/HRMOD/HRSubSiteMaster.master" AutoEventWireup="true"
    CodeFile="CL_Salary_Stmnt.aspx.cs" Inherits="CL_Salary_Stmnt" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <body>
        ...
        <center>
            <span class="fontstyleheader" style="color: Green;">CL Salary Statement Report</span>
            <br />
            <br />
            <table class="maintablestyle">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lbLeaveType" runat="server" Text="Leave Type" Style="font-weight: bold;
                            margin-left: 0px; font-family: book antiqua; font-size: medium;"></asp:Label>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlLeaveType" runat="server" CssClass="textbox1 ddlheight3"
                            Width="130px">
                        </asp:DropDownList>
                    </td>
                    <td>
