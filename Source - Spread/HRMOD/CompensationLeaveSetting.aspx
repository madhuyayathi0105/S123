<%@ Page Title="" Language="C#" MasterPageFile="~/HRMOD/HRSubSiteMaster.master" AutoEventWireup="true"
    CodeFile="CompensationLeaveSetting.aspx.cs" Inherits="HRMOD_CompensatonLeaveSetting"
        ...
        <center>
            <div>
                <center>
                    <br />
                    <div>
                        <span class="fontstyleheader" style="color: Green;">Compensation Leave Setting</span>
                    </div>
                </center>
                <fieldset id="maindiv" runat="server" style="width: 1000px; margin-left: 0px; height: 1100px;
                    ...
                    <fieldset style="background-color: #0ca6ca; border: 1px solid #ccc; border-radius: 10px;
                        box-shadow: 0 0 8px #999999; height: 85px; margin-left: 0px; margin-top: 8px;
                        ...
                        <table style="margin-top: -14px;">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lbl_compDate" runat="server" Text="Compensation Leave Date" Font-Bold="true"
                                        Width="211px" ForeColor="Black" Font-Size="Medium" Font-Names="Book Antiqua"></asp:Label>
                                </td>
                                <td>
                                    <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txt_CompDate" runat="server" Font-Bold="true" AutoPostBack="true"
                                                Width="80px" ForeColor="Black" Font-Size="Medium" Font-Names="Book Antiqua"></asp:TextBox>
                                            <asp:CalendarExtender ID="CalendarExtender4" TargetControlID="txt_CompDate" runat="server"
                                                Format="dd/MM/yyyy">
                                            </asp:CalendarExtender>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                    ...
                    <div id="sp_div" runat="server">
                        <FarPoint:FpSpread ID="FpSpread" runat="server" Visible="false" BorderColor="Black"
                            BorderStyle="Solid" BorderWidth="1px" Width="817px" Height="800px" Style="margin-left: 2px;"
                    ...
                    <center>
                        <asp:Button ID="btn_save" runat="server" Visible="false" Text="Save" OnClick="btn_Save_Click"
