<%@ Page Title="" Language="C#" MasterPageFile="~/HRMOD/HRSubSiteMaster.master" AutoEventWireup="true"
    CodeFile="ITOtherAllowanceDeduction.aspx.cs" Inherits="HRMOD_ITOtherAllowanceDeduction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <body>
        ...
        <div>
            <center>
                <div>
                    <span class="fontstyleheader" style="color: Green;">Allowance And Deduction Master</span></div>
            </center>
        </div>
        <center>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RadioButton ID="rb_allow" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                                        Font-Size="Medium" RepeatDirection="Horizontal" GroupName="same" Text="Other Income Head"
                                ...
                                <td>
                                    <asp:RadioButton ID="rb_deduct" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                                        Font-Size="Medium" RepeatDirection="Horizontal" GroupName="same" Text="Other Deduction Head"
                                        OnCheckedChanged="rb_deduct_OncheckedChanged" AutoPostBack="true"></asp:RadioButton>
                                </td>
                                <td>
                                    <asp:RadioButton ID="rd_salary" runat="server" Font-Bold="True" Font-Names="Book Antiqua"
                                        Font-Size="Medium" RepeatDirection="Horizontal" GroupName="same" Text="Salary Certificate"
                                        OnCheckedChanged="rb_salary_OncheckedChanged" AutoPostBack="true"></asp:RadioButton>
                                </td>
                                <td>
                ...
                <center>
                    <div id="addnew" runat="server" visible="false" style="height: 200em; z-index: 1000;
                        ...
                        <asp:ImageButton ID="ImageButton2" runat="server" Width="40px" Height="40px" ImageUrl="../images/close.png"
                            Style="height: 30px; width: 30px; position: absolute; margin-top: 95px; margin-left: 305px;"
                        ...
                        <br />
                        <br />
                        <div style="background-color: White; height: 488px; width: 650px; border: 5px solid #0CA6CA;
                                ...
                                <center>
                                    <table style="padding: 30px;">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddl_popclg" runat="server" CssClass="textbox1 ddlheight3" Width="250px"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txt_name" runat="server" Font-Names="Book Antiqua" Font-Size="medium"
                                                    Height="25px" CssClass="textbox textbox1" Width="250px" onfocus="return myFunction(this)"
                                                    onblur="return getallded(this.value)" Style="text-transform: none;"></asp:TextBox>
                                            ...
                                            <td>
                                                <span style="font-weight: bold; font-size: small;" id="screrr"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txt_desc" runat="server" TextMode="MultiLine" Font-Names="Book Antiqua"
                                                    Font-Size="medium" CssClass="textbox textbox1" Width="250px" Height="100px" onfocus="return myFunction(this)"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td style="padding-top: 10px;">
                                                <asp:CheckBox ID="cb_splallow" runat="server" AutoPostBack="true" Text="Common Allowances" />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td style="padding-top: 10px;">
                                                <asp:CheckBox ID="cb_agesetting" runat="server" Checked="false" OnCheckedChanged="cb_ageSettingClick"
                                                    AutoPostBack="true" Text="Age Range" />
                                            </td>
                                            <td>
                                                <asp:Label ID="lbl_maxAge" runat="server" Text="Greater Than" Style="margin-left: 20px;"></asp:Label>
                                                <asp:TextBox ID="txt_maxAge" runat="server" Font-Names="Book Antiqua" Font-Size="medium"
                                                    Height="25px" CssClass="textbox textbox1" Width="50px"></asp:TextBox>
                                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txt_maxAge"
                                                    FilterType="UppercaseLetters,LowercaseLetters,custom,Numbers" ValidChars="/,&().[]-:;  ">
                                                </asp:FilteredTextBoxExtender>
                                                <asp:Label ID="lbl_maxval" runat="server" Text="Value" Style="margin-left: 20px;"></asp:Label>
                                                <asp:TextBox ID="txt_Maxval" runat="server" Font-Names="Book Antiqua" Font-Size="medium"
                                                    Height="25px" CssClass="textbox textbox1" Width="67px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lbl_MinAge" runat="server" Text="Less Than" Style="margin-left: 45px;"></asp:Label>
                                                <asp:TextBox ID="txt_MinAge" runat="server" Font-Names="Book Antiqua" Font-Size="medium"
                                                    Height="26px" CssClass="textbox textbox1" Width="50px"></asp:TextBox>
                                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" TargetControlID="txt_MinAge"
                                                    FilterType="UppercaseLetters,LowercaseLetters,custom,Numbers" ValidChars="/,&().[]-:;  ">
                                                </asp:FilteredTextBoxExtender>
                                                <asp:Label ID="lbl_minVal" runat="server" Text="Value" Style="margin-left: 20px;"></asp:Label>
                                                <asp:TextBox ID="txt_minval" runat="server" Font-Names="Book Antiqua" Font-Size="medium"
                                                    Height="25px" CssClass="textbox textbox1" Width="68px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:CheckBox ID="cbincomeTax" runat="server" Text="Income Tax" />
                                            </td>
                                        </tr>
                                    </table>
                                    <center>
