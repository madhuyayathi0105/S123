<%@ Page Title="" Language="C#" MasterPageFile="~/HRMOD/HRSubSiteMaster.master" AutoEventWireup="true"
    CodeFile="PF_Acquain_Report.aspx.cs" Inherits="PF_Acquain_Report" EnableEventValidation="false" %>
        ...
        <div>
            ...
            <center>
                <div>
                    <center>
                        <div>
                            <span class="fontstyleheader" style="color: #008000">PF Aquaintance Report</span></div>
                    </center>
                </div>
                <div class="maindivstyle" style="width: 1000px; height: auto;">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:CheckBoxList ID="cblcolumnorder" runat="server" Height="43px" AutoPostBack="true"
                                                    ...
                                                    <asp:ListItem Value="30">C.L</asp:ListItem>
                                                    <asp:ListItem Value="31">LOP DATES</asp:ListItem>
                                                    <asp:ListItem Value="32">WORKING DAYS</asp:ListItem>
                                                    <asp:ListItem Value="33">ABSENT DAYS</asp:ListItem>
                                                    <asp:ListItem Value="34">PRESENT DAYS</asp:ListItem>
                                                    <asp:ListItem Value="35">NO. OF INCREMENT</asp:ListItem>
                                                    <asp:ListItem Value="36">LOP AMOUNT</asp:ListItem>
                                                    <asp:ListItem Value="37">PF Salary</asp:ListItem>
                                                    <asp:ListItem Value="38">ESI Salary</asp:ListItem>
                                                    <asp:ListItem Value="39">ADV RS.</asp:ListItem>
                                                    <asp:ListItem Value="40">COLLECTED AMT</asp:ListItem>
                                                    <asp:ListItem Value="41">Actual Allowances</asp:ListItem>
                                                    <asp:ListItem Value="42">Allowances</asp:ListItem>
                                                    <asp:ListItem Value="43">Deductions</asp:ListItem>
                                                    <asp:ListItem Value="44">Leave Type</asp:ListItem>
                                                    <asp:ListItem Value="45">DA %</asp:ListItem>
                                                    <asp:ListItem Value="46">AGP</asp:ListItem>
                                                    <asp:ListItem Value="47">INCREMENT IN RS.</asp:ListItem>
                                                    <asp:ListItem Value="48">ACTUAL BASIC</asp:ListItem>
                                                    <asp:ListItem Value="49">BASIC PAY Rs.</asp:ListItem>
                                                    <asp:ListItem Value="50">PAY BAND</asp:ListItem>
                                                    <asp:ListItem Value="51">ACTUAL GRADE</asp:ListItem>
                                                    <asp:ListItem Value="52">GRADE PAY</asp:ListItem>
                                                    <asp:ListItem Value="53">TOT DED Rs.</asp:ListItem>
                                                    <asp:ListItem Value="54">GROSS PAY Rs.</asp:ListItem>
                                                    <asp:ListItem Value="55">ACTUAL GROSS SALARY</asp:ListItem>
                                                    <asp:ListItem Value="56">PAY SCALE</asp:ListItem>
                                                    <asp:ListItem Value="57">TITLE</asp:ListItem>
                                                    <asp:ListItem Value="58">NET PAY</asp:ListItem>
                                                    <asp:ListItem Value="59">BANK FORMAT</asp:ListItem>
                                                    <asp:ListItem Value="60">SIGNATURE</asp:ListItem>
                                                </asp:CheckBoxList>
                    ...
                    <center>
                        <div id="div1" runat="server" visible="false" style="border-radius: 10px; overflow: auto;">
                            <FarPoint:FpSpread ID="fpsalary" runat="server" OnCellClick="Cell_Click" Width="920px"
